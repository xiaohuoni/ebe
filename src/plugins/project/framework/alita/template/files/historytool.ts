...
// const historyFunc = (type: string) => (params: HistoryReplaceProps, currentPlatform?: PlatformType) => {
//   const {
//     key,
//     history,
//     pathname,
...
//     let realSearch = '';
//     if (typeof search === 'object' && !Array.isArray(search)) {
//       realSearch = Qs.stringify({ appId, ...search });
//     } else if (typeof search === 'string') {
//       realSearch = `${search}&appId=${appId}`;
//     } else if (!pathIncludeAppId) {
//       realSearch = `appId=${appId}`;
//     }
...
//   } = params;
//   let url = '';
//   if (pathname.startsWith('http://', 0) || pathname.startsWith('https://', 0) || isPortal) {
//     url = pathname;
//   } else {
//     const urlArr = window.location?.hash?.split('?');
//     if (urlArr[1]) {
//       url = urlArr[1];
//     }
//     url = `${window.location.origin}${window.location.pathname}#${pathname}?${url}`;
//     let realSearch = '';
//     if (typeof search === 'object' && !Array.isArray(search)) {
//       realSearch = Qs.stringify({ ...search });
//     } else if (typeof search === 'string') {
