...
export default {
  ...
  'service.errorHandler.requestEntityTooLargeError': '请求实体过大:错误编码@{status}, 请通过修改 nginx 配置文件的 client_max_body_size 大小和后端应用的配置项#上传文件大小限制spring.servlet.multipart.max-file-size=300MB spring.servlet.multipart.max-request-size=300MB',
