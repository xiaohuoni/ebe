...
export default merge(baseEnUS, {
  'Quill.uploadImages': 'Only images in the formats of .jpg, .gif, and .png can be uploaded.',
  ...
  'Tree.appendTreeNodeWarning': 'The data of the child nodes of the loaded tree must have the key value, without the key can not be manipulated.',
  'Tree.appendMenuNodeWarning': 'Load menu node must have key value, without key can not be manipulated.',
  ...
  'Input.lenRule': 'Content length must be greater than or equal to @{minLength} and less than or equal to @{maxLength}.',
  'Input.maxRule': 'The length of the content must be less than or equal to @{maxLength}.',
  'Input.minRule': 'Content length must be greater than or equal to @{minLength}',
  'Upload.download': 'The file is downloading, please be patient.',
  'Upload.readonly': 'Currently read-only, no files are allowed to be uploaded or removed!',
  'Upload.maxSize': 'The current maximum file upload size is @{singleFileMaxSize}, please try again!',
  'Upload.minSize': 'The current minimum file upload size is @{singleFileMinSize}, please try again!',
  'Upload.maxNum': 'The current maximum number of files to upload is @{numberLimit}, no further uploads are allowed.',
  'Upload.format': 'The file format is not correct, please upload the file in @{acceptType} format.',
  'Upload.limit': 'The current maximum number of files to upload is @{numberLimit}, please try again.',
  ...
  'Table.headTips': 'Columns can be reordered by dragging and dropping the icons on the left.',
  'Table.headCol': 'columns',
  'Table.needObj': 'Add rows of data that should be formatted as objects, but receive non-object values.',
  'VerificationCode.text': 'Send verification code',
  'VerificationCode.refresh': 'Refresh',
  'Img.fileIdError': 'Command error: received value does not match, current value is :@{field}, expects a number or string.',
  'Form.actionWarning': 'This component does not support the use of the getFormValues directive.',
  ...
  'Table.data.typeError': 'Form data type error, current type is @{type}, please check configuration.',
  ...
  'DatePicker.period': '@{name} must be in the range @{startTime} to @{endTime}',
  ...
  'ExpBusiObjModal.exportFieldError': 'Please select the fields to export first',
  'ExpSQLServiceModal.title': 'Export SQL Query Service Data by Field',
  'ExpSQLServiceModal.importData': 'Import Data',
  'ExpSQLServiceModal.importFieldError': 'Please select the fields to import first',
  ...
  'ExpBusiObjModal.downloadFailReason': 'Download failed import data, check the reason for failure',
  'ExpBusiObjModal.validField': 'Specify valid fields for import',
  'ExpBusiObjModal.dragView': 'Click to select a file or drag a file to this area for upload',
  ...
  'ExpBusiObjModal.importSuccessMsg': 'Data import was successful, please choose to go to the list to view',
  'ExpBusiObjModal.importFailTitle': 'Import failed',
  'ExpBusiObjModal.importFailMsg': 'Data import failed, please check the following information and resubmit.',
  'AccountDivideModal.setAccount': 'Set Account',
  'AccountDivideModal.edit': 'Change Plan',
  'AccountDivideModal.detail': 'Plan Details',
  'AccountDivideModal.disableAutoFill': 'Does not meet the automatic fill condition',
  'AccountDivideModal.fillFail': 'Automatic filling failed, please manually enter at least one basis data and try again',
  'AccountDivideModal.AccountNoFinish': 'Account division not completed, please check carefully',
  ...
  'ProgressComp.cancelMessage': 'Canceling will result in no download results. Please confirm if you want to cancel',
  'ProgressComp.progressMsg': '@{fileName} is in progress: @{text}',
  'ImportBusiObjModal.tips': 'Import total records @{total}, of which @{success} are successful, and @{fail} are failures',
  ...
  'Upload.singleStrict': 'Single file mode does not allow uploading multiple files',
  'Upload.actionStrict': 'The upload action is not configured, please return to modify it!',
