...
// BaseRendererProps,
// EngineLifeCycleType,
// IPublicComponentLiftCycle,
// MetaPluginType,
// } from '@lingxiteam/engine-render';
...
export interface ModifiedEngineLifeCycleType {
  engineWillRender?: (
...
export interface DynamicPageProps extends BaseDynamicPageType {
  ...
  installPlugin?: ({ meta }: { meta: any }) => void;
