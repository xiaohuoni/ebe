    ...
    >
      ...
      <div className={`${dividerClsPrefix}-hexagon`}>
        <div className={`${dividerClsPrefix}-hexagon-left`}>
          <div className={`${dividerClsPrefix}-hexagon-left-top`} style={{ height: `${dividerHeight / 2}px`, paddingRight: `${dividerHeight / 4}px` }}>
            <div className={`${dividerClsPrefix}-hexagon-left-top-rectangle1`} {...bgProps} />
            <div className={`${dividerClsPrefix}-hexagon-left-top-rectangle2`} {...bgProps} />
            <div
          ...
          <div className={`${dividerClsPrefix}-hexagon-left-bottom`} style={{ height: `${dividerHeight / 2}px`, paddingRight: `${dividerHeight / 4}px` }}>
            <div className={`${dividerClsPrefix}-hexagon-left-bottom-rectangle1`} {...bgProps} />
            <div className={`${dividerClsPrefix}-hexagon-left-bottom-rectangle2`} {...bgProps} />
            <div
        ...
        <div className={`${dividerClsPrefix}-hexagon-right`}>
          <div className={`${dividerClsPrefix}-hexagon-right-top`} style={{ height: `${dividerHeight / 2}px`, paddingLeft: `${dividerHeight / 4}px` }}>
            <div className={`${dividerClsPrefix}-hexagon-right-top-rectangle1`} {...bgProps} />
            <div className={`${dividerClsPrefix}-hexagon-right-top-rectangle2`} {...bgProps} />
            <div
          ...
          <div className={`${dividerClsPrefix}-hexagon-right-bottom`} style={{ height: `${dividerHeight / 2}px`, paddingLeft: `${dividerHeight / 4}px` }}>
            <div className={`${dividerClsPrefix}-hexagon-right-bottom-rectangle1`} {...bgProps} />
            <div className={`${dividerClsPrefix}-hexagon-right-bottom-rectangle2`} {...bgProps} />
            <div
