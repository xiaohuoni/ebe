...
/** 项目级别的前置处理器 */
export type ProjectPreProcessor = (schema: IProjectSchema) => Promise<IProjectSchema> | IProjectSchema;
export interface ProjectPostProcessorOptions {
    parseResult?: IParseResult;
    template?: IProjectTemplate;
}
/** 项目级别的后置处理器 */
export type ProjectPostProcessor = (result: ResultDir, schema: IProjectSchema, originalSchema: IProjectSchema | string, options: ProjectPostProcessorOptions) => Promise<ResultDir> | ResultDir;
/** 模块级别的后置处理器的工厂方法 */
