import getFile from '../../../../../../../src/plugins/project/framework/alita/template/files/pcbannermodal';
import { expectValue } from '../../../../../../utils';

describe('template files pcbannermodal', () => {
  test('should return the correct file pcbannermodal', () => {
    const config: any = {
      platform: 'pc',
    };
