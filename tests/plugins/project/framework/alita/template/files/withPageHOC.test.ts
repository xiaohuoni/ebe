...
describe('template files withPageHOC', () => {
  test('should return the correct file withPageHOC', () => {
    ...
    const expectedFileContent = `import React, { useContext, useEffect, useState, useRef, useMemo } from 'react';
            ...
            >
              <WrappedComponent
                ...
                addToAwaitQueue={(
                  ...
                  functionName: string,
                  ...args: any[]
                ) => awaitHandleData.addToAwaitQueue(compId, functionName, ...args)}
