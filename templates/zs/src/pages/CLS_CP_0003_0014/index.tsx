...
const pageId = '1043829583398154240';
const ClsCp_0003_0014$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode124: any = [
      {
    ...
    eventDatacustomActionCode124.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest354: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest354.params = [] || [];
    CMDGenerator(eventDataapiRequest354, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest355: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest355.params = [] || [];
    CMDGenerator(eventDataapiRequest355, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest356: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest356.params = [] || [];
    CMDGenerator(eventDataapiRequest356, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse192: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse192.params = [] || [];
    CMDGenerator(eventDataifelse192, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource153: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource153.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <View
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_82904')}
              {...injectData}
            />
            <Input
              name={'端口号'}
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData305: any = [
                      {
                    ...
                    eventDatagetSelectedData305.params =
                      [
                    ...
                    const eventDatagetSelectedData306: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData306.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode609: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode609.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode610: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode610.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId58: any = [
                {
              ...
              eventDatadownloadByFileId58.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0014$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
