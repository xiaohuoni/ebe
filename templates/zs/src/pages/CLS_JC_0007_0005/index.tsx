                ...
                MemoLoopItem: (props: any) => {
                  ...
                  return (
                    <>
                      ...
                      >
                        <View
                          className="View_View_58611_08291"
                          name={'布局容器'}
                          visible={true}
                          backgroundType={{
                            type: 'cleanColor',
                        ...
                        <View
                          className="View_View_58611_6287033_724501"
                          name={'布局容器'}
                          visible={true}
                          backgroundType={{
                            type: 'cleanColor',
                              ...
                              MemoLoopItem: (props: any) => {
                                ...
                                return (
                                  <>
                                    ...
                                    >
                                      <View
                                        className="View_View_58611_08291_132198"
                                        name={'布局容器'}
                                        visible={true}
                                        backgroundType={{
                                          type: 'cleanColor',
                                      ...
                                      <View
                                        className="View_View_58611_6287033_724501_623026"
                                        name={'布局容器'}
                                        visible={true}
                                        backgroundType={{
                                          type: 'cleanColor',
                                      ...
                                      <View
                                        className="View_View_58611_6287033_724501_623026_157274"
                                        name={'布局容器'}
                                        visible={true}
                                        backgroundType={{
                                          type: 'cleanColor',
