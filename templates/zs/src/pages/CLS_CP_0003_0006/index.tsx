...
const pageId = '1047347836691001344';
const ClsCp_0003_0006$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode89: any = [
      {
    ...
    eventDatacustomActionCode89.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse143.params = [] || [];
    CMDGenerator(eventDataifelse143, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest255: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest255.params = [] || [];
    CMDGenerator(eventDataapiRequest255, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest256: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest256.params = [] || [];
    CMDGenerator(eventDataapiRequest256, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse144: any = [
      {
        type: 'ifelse',
        condition: [
          {
                ...
                options: {
                  ...
                  dataSourceSetValue: [
                    ...
                    },
                    {
                      ...
                      initialData: { type: 'static' },
                      showInput: false,
                      _codePath: ['yellowWarningInSixMonths'],
                      _idpath: ['6403236'],
                    },
                    {
                      attrId: '426607',
                      ...
                      initialData: { type: 'static' },
                      showInput: false,
                      _codePath: ['yellowWarningInSixMonthsName'],
                      _idpath: ['426607'],
                    },
                    {
                      attrId: '933969',
    ...
    eventDataifelse144.params = [] || [];
    CMDGenerator(eventDataifelse144, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDatacustomActionCode247: any = [
      {
        type: 'customActionCode',
        dataId: 170131364906553730,
        shielding: true,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '486801',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){var temp=[{"groupId":"1111","groupName":"2222","devChannel":"\\u6E20\\u9053","agencyName":"\\u4EE3\\u7406\\u5546\\u540D\\u79F0\\u3002\\u3002\\u3002","basicAccessNumber":"\\u57FA\\u672C\\u63A5\\u5165\\u53F7\\uFF0C\\uFF0C\\uFF0C\\uFF0C","busiAccessNumber":"\\u4E1A\\u52A1\\u63A5\\u5165\\u53F7","annualComplaintRate":"15%","yellowWarningWithinSixMonths":"\\u65E0"}];success(temp)};',
        },
        line_number: 19,
        callback1: [
          {
            type: 'setDataSource',
            dataId: 170131383134928770,
            shielding: true,
            options: {
              compId: 'setDataSource',
              compName: 'page',
    ...
    eventDatacustomActionCode247.params = [] || [];
    CMDGenerator(eventDatacustomActionCode247, {}, 'customActionCode', {
      id: 'customActionCode',
      name: 'customActionCode',
      type: 'customActionCode',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource123: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource123.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_663728')}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal120: any = [
                    {
                      ...
                      options: {
                        ...
                        id: '611628',
                        pageJsonId: '537892',
                        modalname: '/CLS_CP_0003_0006ADDINFO',
                        ...
                        modalPath: '/CLS_CP_0003_0006ADDINFO',
                      },
                      line_number: 1,
                      callback1: [
                        {
                  ...
                  eventDatashowCustomModal120.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal120,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey48: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey48.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey48,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse443.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse443, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading157: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest718: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode498: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode498.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatasetLoading158: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading158.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading158, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDataapiRequest719: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest719.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest719, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected47: any = [
                    {
                  ...
                  eventDatagetTableSelected47.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected47,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatasetLoading159: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading159.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading159, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDatacustomActionCode499: any = [
                    {
                      type: 'customActionCode',
                      ...
                      options: {
                        ...
                        id: '7076346',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){var arr1=[];var arr2=[];var infoList=data.infoList;for(var i=0;i<infoList.length;i++){var info=infoList[i];{arr2.push({"name":"\\u96C6\\u56E2\\u7F16\\u7801","value":info.groupId});arr2.push({"name":"\\u96C6\\u56E2\\u540D\\u79F0","value":info.groupName});arr2.push({"name":"\\u53D1\\u5C55\\u6E20\\u9053","value":info.devChannelName});arr2.push({"name":"\\u4EE3\\u7406\\u5546\\u540D\\u79F0","value":info.agencyName});arr2.push({"name":"\\u57FA\\u672C\\u63A5\\u5165\\u53F7","value":info.basicAccessNumber});arr2.push({"name":"\\u4E1A\\u52A1\\u63A5\\u5165\\u53F7","value":info.busiAccessNumber});arr2.push({"name":"\\u5F53\\u5E74\\u6295\\u8BC9\\u7387","value":info.busiAccessNumber});arr2.push({"name":"\\u534A\\u5E74\\u5185\\u6709\\u65E0\\u9EC4\\u8272\\u4EE5\\u4E0A\\u9884\\u8B66","value":info.yellowWarningInSixMonthsName})}arr1.push(arr2);arr2=[]}if(arr1.length>0){success(JSON.stringify(arr1))}else{fail()}};',
                      },
                      line_number: 9,
                      callback1: [
                        {
                  ...
                  eventDatacustomActionCode499.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode499,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                id: '7841323',
                title: '半年内有无黄色以上预警',
                dataIndex: 'yellowWarningInSixMonthsName',
                key: '7841323',
                className: 'divider',
                customRendering: undefined,
                editContent: {
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal121: any = [
                {
                  type: 'showCustomModal',
                  dataId: 170166930209755140,
                  options: {
                    compId: 'showCustomModal',
                    compName: 'page',
                    id: '63798674',
                  ...
                  callback1: [
                    {
                      type: 'customActionCode',
                      dataId: 170167114137834180,
                      options: {
                        compId: 'customActionCode',
                        compName: 'page',
                        id: '810549',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){console.log("\\u5F39\\u7A97\\u8FD4\\u56DE:",okData_63798674);var res=okData_63798674;var infoList=data.infoList||[];console.log("infoList = ",infoList);if(infoList.length>0){var maxRowId=1;for(var i=0;i<infoList.length;i++){var rowId=parseInt(infoList[i]["rowId"]);if(maxRowId<=rowId){maxRowId=rowId}}res.rowId=parseInt(maxRowId)+1}else{res.rowId=1}infoList.unshift(res);var instList=[];for(var key in res){instList.push({"attrCode":key,"attrName":"","attrValue":res[key]})}var instObj={"instCode":res.rowId,"instAttrList":instList};if(data.sceneSubmit.instList!=undefined&&data.sceneSubmit.instList.length>0){data.sceneSubmit.instList.unshift(instObj)}else{var instList=[];instList.unshift(instObj);data.sceneSubmit.instList=instList}data.infoList=infoList;success()};',
                      },
                      line_number: 2,
                      callback1: [
                        {
                          type: 'setDataSource',
                          dataId: 170167114137854980,
                          options: {
                            compId: 'setDataSource',
                            compName: 'page',
                            id: '068703',
                    ...
                    {
                      type: 'console',
                      dataId: 170167238569519680,
                      options: {
                        compId: 'debug',
                        compName: 'system',
                        id: '832584',
                        pageJsonId: '537892',
                        value: ['$okData_63798674$'],
                      },
                      line_number: 5,
                    },
                  ],
              ...
              eventDatashowCustomModal121.params =
                [
            ...
            onRowDetail={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal122: any = [
                {
                  type: 'showCustomModal',
                  dataId: 170167000322177120,
                  options: {
                    compId: 'showCustomModal',
                    compName: 'page',
                    id: '683019',
              ...
              eventDatashowCustomModal122.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData200: any = [
                      {
                    ...
                    eventDatagetSelectedData200.params =
                      [
                    ...
                    const eventDatagetSelectedData201: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData201.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode501: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode501.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode502: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode502.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId38: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId38.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0006$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
