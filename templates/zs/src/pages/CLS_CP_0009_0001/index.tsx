...
const pageId = '884408631126106112';
      ...
      >
        ...
        >
          ...
          <Form
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_818139')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_2821861')
              }
              {...injectData}
            />
          </Form>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_829654')}
          {...injectData}
        />
      </View>
    </div>
