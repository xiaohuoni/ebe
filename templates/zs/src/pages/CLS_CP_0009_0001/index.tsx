...
const ClsCp_0009_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_48671: any) => {
    const eventDatacustomActionCode211: any = [
      {
        type: 'customActionCode',
        dataId: 167238978984292160,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '7793562',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_48671;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238979733944400,
            options: {
    ...
    eventDatacustomActionCode211.params =
      [
        { title: '事件入参', name: 'options_48671', value: '$options_48671$' },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode211,
      { options_48671 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest581: any = [
      {
        type: 'apiRequest',
        dataId: 166972715853080770,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '3755842',
    ...
    eventDataapiRequest581.params = [] || [];
    CMDGenerator(eventDataapiRequest581, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest582: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest582.params = [] || [];
    CMDGenerator(eventDataapiRequest582, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse291: any = [
      {
        type: 'ifelse',
        condition: [
          {
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746130393830900,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746131819599170,
                    options: {
    ...
    eventDataifelse291.params = [] || [];
    CMDGenerator(eventDataifelse291, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) => (refs['Form_4311097_9385662'] = r)}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  ref={(r: any) => (refs['Checkbox_882584_5289015_934499'] = r)}
                  {...injectData}
                />
                <View
                  name={'布局容器'}
                ...
                <Input
                  ...
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Input_361479_887285_2150708'] = r)}
                  {...injectData}
                />
              </Form>
            </View>
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_818139',
              uid: 'Form_449441_818139',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource270: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource270.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => (refs['Form_449441_818139'] = r)}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              $$componentItem={{
                id: 'Input_closeDownExp_015954_2821861',
                uid: 'Input_closeDownExp_015954_2821861',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_closeDownExp_015954_2821861'] = r)}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              ref={(r: any) => (refs['Form_395851_1727917'] = r)}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_690228_5400337'] = r)}
                {...injectData}
              />
              <View
                name={'布局容器'}
                ...
                ref={(r: any) => (refs['View_22346374_875512'] = r)}
                {...injectData}
              >
                <StdUpload
                  name={'附件上传'}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData441: any = [
                      {
                    ...
                    eventDatagetSelectedData441.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode817: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode817.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) => (refs['StdUpload_6230546_867413'] = r)}
                  {...injectData}
                />
              </View>
            </Form>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode818: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode818.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId112: any = [
                {
              ...
              eventDatadownloadByFileId112.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => (refs['BOFramer_829654'] = r)}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0009_0001$$Page, {
  pageId: '884408631126106112',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
