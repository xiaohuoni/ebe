    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => (refs['Divider_2669989'] = r)}
          {...injectData}
        />
        <View
          name={'布局容器'}
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) =>
                  (refs['Form_4311097_9385662_1929847_738917_814178_838097'] =
                    r)
                }
                {...injectData}
              >
        ...
        >
          <RemoteComponent
            ...
            onMessage={(msg: any) => {}}
            ref={(r: any) => (refs['RemoteComponent_455921'] = r)}
            {...injectData}
          />
        </View>
        <View
        ...
        >
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_9931375'] = r)}
            {...injectData}
          />
        </View>
      </View>
