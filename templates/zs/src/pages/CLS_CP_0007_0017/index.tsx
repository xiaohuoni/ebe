...
const pageId = '1036923527499247616';
const ClsCp_0007_0017$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode107: any = [
      {
    ...
    eventDatacustomActionCode107.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest313: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest313.params = [] || [];
    CMDGenerator(eventDataapiRequest313, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest314: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest314.params = [] || [];
    CMDGenerator(eventDataapiRequest314, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse170: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse170.params = [] || [];
    CMDGenerator(eventDataifelse170, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource139: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource139.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal164: any = [
                    {
                      ...
                      options: {
                        ...
                        id: '611628',
                        pageJsonId: '537892',
                        modalname: '/networkAcrossProvincecopy',
                        ...
                        modalPath: '/networkAcrossProvincecopy',
                      },
                      line_number: 1,
                      callback1: [
                        {
                  ...
                  eventDatashowCustomModal164.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal164,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey55: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey55.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey55,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse475.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse475, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading170: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest727: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode545: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode545.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDataapiRequest728: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest728.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest728, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected57: any = [
                    {
                  ...
                  eventDatagetTableSelected57.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected57,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatacustomActionCode546: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode546.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode546,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal165: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal165.params =
                [
          ...
          <Table
            ...
            style={{ margin: '10px 0px 10px 0px' }}
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal166: any = [
                {
                  type: 'showCustomModal',
                  dataId: 166539679318667200,
                  options: {
              ...
              eventDatashowCustomModal166.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData255: any = [
                      {
                    ...
                    eventDatagetSelectedData255.params =
                      [
                    ...
                    const eventDatagetSelectedData256: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData256.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode548: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode548.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode549: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode549.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId48: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId48.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0007_0017$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
