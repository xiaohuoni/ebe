...
const pageId = '896687874698616832';
const ClsCp_0002_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_5449066: any) => {
    const eventDatacustomActionCode202: any = [
      {
        type: 'customActionCode',
        dataId: 167288403760859460,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '856298',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_5449066;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167288406433653400,
            options: {
    ...
    eventDatacustomActionCode202.params =
      [
        {
          title: '事件入参',
          name: 'options_5449066',
          value: '$options_5449066$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode202,
      { options_5449066 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest548: any = [
      {
        type: 'apiRequest',
        dataId: 166972743288608500,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '803498',
        ...
        callback1: [
          {
            ...
            dataId: 166972743677503400,
            options: {
              compId: 'Input_690228_5400337_0085404_563907',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '995724',
    ...
    eventDataapiRequest548.params = [] || [];
    CMDGenerator(eventDataapiRequest548, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest549: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest549.params = [] || [];
    CMDGenerator(eventDataapiRequest549, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse275: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
                  ...
                  dataSourceSetValue: [
                    {
                      ...
                      type: 'string',
                      initialData: { type: 'static' },
                      value: { type: [], code: 'applicationExp' },
                    },
                  ],
                  operateType: 1,
                  onlySetPatch: true,
              ...
              {
                type: 'setValue',
                dataId: 166539139731508670,
                options: {
                  compId: 'Input_361479_887285_2150708_701744_517504',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '518566',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746158352615100,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746159755464700,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166545306465640260,
                options: {
                  compId: 'Form_449441_818139_96141_47766',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '64834',
    ...
    eventDataifelse275.params = [] || [];
    CMDGenerator(eventDataifelse275, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_4007919_5609774',
                  uid: 'Form_4311097_9385662_4007919_5609774',
                  type: 'Form',
                  ...componentItem,
                }}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(
                    r,
                    'Form_4311097_9385662_4007919_5609774',
                  )
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_979108_885687',
                    uid: 'Checkbox_882584_5289015_934499_979108_885687',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_979108_885687',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_310701_069428_315146"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_310701_069428_315146',
                    uid: 'View_310701_069428_315146',
                    type: 'View',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_310701_069428_315146')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_701744_517504',
                    uid: 'Input_361479_887285_2150708_701744_517504',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_701744_517504',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_818139_96141_47766',
              uid: 'Form_449441_818139_96141_47766',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource257: any = [
                {
                  type: 'setDataSource',
                    ...
                    dataSourceSetValue: [
                      {
                        ...
                        value: {
                          type: [
                            'form',
                            'Form_449441_818139_96141_47766',
                            'getFieldsValue',
                          ],
                          code: 'applicationExp',
                        },
              ...
              eventDatasetDataSource257.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_818139_96141_47766')
            }
            {...injectData}
          >
            <TextArea
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'applicationExp'}
              value={data?.factorForm?.applicationExp}
              formItemIndex={0}
              allowClear={true}
              disabled={false}
              tipIcon={{
              ...
              tipContent={
                '该集团主要为XX（集团简单介绍），原已合作物联网业务，因XX原因需申请机卡绑定自助重捆。'
              }
              $$componentItem={{
                id: 'Input_closeDownExp_015954_2821861_682734_580884',
                uid: 'Input_closeDownExp_015954_2821861_682734_580884',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Input_closeDownExp_015954_2821861_682734_580884',
                )
              }
              {...injectData}
            />
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_51204_65577685',
                uid: 'Form_395851_1727917_51204_65577685',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_51204_65577685')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_0085404_563907',
                  uid: 'Input_690228_5400337_0085404_563907',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_0085404_563907')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_128086_1984023"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_128086_1984023',
                  uid: 'View_22346374_875512_128086_1984023',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_128086_1984023')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_5748796_4556067',
                    uid: 'StdUpload_6230546_867413_5748796_4556067',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData423: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166539265066282200,
                        options: {
                          compId: 'Input_690228_5400337_0085404_563907',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_378448[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_378448[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData423.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode792: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode792.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'StdUpload_6230546_867413_5748796_4556067',
                    )
                  }
                  {...injectData}
                />
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode793: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode793.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId103: any = [
                {
              ...
              eventDatadownloadByFileId103.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_724599')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0002_0004$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
