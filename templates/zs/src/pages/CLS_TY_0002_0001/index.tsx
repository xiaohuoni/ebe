...
const pageId = '889336347633479680';
const ClsTy_0002_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_40634: any) => {
    const eventDatacustomActionCode212: any = [
      {
        type: 'customActionCode',
        dataId: 167238819882880100,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '237376',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_40634;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238822157122620,
            options: {
    ...
    eventDatacustomActionCode212.params =
      [
        { title: '事件入参', name: 'options_40634', value: '$options_40634$' },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode212,
      { options_40634 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest583: any = [
      {
        type: 'apiRequest',
        dataId: 166977372631519780,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '677094',
        ...
        callback1: [
          {
            ...
            dataId: 166977372897647520,
            options: {
              compId: 'Input_690228_620812',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '070376',
    ...
    eventDataapiRequest583.params = [] || [];
    CMDGenerator(eventDataapiRequest583, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest584: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest584.params = [] || [];
    CMDGenerator(eventDataapiRequest584, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse292: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166364115479458000,
                options: {
                  compId: 'Input_361479_887285_306646',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '579527',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166745784125653900,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166745786134688860,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166364120577703600,
                options: {
                  compId: 'Form_449441_4870275',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '982504',
    ...
    eventDataifelse292.params = [] || [];
    CMDGenerator(eventDataifelse292, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_376582')}
          {...injectData}
        />
        <View
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_775523',
                  uid: 'Form_4311097_775523',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) => refs.setComponentRef(r, 'Form_4311097_775523')}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_70298',
                    uid: 'Checkbox_882584_5289015_70298',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Checkbox_882584_5289015_70298')
                  }
                  {...injectData}
                />
                <View
                  className="View_View_088504"
                  name={'布局容器'}
                  visible={true}
                  labelCol={8}
                  wrapperCol={16}
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_088504')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_306646',
                    uid: 'Input_361479_887285_306646',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Input_361479_887285_306646')
                  }
                  {...injectData}
                />
              </Form>
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_4870275',
              uid: 'Form_449441_4870275',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource271: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource271.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_4870275')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'installExp'}
              value={data?.factorForm?.installExp}
              formItemIndex={0}
              tipIcon={{
                theme: 'outlined',
                type: 'question-circle',
              ...
              tipContent={
                '该集团主要为XX（集团简单介绍），原已合作XX业务，因XX原因需申请行业终端安装。'
              }
              disabled={false}
              allowClear={true}
              $$componentItem={{
                id: 'Input_installExp_0078473',
                uid: 'Input_installExp_0078473',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              onChange={(e: any) => {
                const eventDatasetDataSource273: any = [
                  {
                    type: 'setDataSource',
                    dataId: 166719925911904130,
                    options: {
                      compId: 'setDataSource',
                      compName: 'page',
                      id: '91063',
                ...
                eventDatasetDataSource273.params =
                  [
                    {
                      title: '文本域取值',
                      name: 'e',
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_installExp_0078473')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_2430075',
                uid: 'Form_395851_2430075',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) => refs.setComponentRef(r, 'Form_395851_2430075')}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_620812',
                  uid: 'Input_690228_620812',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => refs.setComponentRef(r, 'Input_690228_620812')}
                {...injectData}
              />
              <View
                className="View_View_22346374_9278063"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_9278063',
                  uid: 'View_22346374_9278063',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_9278063')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_17963',
                    uid: 'StdUpload_6230546_17963',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData443: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166364135360278050,
                        options: {
                          compId: 'Input_690228_620812',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_2473235[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_2473235[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData443.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode820: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode820.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_17963')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode821: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode821.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId113: any = [
                {
              ...
              eventDatadownloadByFileId113.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_343258')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsTy_0002_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
