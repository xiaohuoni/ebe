...
const pageId = '1069099716064563200';
const ClsJc_0008_0007$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDataapiRequest100: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest100.params = [] || [];
    CMDGenerator(eventDataapiRequest100, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse70: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse70.params = [] || [];
    CMDGenerator(eventDataifelse70, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        ...
        <Form
          ...
          style={{ padding: '0px 0px 0px 0px' }}
          onValuesChange={() => {
            const eventDatasetDataSource37: any = [
              {
                type: 'setDataSource',
            ...
            eventDatasetDataSource37.params = [] || [];
            CMDGenerator(eventDatasetDataSource37, {}, 'setDataSource', {
              id: 'setDataSource',
              name: 'setDataSource',
              type: 'setDataSource',
              platform: 'pc',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode334: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode334.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId9: any = [
                {
              ...
              eventDatadownloadByFileId9.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn2={(rowId: any, row: any, index: any) => {
              const eventDatapreviewFile3: any = [
                {
                  type: 'previewFile',
...
export default withPageHOC(ClsJc_0008_0007$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
