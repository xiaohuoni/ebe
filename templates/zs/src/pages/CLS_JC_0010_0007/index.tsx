      ...
      >
        ...
        >
          ...
          <Input
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_custCode_511461'] = r)}
            {...injectData}
          />
          <Input
            name={'客户名称'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_custName_982512'] = r)}
            {...injectData}
          />
          <Input
            name={'调账账户标识'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_acctCode_149112'] = r)}
            {...injectData}
          />
          <Select
            name={'调账请求类型'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_requestType_056471'] = r)}
            {...injectData}
          />
          <Input
            name={'调账金额（含税）'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_requestAmtTotal_246214'] = r)}
            {...injectData}
          />
          <Input
            name={'账本类型名称'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_balanceTypeName_430152'] = r)}
            {...injectData}
          />
          <Select
            name={'调账原因'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_adjustReasonCode_001258'] = r)}
            {...injectData}
          />
        </Form>
        <Table
