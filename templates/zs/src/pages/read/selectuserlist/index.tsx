...
const pageId = '1029331982738386944';
const ReadSelectuserlist$$Modal: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const onOk = () => {
    const eventDatagetCurrentFormValues15: any = [
      {
    ...
    eventDatagetCurrentFormValues15.params = [] || [];
    CMDGenerator(eventDatagetCurrentFormValues15, {}, 'getCurrentFormValues', {
  ...
  const onCancel = () => {
    const eventDatacloseModal57: any = [
      {
        type: 'closeModal',
        dataId: '285762_1',
    ...
    eventDatacloseModal57.params = [] || [];
    CMDGenerator(eventDatacloseModal57, {}, 'closeModal', {
      id: 'closeModal',
      name: 'closeModal',
      type: 'closeModal',
      platform: 'undefined',
  ...
  useEffect(() => {
    const eventDataapiRequest413: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest413.params = [] || [];
    CMDGenerator(eventDataapiRequest413, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
      ...
      >
          ...
          >
            <Tree
              ...
              onSelect={(selectedKeys: any, { node }: any) => {
                const eventDatasetLoading203: any = [
                  {
                    type: 'setLoading',
                ...
                const eventDataclearValue162: any = [
                  {
                    type: 'clearValue',
                ...
                const eventDatareloadDataSource90: any = [
                  {
                    type: 'reloadDataSource',
                ...
                eventDatareloadDataSource90.params =
                  [
                    {
                      title: '节点key(单选)',
                      name: 'selectedKeys',
        ...
        >
          ...
          <Input
            ...
            readOnly={false}
            onIconClick={() => {
              const eventDatasetLoading204: any = [
                {
                  type: 'setLoading',
              ...
              eventDatasetLoading204.params = [] || [];
              CMDGenerator(eventDatasetLoading204, {}, 'setLoading', {
                id: 'setLoading',
                name: 'setLoading',
                type: 'setLoading',
                platform: 'pc',
              });
              const eventDatagetTreeSelectedKey8: any = [
                {
                  type: 'getTreeSelectedKey',
              ...
              eventDatagetTreeSelectedKey8.params = [] || [];
              CMDGenerator(
                eventDatagetTreeSelectedKey8,
                {},
                'getTreeSelectedKey',
                {
            ...
            onPressEnter={(e: any) => {
              const eventDatasetLoading205: any = [
                {
                  type: 'setLoading',
              ...
              eventDatasetLoading205.params =
                [
                  { title: '输入框取值', name: 'e', value: '$e.target.value$' },
                ] || [];
              CMDGenerator(eventDatasetLoading205, { e }, 'setLoading', {
                id: 'setLoading',
                name: 'setLoading',
                type: 'setLoading',
                platform: 'pc',
              });
              const eventDatagetTreeSelectedKey9: any = [
                {
                  type: 'getTreeSelectedKey',
              ...
              eventDatagetTreeSelectedKey9.params =
                [
                  { title: '输入框取值', name: 'e', value: '$e.target.value$' },
                ] || [];
              CMDGenerator(
                eventDatagetTreeSelectedKey9,
                { e },
                'getTreeSelectedKey',
                {
                  id: 'getTreeSelectedKey',
          ...
          <Table
            ...
            onSelectChange={(selectedRowKeys: any, selectedRows: any) => {
              const eventDatagetTableSelected69: any = [
                {
              ...
              eventDatagetTableSelected69.params =
                [
                  {
                    title: '表格选中行id(单选)',
            ...
            onPageChange={(page: any, pageSize: any) => {
              const eventDatasetLoading206: any = [
                {
                  type: 'setLoading',
              ...
              const eventDatagetTreeSelectedKey10: any = [
                {
                  type: 'getTreeSelectedKey',
              ...
              eventDatagetTreeSelectedKey10.params =
                [
                  {
                    title: '当前页码取值',
                    name: 'page',
          ...
          >
            <Input
              ...
              style={{ flex: '' }}
              onIconClick={() => {
                const eventDataclearTableSelected11: any = [
                  {
                ...
                eventDataclearTableSelected11.params = [] || [];
                CMDGenerator(
                  eventDataclearTableSelected11,
                  {},
                  'clearTableSelected',
                  {
                ...
                const eventDataclearValue165: any = [
                  {
                    type: 'clearValue',
                ...
                eventDataclearValue165.params = [] || [];
                CMDGenerator(eventDataclearValue165, {}, 'clearValue', {
                  id: 'clearValue',
                  name: 'clearValue',
                  type: 'clearValue',
                  platform: 'pc',
                });
                const eventDataclearValue166: any = [
                  {
                    type: 'clearValue',
                ...
                eventDataclearValue166.params = [] || [];
                CMDGenerator(eventDataclearValue166, {}, 'clearValue', {
                  id: 'clearValue',
                  name: 'clearValue',
                  type: 'clearValue',
                  platform: 'pc',
...
export default withPageHOC(ReadSelectuserlist$$Modal, {
  pageId,
  hasLogin: false,
  dataSource,
