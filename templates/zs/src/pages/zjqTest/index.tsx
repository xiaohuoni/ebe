...
const pageId = '919558457385832448';
const ZjqTest$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const select_node = (options_485879: any) => {
    const eventDatacustomActionCode26: any = [
      {
    ...
    eventDatacustomActionCode26.params =
      [
        {
          title: '事件入参',
          name: 'options_485879',
  ...
  const onLoadSceneNode = (options_485601: any) => {
    ...
    CMDGenerator(eventDatagetValue13, { options_485601 }, 'getValue', {
      id: 'getValue',
      name: 'getValue',
      type: 'getValue',
      platform: 'undefined',
  ...
  useEffect(() => {
    const eventDatacallSelfFunc14: any = [
      {
        type: 'callSelfFunc',
    ...
    eventDatacallSelfFunc14.params = [] || [];
    CMDGenerator(eventDatacallSelfFunc14, {}, 'callSelfFunc', {
      id: 'callSelfFunc',
      name: 'callSelfFunc',
      type: 'callSelfFunc',
      platform: 'undefined',
          ...
          >
            ...
            >
              <Input
                ...
                onPressEnter={(e: any) => {
                  const eventDatacallSelfFunc115: any = [
                    {
                      type: 'callSelfFunc',
                  ...
                  eventDatacallSelfFunc115.params =
                    [
                      {
                        title: '输入框取值',
                        name: 'e',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatacallSelfFunc116: any = [
                    {
                      type: 'callSelfFunc',
                  ...
                  eventDatacallSelfFunc116.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacallSelfFunc116,
                    { e },
                    'callSelfFunc',
                    {
                      id: 'callSelfFunc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 12px' }}
                onClick={(e: any) => {
                  const eventDataclearValue59: any = [
                    {
                      type: 'clearValue',
                  ...
                  eventDataclearValue59.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataclearValue59, { e }, 'clearValue', {
                    id: 'clearValue',
                    name: 'clearValue',
                    type: 'clearValue',
                    platform: 'pc',
                  });
                  const eventDatacallSelfFunc117: any = [
                    {
                      type: 'callSelfFunc',
                  ...
                  eventDatacallSelfFunc117.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacallSelfFunc117,
                    { e },
                    'callSelfFunc',
                    {
                      id: 'callSelfFunc',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDatahistory.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatahistory, { e }, 'history', {
                    id: 'history',
                    name: 'history',
                    type: 'history',
                    platform: 'pc',
                                ...
                                >
                                  ...
                                  >
                                    <GridView
                                      ...
                                      style={{ minHeight: 40 }}
                                      onChange={(vals: any) => {
                                        const eventDatacustomActionCode338: any =
                                          [
                                            {
                                              type: 'customActionCode',
                                        ...
                                        eventDatacustomActionCode338.params =
                                          [
                                            {
                                              title: '变化值',
                                              value: '$vals$',
                                ...
                                >
                                  ...
                                  >
                                    <GridView
                                      ...
                                      style={{ minHeight: 40 }}
                                      onChange={(vals: any) => {
                                        const eventDatacustomActionCode340: any =
                                          [
                                            {
                                              type: 'customActionCode',
                                        ...
                                        eventDatacustomActionCode340.params =
                                          [
                                            {
                                              title: '变化值',
                                              value: '$vals$',
                                ...
                                >
                                  ...
                                  >
                                    <GridView
                                      ...
                                      style={{ minHeight: 40 }}
                                      onChange={(vals: any) => {
                                        const eventDatacustomActionCode342: any =
                                          [
                                            {
                                              type: 'customActionCode',
                                        ...
                                        eventDatacustomActionCode342.params =
                                          [
                                            {
                                              title: '变化值',
                                              value: '$vals$',
                                ...
                                >
                                  ...
                                  >
                                    <GridView
                                      ...
                                      style={{ minHeight: 40 }}
                                      onChange={(vals: any) => {
                                        const eventDatacustomActionCode344: any =
                                          [
                                            {
                                              type: 'customActionCode',
                                        ...
                                        eventDatacustomActionCode344.params =
                                          [
                                            {
                                              title: '变化值',
                                              value: '$vals$',
              ...
              >
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={(e: any) => {
                      const eventDatacustomActionCode345: any = [
                        {
                          type: 'customActionCode',
                      ...
                      eventDatacustomActionCode345.params =
                        [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                      CMDGenerator(
                        eventDatacustomActionCode345,
                        { e },
                        'customActionCode',
                        {
                          id: 'customActionCode',
                  ...
                  <Button
                    ...
                    onClick={(e: any) => {
                      const eventDatacustomActionCode346: any = [
                        {
                          type: 'customActionCode',
                      ...
                      eventDatacustomActionCode346.params =
                        [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                      CMDGenerator(
                        eventDatacustomActionCode346,
                        { e },
                        'customActionCode',
                        {
                          id: 'customActionCode',
...
export default withPageHOC(ZjqTest$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
