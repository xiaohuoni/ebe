...
const pageId = '892675308829511680';
const ClsCp_0005_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_66405: any) => {
    const eventDatacustomActionCode216: any = [
      {
        type: 'customActionCode',
        dataId: 167282463209359260,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '238109',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_66405;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167282464392095360,
            options: {
    ...
    eventDatacustomActionCode216.params =
      [
        { title: '事件入参', name: 'options_66405', value: '$options_66405$' },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode216,
      { options_66405 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest592: any = [
      {
        type: 'apiRequest',
        dataId: 166972765145085380,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '777927',
        ...
        callback1: [
          {
            ...
            dataId: 166972765450899940,
            options: {
              compId: 'Input_690228_5400337_93977105',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '3327519',
              data: '$reply_777927?.resultData$',
    ...
    eventDataapiRequest592.params = [] || [];
    CMDGenerator(eventDataapiRequest592, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest593: any = [
      {
        type: 'apiRequest',
        dataId: 166951674156765220,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '584843',
              ...
              children: [
                {
                  ...
                  parents: ['body'],
                  id: 'body.catalogCode',
                  dataKey: '584843_body.catalogCode',
                  value: { type: ['customize'], code: '$state.catalogCode$' },
                },
                {
                  code: 'attrCode',
        ...
        callback1: [
          {
            type: 'reloadSelectData',
            dataId: 166951681043797900,
            options: {
              compId: 'Input_openBill_515506',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '867968',
              data: '$reply_584843?.resultData$',
              labelKey: 'attrValueName',
              valueKey: 'attrValue',
            },
            line_number: 4,
    ...
    eventDataapiRequest593.params = [] || [];
    CMDGenerator(eventDataapiRequest593, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest594: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest594.params = [] || [];
    CMDGenerator(eventDataapiRequest594, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse297: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166443631905982900,
                options: {
                  compId: 'Input_361479_887285_2150708_4324605',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '521343',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746125229883900,
                elseIfs: [],
                line_number: 14,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746126521780320,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166443638039880900,
                options: {
                  compId: [
                    'Input_361479_887285_2150708_4324605',
                    'Form_449441_818139_063895',
                  ],
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
    ...
    eventDataifelse297.params = [] || [];
    CMDGenerator(eventDataifelse297, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_340886',
                  uid: 'Form_4311097_9385662_340886',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_340886')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_4004793',
                    uid: 'Checkbox_882584_5289015_934499_4004793',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_4004793',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_310701_142798"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_310701_142798',
                    uid: 'View_310701_142798',
                    type: 'View',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_310701_142798')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_4324605',
                    uid: 'Input_361479_887285_2150708_4324605',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_818139_063895',
              uid: 'Form_449441_818139_063895',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource278: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource278.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_818139_063895')
            }
            {...injectData}
          >
            <Select
              ...
              $$componentItem={{
                id: 'Input_openBill_515506',
                uid: 'Input_openBill_515506',
                type: 'Select',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_openBill_515506')}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
              ...
              tipContent={
                '该集团主要为XX（集团简单介绍），原已合作XX业务。因XX原因，申请开通呼叫中心直连业务，并开通6秒计费，合作期XX年。'
              }
              $$componentItem={{
                id: 'Input_076202',
                uid: 'Input_076202',
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_076202')}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_6675779',
                uid: 'Form_395851_1727917_6675779',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_6675779')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_93977105',
                  uid: 'Input_690228_5400337_93977105',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_93977105')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_5641205"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_5641205',
                  uid: 'View_22346374_875512_5641205',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_5641205')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_1898286',
                    uid: 'StdUpload_6230546_867413_1898286',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData451: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166443654644645380,
                        options: {
                          compId: 'Input_690228_5400337_93977105',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_204107[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_204107[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData451.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode846: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode846.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_1898286')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode847: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode847.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId117: any = [
                {
              ...
              eventDatadownloadByFileId117.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_442984')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0005_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
