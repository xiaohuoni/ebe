...
const pageId = '1047434022239449088';
const ClsCp_0017_0001ProdAttrcopy$$Modal: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const onCancel = () => {
    const eventDatacloseModal36: any = [
      {
        type: 'closeModal',
        dataId: '108945_1',
    ...
    eventDatacloseModal36.params = [] || [];
    CMDGenerator(eventDatacloseModal36, {}, 'closeModal', {
      id: 'closeModal',
      name: 'closeModal',
      type: 'closeModal',
      platform: 'undefined',
  ...
  useEffect(() => {
    ...
    const eventDatacustomActionCode254: any = [
      {
    ...
    eventDatacustomActionCode254.params = [] || [];
    CMDGenerator(eventDatacustomActionCode254, {}, 'customActionCode', {
      id: 'customActionCode',
...
export default withPageHOC(ClsCp_0017_0001ProdAttrcopy$$Modal, {
  pageId,
  hasLogin: false,
