...
const pageId = '892614488988815360';
const ClsCp_0004_0005$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_463633: any) => {
    const eventDatacustomActionCode187: any = [
      {
        type: 'customActionCode',
        dataId: 167282450502017060,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '5214135',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_463633;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167282451793908960,
            options: {
    ...
    eventDatacustomActionCode187.params =
      [
        {
          title: '事件入参',
          name: 'options_463633',
          value: '$options_463633$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode187,
      { options_463633 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest507: any = [
      {
        type: 'apiRequest',
        dataId: 166972706984107550,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '893651',
        ...
        callback1: [
          {
            ...
            dataId: 166972707888389570,
            options: {
              compId: 'Input_690228_5400337_4013303',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '2367298',
              data: '$reply_893651?.resultData$',
    ...
    eventDataapiRequest507.params = [] || [];
    CMDGenerator(eventDataapiRequest507, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest508: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest508.params = [] || [];
    CMDGenerator(eventDataapiRequest508, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse262: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166442044486834180,
                options: {
                  compId: 'Input_361479_887285_2150708_041269',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '89242',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746109270982800,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746110611064200,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                options: {
                  compId: ['Form_449441', 'Form_449441_818139_15192205'],
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '142454',
    ...
    eventDataifelse262.params = [] || [];
    CMDGenerator(eventDataifelse262, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_545922',
                  uid: 'Form_4311097_9385662_545922',
                  type: 'Form',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_545922')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_405217',
                    uid: 'Checkbox_882584_5289015_934499_405217',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  disabled={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_405217',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_310701_325893"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_310701_325893',
                    uid: 'View_310701_325893',
                    type: 'View',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_310701_325893')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_041269',
                    uid: 'Input_361479_887285_2150708_041269',
                    type: 'Input',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_041269',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            wrapperCol={16}
            $$componentItem={{
              id: 'Form_449441_818139_15192205',
              uid: 'Form_449441_818139_15192205',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource229: any = [
                {
                  type: 'setDataSource',
                  ...
                  callback1: [
                    {
                      type: 'console',
                      dataId: 167566993479451260,
                      options: {
                        compId: 'debug',
                        compName: 'system',
                        id: '686161',
                        pageJsonId: '537892',
                        value: ['$data.sceneSubmit$'],
                      },
                      line_number: 2,
                    },
                    {
                      ...
                      options: {
                        ...
                        pageJsonId: '537892',
                        actionTitle: '',
                        code: 'function main(data,state,success,fail){var attrList=[];var obj=data.factorForm;for(var key in obj){attrList.push({"attrCode":key,"attrName":"","attrValue":obj[key]})}data.sceneSubmit.attrList=attrList;console.log("\\u63D0\\u4EA4\\u6570\\u636E\\u540E\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002\\u3002");console.log(data.sceneSubmit);success(attrList)};',
                      },
                      line_number: 3,
                      callback1: [
                        {
                          type: 'console',
                          dataId: 167566908516670880,
                          options: {
                            compId: 'debug',
                            compName: 'system',
                            id: '574787',
              ...
              eventDatasetDataSource229.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_818139_15192205')
            }
            {...injectData}
          >
            <Input
              ...
              postfixIconPosition={'before'}
              required={true}
              placeholder={'使用固话号码数量'}
              formItemIndex={0}
              fieldName={'fixedPhoneNum'}
              value={data?.factorForm?.fixedPhoneNum}
              labelCol={'8'}
              wrapperCol={16}
              regexp={[
                {
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_539683')}
              {...injectData}
            />
            <Input
              name={'需求并发数量(路)'}
              ...
              postfixIconPosition={'before'}
              required={true}
              placeholder={'需求并发数量(路)'}
              formItemIndex={1}
              fieldName={'concurrentNum'}
              value={data?.factorForm?.concurrentNum}
              regexp={[
                {
                  id: '079072',
                  title: '按钮1',
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_614815')}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
              ...
              tipContent={
                '该集团号码用于XXXX（如日常办公、客户服务），不存在违法违纪等外呼行为。为了统一企业形象，需开通固话号码多路并发功能，以实现统一号码呼入呼出'
              }
              $$componentItem={{
                id: 'TextArea_5917244',
                uid: 'TextArea_5917244',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={false}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'TextArea_5917244')}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_555869',
                uid: 'Form_395851_1727917_555869',
                type: 'Form',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_555869')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_4013303',
                  uid: 'Input_690228_5400337_4013303',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_4013303')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_377114"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_377114',
                  uid: 'View_22346374_875512_377114',
                  type: 'View',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_377114')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_3438645',
                    uid: 'StdUpload_6230546_867413_3438645',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData403: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166443134359811650,
                        options: {
                          compId: 'Input_690228_5400337_4013303',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_6916141[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_6916141[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData403.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode752: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode752.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_3438645')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode753: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode753.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId92: any = [
                {
              ...
              eventDatadownloadByFileId92.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_6962184')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0004_0005$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
