      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) => (refs['Form_4311097_8526194'] = r)}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  ref={(r: any) => (refs['Checkbox_882584_5289015_890802'] = r)}
                  {...injectData}
                />
                <View
                  name={'布局容器'}
                  ...
                  ref={(r: any) => (refs['View_556162_526521'] = r)}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Input_361479_887285_058308'] = r)}
                  {...injectData}
                />
              </Form>
            </View>
          ...
          <Form
            ...
            ref={(r: any) => (refs['Form_449441_539172'] = r)}
            {...injectData}
          >
            <Input
              name={'代领数量'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_replaceNum_880765'] = r)}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_auditContent_873691'] = r)}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              ref={(r: any) => (refs['Form_395851_7871937'] = r)}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_690228_573067'] = r)}
                {...injectData}
              />
              <View
                name={'布局容器'}
                ...
                ref={(r: any) => (refs['View_22346374_4656902'] = r)}
                {...injectData}
              >
                <StdUpload
                  name={'附件上传'}
                  ...
                  ref={(r: any) => (refs['StdUpload_6230546_661344'] = r)}
                  {...injectData}
                />
              </View>
            </Form>
