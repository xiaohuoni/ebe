...
const pageId = '899273020350111744';
const ClsYx_0002_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDataapiRequest512: any = [
      {
        type: 'apiRequest',
        dataId: 166977392225118460,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '437676',
        ...
        callback1: [
          {
            ...
            dataId: 166977392444530620,
            options: {
              compId: 'Input_690228_573067',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '656119',
    ...
    eventDataapiRequest512.params = [] || [];
    CMDGenerator(eventDataapiRequest512, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest513: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest513.params = [] || [];
    CMDGenerator(eventDataapiRequest513, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse265: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166601001478355970,
                options: {
                  compId: 'Input_361479_887285_058308',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '114573',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746271993779100,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746273566626620,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166601003522378660,
                options: {
                  compId: 'Form_449441_539172',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '40476',
    ...
    eventDataifelse265.params = [] || [];
    CMDGenerator(eventDataifelse265, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_8526194',
                  uid: 'Form_4311097_8526194',
                  type: 'Form',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_8526194')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_890802',
                    uid: 'Checkbox_882584_5289015_890802',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  disabled={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Checkbox_882584_5289015_890802')
                  }
                  {...injectData}
                />
                <View
                  className="View_View_556162_526521"
                  name={'布局容器'}
                  labelCol={8}
                  wrapperCol={16}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_556162_526521',
                    uid: 'View_556162_526521',
                    type: 'View',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_556162_526521')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_058308',
                    uid: 'Input_361479_887285_058308',
                    type: 'Input',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Input_361479_887285_058308')
                  }
                  {...injectData}
                />
              </Form>
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_539172',
              uid: 'Form_449441_539172',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource231: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource231.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_539172')}
            {...injectData}
          >
            <Input
              name={'代领数量'}
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'replaceNum'}
              value={data?.factorForm?.replaceNum}
              formItemIndex={0}
              regexp={[
                {
                  id: '881657',
              ...
              $$componentItem={{
                id: 'Input_replaceNum_880765',
                uid: 'Input_replaceNum_880765',
                type: 'Input',
                ...componentItem,
              }}
              disabled={false}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_replaceNum_880765')
              }
              {...injectData}
            />
            <TextArea
              ...
              tipContent={
                '该集团主要为XX（集团简单介绍），原已合作XX业务，因XX原因需申请营销品代领。'
              }
              allowClear={true}
              $$componentItem={{
                id: 'Input_auditContent_873691',
                uid: 'Input_auditContent_873691',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={false}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_auditContent_873691')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_7871937',
                uid: 'Form_395851_7871937',
                type: 'Form',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Form_395851_7871937')}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_573067',
                  uid: 'Input_690228_573067',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => refs.setComponentRef(r, 'Input_690228_573067')}
                {...injectData}
              />
              <View
                className="View_View_22346374_4656902"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_4656902',
                  uid: 'View_22346374_4656902',
                  type: 'View',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_4656902')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_661344',
                    uid: 'StdUpload_6230546_661344',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData407: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166601007531972320,
                        options: {
                          compId: 'Input_690228_573067',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_276978[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_276978[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData407.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode758: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode758.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_661344')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode759: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode759.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId94: any = [
                {
              ...
              eventDatadownloadByFileId94.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsYx_0002_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
