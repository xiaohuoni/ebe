  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_887424_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        >
          <Divider
            ...
            ref={(r: any) => (refs['Divider_811515'] = r)}
            {...injectData}
          />
          <View
            name={'布局容器'}
          ...
          >
            <HorizontalView
              ...
              ref={(r: any) => (refs['HorizontalView_1128569'] = r)}
              {...injectData}
            >
              <View
                name={'布局容器'}
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    ref={(r: any) => (refs['Checkbox_4777784'] = r)}
                    {...injectData}
                  />
                  <View
                    name={'布局容器'}
          ...
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_252152'] = r)}
            {...injectData}
          />
        </View>
      </View>
