...
const pageId = '885091849311047680';
const ClsCp_0009_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_7049216: any) => {
    const eventDatacustomActionCode208: any = [
      {
        type: 'customActionCode',
        dataId: 167238943487492350,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '593174',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_7049216;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238944465776540,
            options: {
    ...
    eventDatacustomActionCode208.params =
      [
        {
          title: '事件入参',
          name: 'options_7049216',
          value: '$options_7049216$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode208,
      { options_7049216 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest575: any = [
      {
        type: 'apiRequest',
        dataId: 166972741242136830,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '862534',
    ...
    eventDataapiRequest575.params = [] || [];
    CMDGenerator(eventDataapiRequest575, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest576: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest576.params = [] || [];
    CMDGenerator(eventDataapiRequest576, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse288: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166262880846397280,
                options: {
                  compId: 'Input_361479_887285_2150708_923492',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '117392',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746147285252350,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746148618207970,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166262883844800770,
                options: {
                  compId: 'Form_449441_2604934',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '7867445',
    ...
    eventDataifelse288.params = [] || [];
    CMDGenerator(eventDataifelse288, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_0413915',
                  uid: 'Form_4311097_9385662_0413915',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_0413915')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_6069114',
                    uid: 'Checkbox_882584_5289015_934499_6069114',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_6069114',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_5097806"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_5097806')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_923492',
                    uid: 'Input_361479_887285_2150708_923492',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_2604934',
              uid: 'Form_449441_2604934',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource267: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource267.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_2604934')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              disabled={false}
              $$componentItem={{
                id: 'Input_closeDownExp_015954_564489',
                uid: 'Input_closeDownExp_015954_564489',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_564489')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_005435',
                uid: 'Form_395851_1727917_005435',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_005435')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_5332635',
                  uid: 'Input_690228_5400337_5332635',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_5332635')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_807573"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_807573',
                  uid: 'View_22346374_875512_807573',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_807573')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_48478',
                    uid: 'StdUpload_6230546_867413_48478',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData435: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166270874916665730,
                        options: {
                          compId: 'Input_690228_5400337_5332635',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_233292[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                    ...
                    eventDatagetSelectedData435.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode808: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode808.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_48478')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode809: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode809.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId109: any = [
                {
              ...
              eventDatadownloadByFileId109.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_548427')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0009_0004$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
