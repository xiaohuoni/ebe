...
const pageId = '1049982309668941824';
const ClsJc_0008_0006$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1783384: any) => {
    const eventDatacustomActionCode87: any = [
      {
    ...
    eventDatacustomActionCode87.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse141.params = [] || [];
    CMDGenerator(eventDataifelse141, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          >
            <Divider
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => refs.setComponentRef(r, 'Divider_908054')}
              {...injectData}
            />
            <View
              className="View_View_118704"
              name={'布局容器'}
              labelCol={8}
              wrapperCol={16}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_118704')}
              {...injectData}
            />
            <View
              className="View_View_851407"
              name={'布局容器'}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
                id: 'View_851407',
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_851407')}
              {...injectData}
            />
            <Input
              name={'转帐方户名'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_054471')}
              {...injectData}
            />
            <Input
              name={'摘要'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_466285')}
              {...injectData}
            />
            <TextArea
              name={'附言'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_008568')}
              {...injectData}
            />
            <Input
              name={'收款方户名'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_54492952')}
              {...injectData}
            />
            <Input
              name={'收款方帐号'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_6836975')}
              {...injectData}
            />
            <Input
              name={'是否政企专户'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_2721102')}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => refs.setComponentRef(r, 'Divider_319536')}
              {...injectData}
            />
            <View
              className="View_View_164685"
              name={'布局容器'}
              labelCol={8}
              wrapperCol={16}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_164685')}
              {...injectData}
            />
            <View
              className="View_View_864186"
              name={'布局容器'}
              labels={[]}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_864186')}
              {...injectData}
            />
            <Input
              name={'资金区域'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_818163')}
              {...injectData}
            />
            <Input
              name={'冻结类型'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_376929')}
              {...injectData}
            />
            <Input
              name={'转入银行'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_494792')}
              {...injectData}
            />
            <Input
              name={'转入银行户名'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_3133432')}
              {...injectData}
            />
            <Input
              name={'转入银行帐号'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_863567')}
              {...injectData}
            />
            <Input
              name={'退款银行'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_64505')}
              {...injectData}
            />
            <Input
              name={'退款银行户名'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_825322')}
              {...injectData}
            />
            <Input
              name={'退款银行帐号'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_2344667')}
              {...injectData}
            />
          </Form>
          <BusiComp0521965
...
export default withPageHOC(ClsJc_0008_0006$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
