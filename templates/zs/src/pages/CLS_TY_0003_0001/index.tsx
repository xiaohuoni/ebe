...
const pageId = '885092591077163008';
const ClsTy_0003_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_5203893: any) => {
    const eventDatacustomActionCode129: any = [
      {
        type: 'customActionCode',
        dataId: 167238838473921860,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '26887315',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_5203893;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238839990822140,
            options: {
    ...
    eventDatacustomActionCode129.params =
      [
        {
          title: '事件入参',
          name: 'options_5203893',
          value: '$options_5203893$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode129,
      { options_5203893 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest385: any = [
      {
        type: 'apiRequest',
        dataId: 166977378641506080,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '4643414',
        ...
        callback1: [
          {
            ...
            dataId: 166977378884005000,
            options: {
              compId: 'Input_690228_5400337_664203',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '3468997',
              data: '$reply_4643414?.resultData$',
    ...
    eventDataapiRequest385.params = [] || [];
    CMDGenerator(eventDataapiRequest385, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDatareloadSelectData13: any = [
      {
        type: 'reloadSelectData',
        dataId: 166403914220576130,
        options: {
          compId: 'Input_361479_887285_2150708_0769527',
          compLib: 'comm',
          pageJsonId: '537892',
          compName: 'Select',
          id: '3530902',
          data: '$state.auditClassSele$',
          labelKey: 'tacheName',
    ...
    eventDatareloadSelectData13.params = [] || [];
    CMDGenerator(eventDatareloadSelectData13, {}, 'reloadSelectData', {
      id: 'reloadSelectData',
      name: 'reloadSelectData',
      type: 'reloadSelectData',
      platform: 'undefined',
    });
    const eventDataapiRequest386: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest386.params = [] || [];
    CMDGenerator(eventDataapiRequest386, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse201: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166745804532990820,
                elseIfs: [],
                line_number: 13,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166745815629019360,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              {
                type: 'setDisable',
                dataId: 166262918496895580,
                options: {
                  compId: 'Form_449441_8256383',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '3487534',
    ...
    eventDataifelse201.params = [] || [];
    CMDGenerator(eventDataifelse201, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_37694')}
          {...injectData}
        />
        <View
          name={'布局容器'}
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_952339',
                  uid: 'Form_4311097_9385662_952339',
                  type: 'Form',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_952339')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_099585',
                    uid: 'Checkbox_882584_5289015_934499_099585',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  disabled={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_099585',
                    )
                  }
                  {...injectData}
                />
                <View
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_111591')}
                  {...injectData}
                />
                <Select
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_0769527',
                    uid: 'Input_361479_887285_2150708_0769527',
                    type: 'Select',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  isFormRootChild={true}
                  onChange={(e: any) => {
                    const eventDatagetSelectedData325: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166402379345004700,
                        options: {
                          compId: 'Input_361479_887285_2150708_0769527',
                          compLib: 'comm',
                          pageJsonId: '537892',
                        ...
                        callback1: [
                          {
                            type: 'customActionCode',
                            dataId: 166402389648036000,
                            options: {
                              compId: 'customActionCode',
                              compName: 'page',
                              id: '765068',
                              pageJsonId: '537892',
                              code: 'function main(data,state,success,fail){data.sceneSubmit.approveGrade=selectedData_5249304[0].value;data.sceneSubmit.approveGradeName=selectedData_5249304[0].label;success()};',
                            },
                            line_number: 2,
                            callback1: [
                              {
                                type: 'callParentCustomFunc',
                                dataId: 166402399128845060,
                                options: {
                                  compId: 'callParentCustomFunc',
                                  compName: 'system',
                                  id: '863721',
                    ...
                    eventDatagetSelectedData325.params =
                      [{ title: '下拉框取值', name: 'e', value: '$e$' }] || [];
                    CMDGenerator(
                      eventDatagetSelectedData325,
                      { e },
                      'getSelectedData',
                      {
                        id: 'getSelectedData',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_0769527',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_8256383',
              uid: 'Form_449441_8256383',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource163: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource163.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_8256383')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              placeholder={'请输入'}
              fieldName={'applyDesc'}
              value={data?.factorForm?.applyDesc}
              formItemIndex={0}
              $$componentItem={{
                id: 'Input_closeDownExp_015954_0368127',
                uid: 'Input_closeDownExp_015954_0368127',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={false}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_0368127')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_8489048',
                uid: 'Form_395851_1727917_8489048',
                type: 'Form',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_8489048')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_664203',
                  uid: 'Input_690228_5400337_664203',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_664203')
                }
                {...injectData}
              />
              <View
                ...
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_844641',
                  uid: 'View_22346374_875512_844641',
                  type: 'View',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_844641')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_587895',
                    uid: 'StdUpload_6230546_867413_587895',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData327: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166415840959876860,
                        options: {
                          compId: 'Input_690228_5400337_664203',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_263568[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_263568[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData327.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode628: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode628.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_587895')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode629: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode629.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId63: any = [
                {
              ...
              eventDatadownloadByFileId63.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
          ...
          <BusiComp0521965
            ...
            ref={(r: any) => refs.setComponentRef(r, 'BOFramer_471176')}
            {...injectData}
          />
        </View>
      </View>
...
export default withPageHOC(ClsTy_0003_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
