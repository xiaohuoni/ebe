...
const pageId = '890557641205051392';
    ...
    >
      ...
      >
        ...
        >
              ...
              <Form
                ...
                ref={(r: any) =>
                  refs.setComponentRef(
                    r,
                    'Form_4311097_9385662_8411515_9167293_4337769_708507',
                  )
                }
                {...injectData}
              >
                ...
                />
                <View
                  className="View_View_6319234_3569864"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_6319234_3569864')
                  }
                  {...injectData}
                />
                <Input
          ...
          <View
            className="View_View_278839_3369926"
            name={'布局容器'}
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_278839_3369926')}
            {...injectData}
          >
            <Button
              name={'添加'}
            ...
            <StdUpload
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'StdUpload_4835215_7877536')
              }
              {...injectData}
            />
            <Button
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Button_430819')}
              {...injectData}
            />
            <Button
              name={'导出'}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Button_050256_034475_19183654')
              }
              {...injectData}
            />
          </View>
          ...
          <Table
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Table_8700198_4997642')}
            {...injectData}
          />
          <Form
            name={'要素表单'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_1648074')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'TextArea_794494')}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Form_395851_1727917_9692158_9612234_1000722_434628',
                )
              }
              {...injectData}
            >
              ...
              />
              <View
                className="View_View_22346374_875512_926873_4359147_729981_339083"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(
                    r,
                    'View_22346374_875512_926873_4359147_729981_339083',
                  )
                }
                {...injectData}
              >
        ...
        <Card
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Card_6933535')}
          {...injectData}
        >
          <VerticalView
            name={'上下布局'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'VerticalView_215699')}
            {...injectData}
          >
            <View
              className="View_View_687037"
              name={'布局容器'}
              $$componentItem={{
                id: 'View_687037',
                uid: 'View_687037',
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_687037')}
              {...injectData}
            >
              <HorizontalView
                name={'左右布局'}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'HorizontalView_1396834')
                }
                {...injectData}
              >
                <View
                  className="View_View_698028"
                  name={'布局容器'}
                  $$componentItem={{
                    id: 'View_698028',
                    uid: 'View_698028',
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_698028')}
                  {...injectData}
                >
                  <VerticalView
                    name={'上下布局'}
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'VerticalView_470981')
                    }
                    {...injectData}
                  >
                    <View
                      className="View_View_651127"
                      name={'布局容器'}
                      $$componentItem={{
                        id: 'View_651127',
                        uid: 'View_651127',
                      ...
                      ref={(r: any) => refs.setComponentRef(r, 'View_651127')}
                      {...injectData}
                    >
                      <Input
                        name={'受理结果'}
                        ...
                        readOnly={false}
                        ref={(r: any) =>
                          refs.setComponentRef(r, 'Input_887963')
                        }
                        {...injectData}
                      />
                    </View>
                    <View
                      className="View_View_010555"
                      name={'布局容器'}
                      $$componentItem={{
                        id: 'View_010555',
                        uid: 'View_010555',
                      ...
                      ref={(r: any) => refs.setComponentRef(r, 'View_010555')}
                      {...injectData}
                    >
                      <Text
                        name={'注意:'}
                        ...
                        ref={(r: any) => refs.setComponentRef(r, 'Text_359785')}
                        {...injectData}
                      />
                    </View>
                  </VerticalView>
                ...
                <View
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_965239')}
                  {...injectData}
                >
                  <Button
                    name={'重派'}
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'Button_3562167')}
                    {...injectData}
                  />
                </View>
              </HorizontalView>
            ...
            <View
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_082589')}
              {...injectData}
            >
              <Table
                name={'表格'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_886415')}
                {...injectData}
              />
            </View>
          </VerticalView>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_8459068')}
          {...injectData}
        />
      </View>
    </div>
