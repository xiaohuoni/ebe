  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_615837_1'] = r)}
        {...injectData}
      >
        <HorizontalView
          name={'左右布局'}
          ...
          ref={(r: any) => (refs['HorizontalView_446863'] = r)}
          {...injectData}
        >
          <View
            name={'布局容器'}
          ...
          >
            ...
            >
              <Description
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => (refs['Description_503174'] = r)}
                {...injectData}
              />
            </Card>
            <Card
            ...
            >
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      ref={(r: any) => (refs['Button_3440476'] = r)}
                      {...injectData}
                    />
                    <Button
                      name={'重置'}
                      ...
                      ref={(r: any) => (refs['Button_555132'] = r)}
                      {...injectData}
                    />
                  </View>
                </Form>
              ...
              >
                <Table
                  ...
                  ref={(r: any) => (refs['Table_22551098'] = r)}
                  {...injectData}
                />
              </View>
            </Card>
            ...
            >
              ...
              >
                <Select
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Select_491898'] = r)}
                  {...injectData}
                />
                <Select
                  name={'适用地市'}
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Select_0336964'] = r)}
                  {...injectData}
                />
                <Input
                  name={'要素名称'}
                ...
                <Select
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Select_119104'] = r)}
                  {...injectData}
                />
                <Select
                  name={'值来源'}
                  ...
                  ref={(r: any) => (refs['Select_031271'] = r)}
                  {...injectData}
                />
                <Input
                  name={'接口地址'}
                ...
                <TextArea
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['TextArea_729335'] = r)}
                  {...injectData}
                />
                <Input
                  name={'属性标识'}
              ...
              >
                <Button
                  ...
                  ref={(r: any) => (refs['Button_3133285'] = r)}
                  {...injectData}
                />
                <Button
                  name={'取消'}
                  ...
                  ref={(r: any) => (refs['Button_550582'] = r)}
                  {...injectData}
                />
              </View>
            </Card>
