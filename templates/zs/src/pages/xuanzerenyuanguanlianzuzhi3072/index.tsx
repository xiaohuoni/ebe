...
const Xuanzerenyuanguanlianzuzhi3072$$Modal: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const refreshTable = (options_572314: any) => {
    const eventDatasetLoading6: any = [
      {
        type: 'setLoading',
    ...
    CMDGenerator(eventDatasetLoading6, { options_572314 }, 'setLoading', {
      id: 'setLoading',
      name: 'setLoading',
      type: 'setLoading',
      platform: 'undefined',
  ...
  const onOk = () => {
    const eventDatagetTableSelected3: any = [
      {
                ...
                callback1: [
                  {
                    ...
                    options: {
                      ...
                      _capabilityCode: 'batchAddDcOaOrgUserRelSingleUser',
                      _apiCode: 'batchAddDcOaOrgUserRelSingleUser',
                      _source: 'rhin',
                      _serviceId: '953280295164989440',
                      _serviceTitle:
                        '单用户批量添加多组织-hyj: batchAddDcOaOrgUserRelSingleUser',
                      params: 'object',
                      apiRequestSetParams: [
                        {
                          code: 'header',
                          ...
                          children: [
                            {
                              ...
                              parents: ['body'],
                              id: 'body.relDataType',
                              dataKey: '910255_body.relDataType',
                            ...
                            },
                            {
                              ...
                              parents: ['body'],
                              id: 'body.orgCodes',
                              dataKey: '910255_body.orgCodes',
                              value: {
                                type: ['context', '$data_200181$'],
                                code: '',
                              },
                            },
                            {
    ...
    eventDatagetTableSelected3.params = [] || [];
    CMDGenerator(eventDatagetTableSelected3, {}, 'getTableSelected', {
      id: 'getTableSelected',
  ...
  const onCancel = () => {
    const eventDatacloseModal10: any = [
      {
        type: 'closeModal',
        dataId: '978597_1',
    ...
    eventDatacloseModal10.params = [] || [];
    CMDGenerator(eventDatacloseModal10, {}, 'closeModal', {
      id: 'closeModal',
      name: 'closeModal',
      type: 'closeModal',
      platform: 'undefined',
  ...
  useEffect(() => {
    const eventDatacallSelfFunc20: any = [
      {
        type: 'callSelfFunc',
    ...
    eventDatacallSelfFunc20.params = [] || [];
    CMDGenerator(eventDatacallSelfFunc20, {}, 'callSelfFunc', {
      id: 'callSelfFunc',
      name: 'callSelfFunc',
      type: 'callSelfFunc',
      platform: 'undefined',
  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_482782_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        >
          <Form
            ...
            ref={(r: any) => (refs['Form_148709_2103377_216161'] = r)}
            {...injectData}
          >
            <Input
              name={'组织编码'}
              ...
              onPressEnter={(e: any) => {
                const eventDatacallSelfFunc192: any = [
                  {
                    type: 'callSelfFunc',
                ...
                eventDatacallSelfFunc192.params =
                  [
                    {
                      title: '输入框取值',
                      name: 'e',
                ...
                CMDGenerator(eventDatacallSelfFunc192, { e }, 'callSelfFunc', {
                  id: 'callSelfFunc',
                  name: 'callSelfFunc',
                  type: 'callSelfFunc',
                  platform: 'pc',
              ...
              ref={(r: any) => (refs['Input_3889064_9887114_660871'] = r)}
              {...injectData}
            />
            <Input
              name={'组织名称'}
              ...
              isFormRootChild={true}
              onPressEnter={(e: any) => {
                const eventDatacallSelfFunc193: any = [
                  {
                    type: 'callSelfFunc',
                ...
                eventDatacallSelfFunc193.params =
                  [
                    {
                      title: '输入框取值',
                      name: 'e',
                ...
                CMDGenerator(eventDatacallSelfFunc193, { e }, 'callSelfFunc', {
                  id: 'callSelfFunc',
                  name: 'callSelfFunc',
                  type: 'callSelfFunc',
                  platform: 'pc',
              ...
              ref={(r: any) => (refs['Input_33684855_0267973_1469488'] = r)}
              {...injectData}
            />
            <View
              name={'布局容器'}
              ...
              ref={(r: any) => (refs['View_841498_8261476_979664'] = r)}
              {...injectData}
            >
              <View
                name={'布局容器'}
                ...
                ref={(r: any) => (refs['View_110211_6102645'] = r)}
                {...injectData}
              >
                <Button
                  name={'查询'}
                  ...
                  onClick={(e: any) => {
                    const eventDatacallSelfFunc194: any = [
                      {
                        type: 'callSelfFunc',
                    ...
                    eventDatacallSelfFunc194.params =
                      [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                    CMDGenerator(
                      eventDatacallSelfFunc194,
                      { e },
                      'callSelfFunc',
                      {
                        id: 'callSelfFunc',
                  ...
                  ref={(r: any) => (refs['Button_224226_9699964_7583217'] = r)}
                  {...injectData}
                />
                <Button
                  name={'重置'}
                  ...
                  onClick={(e: any) => {
                    const forms23 = getFormByCompId(
                      'Form_148709_2103377_216161',
                      refs,
                    );
                    // 支持循环容器中的表单重置
                    (Array.isArray(forms23) ? forms23 : [forms23]).forEach(
                      (form) => form?.resetFields(),
                    );
                    const eventDatacallSelfFunc195: any = [
                      {
                        type: 'callSelfFunc',
                    ...
                    eventDatacallSelfFunc195.params =
                      [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                    CMDGenerator(
                      eventDatacallSelfFunc195,
                      { e },
                      'callSelfFunc',
                      {
                        id: 'callSelfFunc',
                  ...
                  ref={(r: any) => (refs['Button_499055_253437_90213'] = r)}
                  {...injectData}
                />
              </View>
            </View>
        ...
        >
          <Table
            ...
            onPageChange={(page: any, pageSize: any) => {
              const eventDatasetLoading117: any = [
                {
                  type: 'setLoading',
              ...
              const eventDatareloadDataSource65: any = [
                {
                  type: 'reloadDataSource',
              ...
              eventDatareloadDataSource65.params =
                [
                  {
                    title: '当前页码取值',
                    name: 'page',
            ...
            ref={(r: any) => (refs['Table_5176025'] = r)}
            {...injectData}
          />
        </View>
      </View>
...
export default withPageHOC(Xuanzerenyuanguanlianzuzhi3072$$Modal, {
