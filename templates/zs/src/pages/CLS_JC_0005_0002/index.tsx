...
const pageId = '885095407620149248';
    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_7692')}
          {...injectData}
        />
        <View
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_8411515')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_355644',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_021987"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_021987')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_936504',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_552329')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_188195')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_9692158')
              }
              {...injectData}
            >
              <Select
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_280051')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_926873"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_926873')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_538179')
                  }
                  {...injectData}
                />
              </View>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_710787')}
          {...injectData}
        />
      </View>
    </div>
