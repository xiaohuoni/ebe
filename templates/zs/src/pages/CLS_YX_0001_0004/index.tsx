...
const ClsYx_0001_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDataapiRequest590: any = [
      {
        type: 'apiRequest',
        dataId: 166977390225744160,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '574336',
    ...
    eventDataapiRequest590.params = [] || [];
    CMDGenerator(eventDataapiRequest590, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest591: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest591.params = [] || [];
    CMDGenerator(eventDataapiRequest591, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse296: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            options: {
              ...
              id: '9981685',
              pageJsonId: '537892',
              code: 'function main(data,state,success,fail){var item=state.itemList;data.sceneSubmit=item;data.sceneSubmit.approveGrade=item.approveGrade;data.sceneSubmit.approveGradeName=item.approveGradeName;data.sceneSubmit.instList=item.instList;var marketList=[];item.instList.forEach(function(v){var marketObj={};var instList=v.instAttrList;if(instList!=undefined&&instList.length>0){for(var i=0;i<instList.length;i++){marketObj[instList[i].attrCode]=instList[i].attrValue}marketObj.rowId=v.instCode;marketList.push(marketObj)}});data.returnPop=item.customObject;success(marketList)};',
    ...
    eventDataifelse296.params = [] || [];
    CMDGenerator(eventDataifelse296, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
            ...
            >
              ...
              >
                ...
                <View
                  ...
                  ref={(r: any) =>
                    (refs['View_6319234_3569864_15467365_781748_496899'] = r)
                  }
                  {...injectData}
                />
                <Input
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal275: any = [
                    {
                  ...
                  eventDatashowCustomModal275.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal275,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey91: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey91.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey91,
                    { e },
                    'getTableSelectedKey',
                    {
          ...
          <Table
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode838: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode838.params =
                [
            ...
            onRowDetail={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode839: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode839.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
          ...
          <Table
            ...
            style={{ margin: '10px 0px 10px 0px' }}
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode840: any = [
                {
                  type: 'customActionCode',
                  dataId: 166616796448653570,
                  options: {
              ...
              eventDatacustomActionCode840.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onRowDetail={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode841: any = [
                {
                  type: 'customActionCode',
                  dataId: 166623423756552930,
                  options: {
              ...
              eventDatacustomActionCode841.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            ref={(r: any) => (refs['Table_8700198_818742'] = r)}
            {...injectData}
          />
          <Form
            name={'要素表单'}
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource277: any = [
                {
                  type: 'setDataSource',
                  dataId: 167049305128761760,
                  options: {
                    compId: 'page',
                    compName: 'page',
                    id: '752957',
                    pageJsonId: '537892',
                    dataSourceId: 167049297163662080,
                    ...
                    dataSourceSetValue: [
                      {
                        ...
                        initialData: { type: 'static' },
                        value: {
                          type: ['form', 'Form_3718914', 'getFieldsValue'],
                          code: 'reason',
                        },
                      },
                    ],
              ...
              eventDatasetDataSource277.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            <TextArea
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['TextArea_484028'] = r)}
              {...injectData}
            />
          </Form>
          <Row
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData449: any = [
                      {
                    ...
                    eventDatagetSelectedData449.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode843: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode843.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode844: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode844.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId116: any = [
                {
              ...
              eventDatadownloadByFileId116.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsYx_0001_0004$$Page, {
  pageId: '906467252593385472',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
