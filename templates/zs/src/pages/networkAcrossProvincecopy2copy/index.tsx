...
import { Divider, Form, Input, View } from '@/components/factory';
        ...
        >
          ...
          >
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_3169715'] = r)}
              {...injectData}
            />
            <Input
              name={'重要客户标识'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_3755025'] = r)}
              {...injectData}
            />
            <Input
              name={'加入时间'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_72339117'] = r)}
              {...injectData}
            />
            <Input
              name={'年龄是否异常'}
