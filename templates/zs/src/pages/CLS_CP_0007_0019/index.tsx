...
const pageId = '1038995172144508928';
const ClsCp_0007_0019$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode132: any = [
      {
    ...
    eventDatacustomActionCode132.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest391: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest391.params = [] || [];
    CMDGenerator(eventDataapiRequest391, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest392: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest392.params = [] || [];
    CMDGenerator(eventDataapiRequest392, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse206: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse206.params = [] || [];
    CMDGenerator(eventDataifelse206, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource167: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource167.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal182: any = [
                    {
                      ...
                      options: {
                        ...
                        id: '611628',
                        pageJsonId: '537892',
                        modalname: '/networkAcrossProvincecopy2',
                        ...
                        modalPath: '/networkAcrossProvincecopy2',
                      },
                      line_number: 1,
                      callback1: [
                        {
                  ...
                  eventDatashowCustomModal182.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal182,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey65: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey65.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey65,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse483.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse483, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading192: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest750: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode636: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode636.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDataapiRequest751: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest751.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest751, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected64: any = [
                    {
                  ...
                  eventDatagetTableSelected64.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected64,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatacustomActionCode637: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode637.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode637,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal183: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal183.params =
                [
          ...
          <Table
            ...
            style={{ margin: '10px 0px 10px 0px' }}
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal184: any = [
                {
                  type: 'showCustomModal',
                  dataId: 166539679318667200,
                  options: {
              ...
              eventDatashowCustomModal184.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onRowDetail={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal185: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal185.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData342: any = [
                      {
                    ...
                    eventDatagetSelectedData342.params =
                      [
                    ...
                    const eventDatagetSelectedData343: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData343.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode639: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode639.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode640: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode640.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId65: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId65.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0007_0019$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
