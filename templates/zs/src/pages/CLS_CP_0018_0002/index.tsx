...
const ClsCp_0018_0002$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode128: any = [
      {
    ...
    eventDatacustomActionCode128.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse199.params = [] || [];
    CMDGenerator(eventDataifelse199, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest381: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest381.params = [] || [];
    CMDGenerator(eventDataapiRequest381, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest382: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest382.params = [] || [];
    CMDGenerator(eventDataapiRequest382, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest383: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest383.params = [] || [];
    CMDGenerator(eventDataapiRequest383, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest384: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest384.params = [] || [];
    CMDGenerator(eventDataapiRequest384, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse200: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse200.params = [] || [];
    CMDGenerator(eventDataifelse200, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource162: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource162.params =
                [
                  {
                    title: '表单当前改变字段编码',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData322: any = [
                      {
                    ...
                    eventDatagetSelectedData322.params =
                      [
                    ...
                    const eventDatagetSelectedData323: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData323.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode625: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode625.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode626: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode626.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId62: any = [
                {
              ...
              eventDatadownloadByFileId62.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0018_0002$$Page, {
  pageId: '1042019064354918400',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
