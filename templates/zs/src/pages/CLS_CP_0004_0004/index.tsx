...
const pageId = '892241802278445056';
const ClsCp_0004_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_429354: any) => {
    const eventDatacustomActionCode218: any = [
      {
        type: 'customActionCode',
        dataId: 167282540372517020,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '317607',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_429354;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167282543180806460,
            options: {
    ...
    eventDatacustomActionCode218.params =
      [
        {
          title: '事件入参',
          name: 'options_429354',
          value: '$options_429354$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode218,
      { options_429354 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest598: any = [
      {
        type: 'apiRequest',
        dataId: 166972733412680060,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '2802315',
        ...
        callback1: [
          {
            ...
            dataId: 166972733671507840,
            options: {
              compId: 'Input_690228_5400337_0085404',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '9136537',
              data: '$reply_2802315?.resultData$',
    ...
    eventDataapiRequest598.params = [] || [];
    CMDGenerator(eventDataapiRequest598, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest599: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest599.params = [] || [];
    CMDGenerator(eventDataapiRequest599, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse299: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 16702403884067704,
                options: {
                  compId: 'Input_361479_887285_2150708_701744',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '001431',
                  valueList: {
                    Input_361479_887285_2150708_701744:
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746092741077500,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746094046068700,
                    options: {
    ...
    eventDataifelse299.params = [] || [];
    CMDGenerator(eventDataifelse299, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_4007919',
                  uid: 'Form_4311097_9385662_4007919',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_4007919')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_979108',
                    uid: 'Checkbox_882584_5289015_934499_979108',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_979108',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_310701_069428"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_310701_069428',
                    uid: 'View_310701_069428',
                    type: 'View',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_310701_069428')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_701744',
                    uid: 'Input_361479_887285_2150708_701744',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_818139_96141',
              uid: 'Form_449441_818139_96141',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource280: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource280.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_818139_96141')
            }
            {...injectData}
          >
            <TextArea
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'cutOverExp'}
              value={data?.factorForm?.cutOverExp}
              formItemIndex={0}
              allowClear={true}
              tipIcon={{
                theme: 'outlined',
              ...
              disabled={false}
              $$componentItem={{
                id: 'Input_closeDownExp_015954_2821861_682734',
                uid: 'Input_closeDownExp_015954_2821861_682734',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Input_closeDownExp_015954_2821861_682734',
                )
              }
              {...injectData}
            />
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_51204',
                uid: 'Form_395851_1727917_51204',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_51204')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_0085404',
                  uid: 'Input_690228_5400337_0085404',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_0085404')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_128086"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_128086',
                  uid: 'View_22346374_875512_128086',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_128086')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_5748796',
                    uid: 'StdUpload_6230546_867413_5748796',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData455: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166433374431515970,
                        options: {
                          compId: 'Input_690228_5400337_0085404',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_02202[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_02202[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData455.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode852: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode852.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_5748796')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode853: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode853.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId119: any = [
                {
              ...
              eventDatadownloadByFileId119.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_116223')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0004_0004$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
