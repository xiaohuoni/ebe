...
const ClsCp_0018_0005$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode95: any = [
      {
    ...
    eventDatacustomActionCode95.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest273: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest273.params = [] || [];
    CMDGenerator(eventDataapiRequest273, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest274: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest274.params = [] || [];
    CMDGenerator(eventDataapiRequest274, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest275: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest275.params = [] || [];
    CMDGenerator(eventDataapiRequest275, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse152: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse152.params = [] || [];
    CMDGenerator(eventDataifelse152, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          type={'horizontal'}
          dashed={false}
          dividerText={'大数据行业端口签名变更审批单（短流程）'}
          showTitle={true}
          $$componentItem={{
            id: 'Divider_52558',
            uid: 'Divider_52558',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource129: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource129.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <Input
              ...
              placeholder={'请输入'}
              formItemIndex={2}
              fieldName={'changedSign'}
              value={data?.factorForm?.changedSign}
              icon={{
                type: undefined,
                theme: 'outlined',
                fontAddress: '',
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_0130543'] = r)}
              {...injectData}
            />
            <Input
              name={'业务接入号'}
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData214: any = [
                      {
                    ...
                    eventDatagetSelectedData214.params =
                      [
                    ...
                    const eventDatagetSelectedData215: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData215.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode520: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode520.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode521: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode521.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId42: any = [
                {
              ...
              eventDatadownloadByFileId42.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0018_0005$$Page, {
  pageId: '1053849250812850176',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
