...
const ClsCp_0003_0008$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode112: any = [
      {
    ...
    eventDatacustomActionCode112.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDatacustomActionCode257: any = [
      {
        type: 'customActionCode',
        dataId: 169936552371609860,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '943794',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){var iconClass="icon-tips2";var tableId="Table_076617";var thName="\\u5F15\\u5165\\u8BC4\\u5BA1\\u5F97\\u5206";var ths=document.querySelectorAll("div[data-compid=".concat(tableId,"] .pcfactory-table-thead th"));var icon=document.getElementsByClassName(iconClass)[0];if(!icon)return;for(var i=0;i<ths.length;i+=1){if(ths[i].innerText===thName){icon.style.marginLeft="6px";ths[i].appendChild(icon)}}};',
          actionTitle: '将表头的提示移动到正确位置',
        },
        line_number: 1,
        callback1: [],
        callback2: [],
    ...
    eventDatacustomActionCode257.params = [] || [];
    CMDGenerator(eventDatacustomActionCode257, {}, 'customActionCode', {
      id: 'customActionCode',
      name: 'customActionCode',
      type: 'customActionCode',
      platform: 'undefined',
    });
    const eventDataifelse178: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse178.params = [] || [];
    CMDGenerator(eventDataifelse178, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest330: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest330.params = [] || [];
    CMDGenerator(eventDataapiRequest330, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest331: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest331.params = [] || [];
    CMDGenerator(eventDataapiRequest331, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest332: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest332.params = [] || [];
    CMDGenerator(eventDataapiRequest332, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse179: any = [
      {
        type: 'ifelse',
        condition: [
          {
            ...
            callback1: [
              {
                ...
                options: {
                  ...
                  id: '013094',
                  pageJsonId: '537892',
                  dataSourceId: 169942748546405820,
                  dataSourceName: 'officialAgencyList',
                  dataSourceRelType: 'custom',
                  dataSourceSetValue: [
                    {
                      attrId: '279392',
                      code: 'officialAgencyName',
                      name: '正式落地代理商名称',
                      type: 'string',
                      initialData: { type: 'static' },
                      showInput: false,
                    ...
                    {
                      attrId: '4313375',
                      code: 'promiseQuarterPrestoreFee',
                      name: '承诺季度预存金额',
                      type: 'string',
                      initialData: { type: 'static' },
                      showInput: false,
    ...
    eventDataifelse179.params = [] || [];
    CMDGenerator(eventDataifelse179, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource145: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource145.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal171: any = [
                    {
                      ...
                      callback1: [
                        {
                          ...
                          options: {
                            ...
                            id: '195951',
                            pageJsonId: '537892',
                            code: 'function main(data,state,success,fail){console.log("\\u5F39\\u7A97\\u8FD4\\u56DE:",okData_611628);var res=okData_611628;var officialAgencyList=data.officialAgencyList||[];console.log("officialAgencyList = ",officialAgencyList);if(officialAgencyList.length>0){var maxRowId=1;for(var i=0;i<officialAgencyList.length;i++){var rowId=parseInt(officialAgencyList[i]["rowId"]);if(maxRowId<=rowId){maxRowId=rowId}}res.rowId=parseInt(maxRowId)+1}else{res.rowId=1}officialAgencyList.unshift(res);var instList=[];for(var key in res){instList.push({"attrCode":key,"attrName":"","attrValue":res[key]})}var instObj={"instCode":res.rowId,"instAttrList":instList};if(data.sceneSubmit.instList!=undefined&&data.sceneSubmit.instList.length>0){data.sceneSubmit.instList.unshift(instObj)}else{var instList=[];instList.unshift(instObj);data.sceneSubmit.instList=instList}data.officialAgencyList=officialAgencyList;success()};',
                          },
                          line_number: 2,
                          callback1: [
                            {
                  ...
                  eventDatashowCustomModal171.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal171,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey59: any = [
                    {
                                      ...
                                      children: [
                                        {
                                          ...
                                          options: {
                                            ...
                                            id: '23945',
                                            pageJsonId: '537892',
                                            code: 'function main(data,state,success,fail){var officialAgencyList=data.officialAgencyList;var sel=selectedRowKeys_242263;var res=[];var instList=[];if(sel!=undefined&&sel.length>0){officialAgencyList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.rowId});console.log(exit);if(exit===-1){res.push(v)}});data.officialAgencyList=res;data.sceneSubmit.instList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.instCode});if(exit===-1){instList.push(v)}});data.sceneSubmit.instList=instList}success()};',
                                          },
                  ...
                  eventDatagetTableSelectedKey59.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey59,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                      ...
                      condition: [
                        {
                          condId: '913482',
                          options: {
                            context: '$data.officialAgencyList$',
                            operate: 'notEmpty',
                          },
                          conditionType: 'checkContextValue',
                          objType: 'system',
                        ...
                        },
                        {
                          options: {
                            useManual: true,
                            useObject: false,
                            context: '$data.officialAgencyList.length$',
                            operate: '>',
                            manualValue: '0',
                          },
                          condId: '225057',
                  ...
                  eventDataifelse478.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse478, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading177: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest735: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode569: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode569.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatasetLoading178: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading178.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading178, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDataapiRequest736: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest736.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest736, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected59: any = [
                    {
                  ...
                  eventDatagetTableSelected59.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected59,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatasetLoading179: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading179.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading179, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDatacustomActionCode570: any = [
                    {
                      type: 'customActionCode',
                      ...
                      options: {
                        ...
                        id: '7076346',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){var arr1=[];var arr2=[];var agencyList=data.officialAgencyList||[];for(var i=0;i<agencyList.length;i++){var info=agencyList[i];{arr2.push({"name":"\\u6B63\\u5F0F\\u843D\\u5730\\u4EE3\\u7406\\u5546\\u540D\\u79F0","value":info.officialAgencyName});arr2.push({"name":"\\u540E\\u5907\\u5F15\\u5165\\u65F6\\u95F4","value":info.backImportDate});arr2.push({"name":"\\u5F15\\u5165\\u8BC4\\u5BA1\\u5F97\\u5206","value":info.judgeScore});arr2.push({"name":"\\u627F\\u8BFA\\u5B63\\u5EA6\\u9884\\u5B58\\u91D1\\u989D\\uFF08\\u5355\\u4F4D\\uFF1A\\u4E07\\u5143\\uFF09","value":info.promiseQuarterPrestoreFee});arr2.push({"name":"\\u4EE3\\u7406\\u5546\\u7B80\\u4ECB","value":info.agencyProfile})}arr1.push(arr2);arr2=[]}if(arr1.length>0){success(JSON.stringify(arr1))}else{fail()}};',
                      },
                      line_number: 9,
                      callback1: [
                        {
                  ...
                  eventDatacustomActionCode570.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode570,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            columns={[
              ...
              {
                title: '正式落地代理商名称',
                key: 'officialAgencyName',
                dataIndex: 'officialAgencyName',
                className: 'divider',
                id: '503531',
                customRendering: undefined,
                editContent: {
              ...
              {
                title: '承诺季度预存金额（单位：万元）',
                key: 'promiseQuarterPrestoreFee',
                dataIndex: 'promiseQuarterPrestoreFee',
                className: 'divider',
                id: '028207',
                customRendering: undefined,
                editContent: {
            ...
            dataSource={data?.officialAgencyList}
            ...
            dataSourceFromDataSourceConfig={'data.officialAgencyList'}
            $$componentItem={{
              id: 'Table_076617',
              uid: 'Table_076617',
              type: 'Table',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData273: any = [
                      {
                    ...
                    eventDatagetSelectedData273.params =
                      [
                    ...
                    const eventDatagetSelectedData274: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData274.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode572: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode572.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode573: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode573.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId53: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId53.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0008$$Page, {
  pageId: '1039435942294769664',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
