  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_912842_1'] = r)}
        {...injectData}
      >
        <Card
          name={'省内配置信息卡片'}
        ...
        >
          ...
          >
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_7086615'] = r)}
              {...injectData}
            />
          </Form>
        </Card>
        ...
        >
          ...
          >
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_2006585'] = r)}
              {...injectData}
            />
            <Input
              name={'一级费项名称'}
            ...
            <Select
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Select_5004844'] = r)}
              {...injectData}
            />
            <Input
              name={'三级费项编码'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_68279565'] = r)}
              {...injectData}
            />
            <Input
              name={'三级费项名称'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_0938348'] = r)}
              {...injectData}
            />
            <Input
              name={'资费周期类型'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_8121889'] = r)}
              {...injectData}
            />
            <View
              name={'布局容器'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_7907087'] = r)}
              {...injectData}
            />
            <Input
              name={'资费场景实例编码'}
