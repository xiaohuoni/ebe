...
const pageId = '1064446176869310464';
const ClsCp_0019_0005$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_263015: any) => {
    const eventDatacustomActionCode57: any = [
      {
    ...
    eventDatacustomActionCode57.params =
      [
        {
          title: '事件入参',
          name: 'options_263015',
  ...
  const updateTitle = (options_9020026: any) => {
    const eventDatacustomActionCode58: any = [
      {
        type: 'customActionCode',
    ...
    eventDatacustomActionCode58.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest192: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest192.params = [] || [];
    CMDGenerator(eventDataapiRequest192, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse114: any = [
      {
        type: 'ifelse',
        condition: [
          {
              ...
              },
              {
                ...
                options: {
                  ...
                  dataSourceSetValue: [
                    ...
                    {
                      attrId: '375159',
                      code: 'arrearageBlacklistDeclare',
                      name: '恶意欠费纳黑说明',
                      type: 'string',
                      initialData: { type: 'static' },
                      showInput: true,
                      _codePath: ['arrearageBlacklistDeclare'],
                      _idpath: ['375159'],
                    },
                  ],
                  operateType: 1,
    ...
    eventDataifelse114.params = [] || [];
    CMDGenerator(eventDataifelse114, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        ...
        <View
          ...
          ref={(r: any) => refs.setComponentRef(r, 'View_618215')}
          {...injectData}
        >
          <Text
            name={'集团信息风险提示'}
            content={
              '注：需含客户催缴函及回执单，或客户白名单新开业务申请需求单。'
            }
            textType={'span'}
            version={'1.0'}
            showHtml={false}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Text_7667456')}
            {...injectData}
          />
        </View>
        <BusiComp0521965
...
export default withPageHOC(ClsCp_0019_0005$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
