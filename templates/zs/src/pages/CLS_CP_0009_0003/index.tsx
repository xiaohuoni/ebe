...
const pageId = '885090398060150784';
const ClsCp_0009_0003$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_141412: any) => {
    const eventDatacustomActionCode209: any = [
      {
        type: 'customActionCode',
        dataId: 16723896051316688,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '0592362',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_141412;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238961803454980,
            options: {
    ...
    eventDatacustomActionCode209.params =
      [
        {
          title: '事件入参',
          name: 'options_141412',
          value: '$options_141412$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode209,
      { options_141412 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest577: any = [
      {
        type: 'apiRequest',
        dataId: 166972738350088100,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '543258',
        ...
        callback1: [
          {
            ...
            dataId: 166972738625867200,
            options: {
              compId: 'Input_690228_5400337_280164',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '357939',
              data: '$reply_543258?.resultData$',
    ...
    eventDataapiRequest577.params = [] || [];
    CMDGenerator(eventDataapiRequest577, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest578: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest578.params = [] || [];
    CMDGenerator(eventDataapiRequest578, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse289: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166262852499266600,
                options: {
                  compId: 'Input_361479_887285_2150708_7460276',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '7361616',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746142218770700,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746143669334940,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166262856865791330,
                options: {
                  compId: 'Form_449441_1900385',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '8188514',
    ...
    eventDataifelse289.params = [] || [];
    CMDGenerator(eventDataifelse289, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_302551',
                  uid: 'Form_4311097_9385662_302551',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_302551')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_292792',
                    uid: 'Checkbox_882584_5289015_934499_292792',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_292792',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_971391"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_971391')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_7460276',
                    uid: 'Input_361479_887285_2150708_7460276',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_7460276',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            formItemIndex={1}
            $$componentItem={{
              id: 'Form_449441_1900385',
              uid: 'Form_449441_1900385',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource268: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource268.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_1900385')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              $$componentItem={{
                id: 'Input_closeDownExp_015954_952744',
                uid: 'Input_closeDownExp_015954_952744',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_952744')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_661735',
                uid: 'Form_395851_1727917_661735',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_661735')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_280164',
                  uid: 'Input_690228_5400337_280164',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_280164')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_9117364"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_9117364',
                  uid: 'View_22346374_875512_9117364',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_9117364')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_762296',
                    uid: 'StdUpload_6230546_867413_762296',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData437: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166262861796838530,
                        options: {
                          compId: 'Input_690228_5400337_280164',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_2984843[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                    ...
                    eventDatagetSelectedData437.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode811: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode811.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_762296')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode812: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode812.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId110: any = [
                {
              ...
              eventDatadownloadByFileId110.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_900139')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0009_0003$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
