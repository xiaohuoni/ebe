...
const pageId = '889087775730135040';
    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_852029')}
          {...injectData}
        />
        <View
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_5142916_1060456')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_6659047_704876',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_958356"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_958356',
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_958356')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
          ...
          <Form
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_9243547_9271127')
            }
            {...injectData}
          >
            <Input
              ...
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Input_agentName_4780553_7528804_2377641',
                )
              }
              {...injectData}
            />
            <Input
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_agentCode_0555006')
              }
              {...injectData}
            />
            <Input
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_repairCloseMoney_357717_248252')
              }
              {...injectData}
            />
            <TextArea
              ...
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Input_derateReason_332471271_9259764_78749489',
                )
              }
              {...injectData}
            />
          ...
          >
            <Form
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_238338_265881')
              }
              {...injectData}
            >
              <Select
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_437986_500126')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_40472_401685"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_40472_401685')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_48197_188689')
                  }
                  {...injectData}
                />
              </View>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_8322623')}
          {...injectData}
        />
      </View>
    </div>
