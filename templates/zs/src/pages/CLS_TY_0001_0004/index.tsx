      ...
      >
        ...
        >
          <Select
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Select_205718'] = r)}
            {...injectData}
          />
          <Input
            name={'代理商名称'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_agentName_3824789'] = r)}
            {...injectData}
          />
          <Input
            name={'代理商编码'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_agentCode_737854'] = r)}
            {...injectData}
          />
          <Input
            name={'发展人姓名'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_devStaffName_706314'] = r)}
            {...injectData}
          />
          <Input
            name={'发展人手机号'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_devStaffMobile_991173'] = r)}
            {...injectData}
          />
          <Input
            name={'商机编码'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_oppCode_845324'] = r)}
            {...injectData}
          />
          <Input
            name={'商机名称'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_oppName_4473983'] = r)}
            {...injectData}
          />
          <Input
            name={'申请保护天数'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_saveDays_8086668'] = r)}
            {...injectData}
          />
          <Input
            name={'业务名称'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_busiName_739216'] = r)}
            {...injectData}
          />
          <Input
            name={'渠道费用结算比例'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_closeRatio_693466'] = r)}
            {...injectData}
          />
          <TextArea
            name={'商机描述'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => (refs['Input_oppDesc_267495'] = r)}
            {...injectData}
          />
        </Form>
        <View
        ...
        >
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_890419'] = r)}
            {...injectData}
          />
        </View>
      </View>
