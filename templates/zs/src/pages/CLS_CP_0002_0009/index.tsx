...
const pageId = '896693524849729536';
const ClsCp_0002_0009$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_954403: any) => {
    const eventDatacustomActionCode204: any = [
      {
        type: 'customActionCode',
        dataId: 167288375558208400,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '9418998',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_954403;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167288376432025380,
            options: {
    ...
    eventDatacustomActionCode204.params =
      [
        {
          title: '事件入参',
          name: 'options_954403',
          value: '$options_954403$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode204,
      { options_954403 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest565: any = [
      {
        type: 'apiRequest',
        dataId: 166972746590682780,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '4671735',
        ...
        callback1: [
          {
            ...
            dataId: 166972746808798850,
            options: {
              compId: 'Input_690228_5400337_184417',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '682578',
              data: '$reply_4671735?.resultData$',
    ...
    eventDataapiRequest565.params = [] || [];
    CMDGenerator(eventDataapiRequest565, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest566: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest566.params = [] || [];
    CMDGenerator(eventDataapiRequest566, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse282: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166539447151989300,
                options: {
                  compId: 'Input_361479_887285_2150708_1887476',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '623499',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746162483051100,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746163840816420,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166545313381072300,
                options: {
                  compId: 'Form_449441_818139_4213316',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '72039',
    ...
    eventDataifelse282.params = [] || [];
    CMDGenerator(eventDataifelse282, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_209184',
                  uid: 'Form_4311097_9385662_209184',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_209184')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_8728062',
                    uid: 'Checkbox_882584_5289015_934499_8728062',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_8728062',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_310701_5468358"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_310701_5468358',
                    uid: 'View_310701_5468358',
                    type: 'View',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_310701_5468358')
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_1887476',
                    uid: 'Input_361479_887285_2150708_1887476',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_1887476',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_818139_4213316',
              uid: 'Form_449441_818139_4213316',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource263: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource263.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_449441_818139_4213316')
            }
            {...injectData}
          >
            <TextArea
              ...
              required={true}
              placeholder={
                '请说明员工姓名、手机号码、4A账号、身份证号码、配置角色，是否移动员工等'
              }
              ...
              tipContent={
                '因XX原因需申请CMIOT系统账号，姓名、手机号码、4A账号、身份证号码、配置角色，是否移动员工等'
              }
              disabled={false}
              $$componentItem={{
                id: 'Input_closeDownExp_015954_2821861_5014408',
                uid: 'Input_closeDownExp_015954_2821861_5014408',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(
                  r,
                  'Input_closeDownExp_015954_2821861_5014408',
                )
              }
              {...injectData}
            />
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_19043',
                uid: 'Form_395851_1727917_19043',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_19043')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_184417',
                  uid: 'Input_690228_5400337_184417',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_184417')
                }
                {...injectData}
              />
              <View
                className="View_View_22346374_875512_335136"
                name={'布局容器'}
                visible={true}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_335136',
                  uid: 'View_22346374_875512_335136',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_335136')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_0979884',
                    uid: 'StdUpload_6230546_867413_0979884',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData425: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166539465139245340,
                        options: {
                          compId: 'Input_690228_5400337_184417',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_4303874[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_4303874[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData425.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode795: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode795.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_0979884')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode796: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode796.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId105: any = [
                {
              ...
              eventDatadownloadByFileId105.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_237672')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0002_0009$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
