  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_450669_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        >
          <Divider
            ...
            ref={(r: any) => (refs['Divider_3987022'] = r)}
            {...injectData}
          />
          <View
            name={'布局容器'}
          ...
          >
            <HorizontalView
              ...
              ref={(r: any) => (refs['HorizontalView_3131409'] = r)}
              {...injectData}
            >
              <View
                name={'布局容器'}
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    ref={(r: any) => (refs['Checkbox_200994'] = r)}
                    {...injectData}
                  />
                  <View
                    name={'布局容器'}
          ...
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_977906'] = r)}
            {...injectData}
          />
        </View>
      </View>
