...
const pageId = '1038720787517075456';
const ClsCp_0003_0009$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode114: any = [
      {
    ...
    eventDatacustomActionCode114.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse182.params = [] || [];
    CMDGenerator(eventDataifelse182, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest336: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest336.params = [] || [];
    CMDGenerator(eventDataapiRequest336, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest337: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest337.params = [] || [];
    CMDGenerator(eventDataapiRequest337, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest338: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest338.params = [] || [];
    CMDGenerator(eventDataapiRequest338, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse183: any = [
      {
        type: 'ifelse',
        condition: [
          {
            ...
            callback1: [
              {
                ...
                options: {
                  ...
                  id: '013094',
                  pageJsonId: '537892',
                  dataSourceId: 169925956272247040,
                  dataSourceName: 'agencyList',
                  dataSourceRelType: 'custom',
                  dataSourceSetValue: [
                    {
                      attrId: '8933325',
                      code: 'clearedAgencyName',
                      name: '清退代理商名称',
                      type: 'string',
                      initialData: { type: 'static' },
                      showInput: false,
    ...
    eventDataifelse183.params = [] || [];
    CMDGenerator(eventDataifelse183, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource147: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource147.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal173: any = [
                    {
                      ...
                      callback1: [
                        {
                          ...
                          options: {
                            ...
                            id: '195951',
                            pageJsonId: '537892',
                            code: 'function main(data,state,success,fail){console.log("\\u5F39\\u7A97\\u8FD4\\u56DE:",okData_611628);var res=okData_611628;var agencyList=data.agencyList||[];console.log("agencyList = ",agencyList);if(agencyList.length>0){var maxRowId=1;for(var i=0;i<agencyList.length;i++){var rowId=parseInt(agencyList[i]["rowId"]);if(maxRowId<=rowId){maxRowId=rowId}}res.rowId=parseInt(maxRowId)+1}else{res.rowId=1}agencyList.unshift(res);var instList=[];for(var key in res){instList.push({"attrCode":key,"attrName":"","attrValue":res[key]})}var instObj={"instCode":res.rowId,"instAttrList":instList};if(data.sceneSubmit.instList!=undefined&&data.sceneSubmit.instList.length>0){data.sceneSubmit.instList.unshift(instObj)}else{var instList=[];instList.unshift(instObj);data.sceneSubmit.instList=instList}data.agencyList=agencyList;success()};',
                          },
                          line_number: 2,
                          callback1: [
                            {
                  ...
                  eventDatashowCustomModal173.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal173,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey61: any = [
                    {
                                      ...
                                      children: [
                                        {
                                          ...
                                          options: {
                                            ...
                                            id: '25397954',
                                            pageJsonId: '537892',
                                            code: 'function main(data,state,success,fail){var agencyList=data.agencyList;var sel=selectedRowKeys_7288851;var res=[];var instList=[];if(sel!=undefined&&sel.length>0){agencyList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.rowId});console.log(exit);if(exit===-1){res.push(v)}});data.agencyList=res;data.sceneSubmit.instList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.instCode});if(exit===-1){instList.push(v)}});data.sceneSubmit.instList=instList}success()};',
                                          },
                  ...
                  eventDatagetTableSelectedKey61.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey61,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                      ...
                      condition: [
                        ...
                        },
                        {
                          options: {
                            useManual: true,
                            useObject: false,
                            context: '$data.agencyList.length$',
                            operate: '>',
                            manualValue: '0',
                          },
                          condId: '225057',
                  ...
                  eventDataifelse480.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse480, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading183: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest739: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode579: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode579.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatasetLoading184: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading184.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading184, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDataapiRequest740: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest740.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest740, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected61: any = [
                    {
                  ...
                  eventDatagetTableSelected61.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected61,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatasetLoading185: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading185.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading185, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDatacustomActionCode580: any = [
                    {
                      type: 'customActionCode',
                      ...
                      options: {
                        ...
                        id: '7076346',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){var arr1=[];var arr2=[];var agencyList=data.agencyList;for(var i=0;i<agencyList.length;i++){var info=agencyList[i];{arr2.push({"name":"\\u6E05\\u9000\\u4EE3\\u7406\\u5546\\u540D\\u79F0","value":info.clearedAgencyName});arr2.push({"name":"\\u6E05\\u9000\\u8BF4\\u660E","value":info.clearedReason})}arr1.push(arr2);arr2=[]}if(arr1.length>0){success(JSON.stringify(arr1))}else{fail()}};',
                      },
                      line_number: 9,
                      callback1: [
                        {
                  ...
                  eventDatacustomActionCode580.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode580,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            columns={[
              ...
              {
                title: '清退代理商名称',
                key: 'clearedAgencyName',
                dataIndex: 'clearedAgencyName',
                className: 'divider',
                id: '444242',
                align: 'center',
                customRendering: undefined,
            ...
            dataSource={data?.agencyList}
            fieldName={'data.MemberInfo.length'}
            total={data?.agencyList?.length}
            hiddenAction={false}
            rowKey={'rowId'}
            rowActions={[]}
            extend={[]}
            ...
            dataSourceFromDataSourceConfig={'data.agencyList'}
            $$componentItem={{
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData281: any = [
                      {
                    ...
                    eventDatagetSelectedData281.params =
                      [
                    ...
                    const eventDatagetSelectedData282: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData282.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode582: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode582.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode583: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode583.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId55: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId55.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0009$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
