...
const IndustryTerm$$Modal: React.FC<PageProps> = ({
  ...
  const calculV4Num = (options_8722644: any) => {
    ...
    CMDGenerator(eventDatagetValue109, { options_8722644 }, 'getValue', {
      id: 'getValue',
      name: 'getValue',
      type: 'getValue',
      platform: 'undefined',
  ...
  const calculV6Price = (options_302257: any) => {
    const eventDatagetSelectedData20: any = [
      {
    ...
    eventDatagetSelectedData20.params =
      [
        {
          title: '事件入参',
          name: 'options_302257',
    ...
    const eventDatagetValue110: any = [
      {
        type: 'getValue',
    ...
    CMDGenerator(eventDatagetValue110, { options_302257 }, 'getValue', {
      id: 'getValue',
      name: 'getValue',
      type: 'getValue',
      platform: 'undefined',
  ...
  const calculEndDiscount = (options_824845: any) => {
    const eventDatagetValue111: any = [
      {
        type: 'getValue',
    ...
    CMDGenerator(eventDatagetValue111, { options_824845 }, 'getValue', {
      id: 'getValue',
      name: 'getValue',
      type: 'getValue',
      platform: 'undefined',
  ...
  const onOk = () => {
    const eventDatavalidateForm1: any = [
      {
        type: 'validateForm',
    ...
    eventDatavalidateForm1.params = [] || [];
    CMDGenerator(eventDatavalidateForm1, {}, 'validateForm', {
      id: 'validateForm',
      name: 'validateForm',
      type: 'validateForm',
      platform: 'undefined',
  ...
  const onCancel = () => {
    const eventDatacloseModal116: any = [
      {
        type: 'closeModal',
        dataId: '3594441_1',
    ...
    eventDatacloseModal116.params = [] || [];
    CMDGenerator(eventDatacloseModal116, {}, 'closeModal', {
      id: 'closeModal',
      name: 'closeModal',
      type: 'closeModal',
      platform: 'undefined',
  ...
  useEffect(() => {
    const eventDatasetDataSource24: any = [
      {
        type: 'setDataSource',
    ...
    eventDatasetDataSource24.params = [] || [];
    CMDGenerator(eventDatasetDataSource24, {}, 'setDataSource', {
      id: 'setDataSource',
      name: 'setDataSource',
      type: 'setDataSource',
      platform: 'undefined',
    });
    const eventDataapiRequest641: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest641.params = [] || [];
    CMDGenerator(eventDataapiRequest641, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest642: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest642.params = [] || [];
    CMDGenerator(eventDataapiRequest642, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse331: any = [
      {
        type: 'ifelse',
        condition: [
          {
                ...
                options: {
                  ...
                  dataSourceSetValue: [
                    ...
                    },
                    {
                      ...
                      value: {
                        type: ['customize'],
                        code: '$state.returnPop.marketObj.terminalDesc$',
                      },
                    },
                  ],
                  operateType: 1,
    ...
    eventDataifelse331.params = [] || [];
    CMDGenerator(eventDataifelse331, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
                      ...
                      >
                        ...
                        >
                          <BusiComp4158382
                            ...
                            onValuesChange={(
                              ...
                              const eventDatagetBlockSelectValues6: any = [
                                {
                              ...
                              eventDatagetBlockSelectValues6.params =
                                [
                                  {
                                    title: '表单变化值',
                                    name: 'changedValues',
                              ...
                              CMDGenerator(
                                eventDatagetBlockSelectValues6,
                              ...
                              const eventDatacallSelfFunc844: any = [
                                {
                                  type: 'callSelfFunc',
                              ...
                              eventDatacallSelfFunc844.params =
                                [
                                  {
                                    title: '表单变化值',
                                    name: 'changedValues',
                        ...
                        >
                          <Icon
                            ...
                            onClick={(e: any) => {
                              const eventDatagetBlockSelectValues7: any = [
                                {
                                  type: 'getBlockSelectValues',
                              ...
                              eventDatagetBlockSelectValues7.params =
                                [
                                  {
                                    title: '事件对象',
                                    value: '$e$',
                              ...
                              CMDGenerator(
                                eventDatagetBlockSelectValues7,
                                { e, item, i },
                                'getBlockSelectValues',
                                {
                                  id: 'getBlockSelectValues',
        ...
        >
          <Icon
            ...
            onClick={(e: any) => {
              const eventDatasetDataSource308: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource308.params =
                [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
              CMDGenerator(eventDatasetDataSource308, { e }, 'setDataSource', {
                id: 'setDataSource',
                name: 'setDataSource',
                type: 'setDataSource',
                platform: 'pc',
        ...
        >
          <View
            ...
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'View_015288_239109_6528729_3449095_643503_344108',
              uid: 'View_015288_239109_6528729_3449095_643503_344108',
              type: 'View',
              ...componentItem,
            }}
            style={{
          ...
          >
            <Button
              ...
              hasIcon={false}
              $$componentItem={{
                id: 'Button_3488654_2211138',
                uid: 'Button_3488654_2211138',
                type: 'Button',
                ...componentItem,
              }}
              readOnly={false}
              ...
              onClick={(e: any) => {
                const eventDatashowCustomModal306: any = [
                  {
                ...
                eventDatashowCustomModal306.params =
                  [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                CMDGenerator(
                  eventDatashowCustomModal306,
                  { e },
                  'showCustomModal',
                  {
                    id: 'showCustomModal',
          ...
          <Form
            ...
            onValuesChange={() => {
              const eventDatasetDataSource309: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource309.params = [] || [];
              CMDGenerator(eventDatasetDataSource309, {}, 'setDataSource', {
                id: 'setDataSource',
                name: 'setDataSource',
                type: 'setDataSource',
                platform: 'pc',
          ...
          >
            <Input
              ...
              onIconClick={() => {
                const eventDatagetValue269: any = [
                  {
                    type: 'getValue',
                ...
                eventDatagetValue269.params = [] || [];
                CMDGenerator(eventDatagetValue269, {}, 'getValue', {
                  id: 'getValue',
                  name: 'getValue',
                  type: 'getValue',
                  platform: 'pc',
            ...
            <Input
              ...
              isFormRootChild={true}
              onChange={(e: any) => {
                const eventDatacallSelfFunc846: any = [
                  {
                    type: 'callSelfFunc',
                ...
                eventDatacallSelfFunc846.params =
                  [
                    {
                      title: '输入框取值',
                      name: 'e',
                ...
                CMDGenerator(eventDatacallSelfFunc846, { e }, 'callSelfFunc', {
                  id: 'callSelfFunc',
                  name: 'callSelfFunc',
                  type: 'callSelfFunc',
                  platform: 'pc',
            ...
            <TextArea
              ...
              required={false}
              placeholder={'请输入'}
              fieldName={'terminalDesc'}
              value={data?.marketObj?.terminalDesc}
              formItemIndex={13}
              $$componentItem={{
                id: 'Input_terminalDesc_99592674',
                uid: 'Input_terminalDesc_99592674',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
          ...
          >
            <Button
              ...
              style={{ width: 'fit-content' }}
              onClick={(e: any) => {
                const eventDatashowCustomModal307: any = [
                  {
                    type: 'showCustomModal',
                ...
                eventDatashowCustomModal307.params =
                  [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                CMDGenerator(
                  eventDatashowCustomModal307,
                  { e },
                  'showCustomModal',
                  {
                    id: 'showCustomModal',
          ...
          <Form
            ...
            style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
            onValuesChange={() => {
              const eventDatasetDataSource310: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource310.params = [] || [];
              CMDGenerator(eventDatasetDataSource310, {}, 'setDataSource', {
                id: 'setDataSource',
                name: 'setDataSource',
                type: 'setDataSource',
                platform: 'pc',
          ...
          >
            <Input
              ...
              isFormRootChild={true}
              onIconClick={() => {
                const eventDatagetValue271: any = [
                  {
                    type: 'getValue',
                ...
                eventDatagetValue271.params = [] || [];
                CMDGenerator(eventDatagetValue271, {}, 'getValue', {
                  id: 'getValue',
                  name: 'getValue',
                  type: 'getValue',
                  platform: 'pc',
            ...
            <Select
              ...
              isFormRootChild={true}
              onChange={(e: any) => {
                const eventDatagetSelectedData473: any = [
                  {
                    type: 'getSelectedData',
                ...
                eventDatagetSelectedData473.params =
                  [{ title: '下拉框取值', name: 'e', value: '$e$' }] || [];
                CMDGenerator(
                  eventDatagetSelectedData473,
                  { e },
                  'getSelectedData',
                  {
                    id: 'getSelectedData',
