...
const AuditStart$$Page: React.FC<PageProps> = ({
  ...
  useEffect(() => {
    ...
    CMDGenerator(eventDatacallSelfFunc, {}, 'callSelfFunc', {
      id: 'callSelfFunc',
      name: 'callSelfFunc',
      type: 'callSelfFunc',
      platform: 'undefined',
            ...
            >
              <Input
                ...
                onPressEnter={(e: any) => {
                  ...
                  CMDGenerator(eventDatacallSelfFunc2, { e }, 'callSelfFunc', {
                    id: 'callSelfFunc',
                    name: 'callSelfFunc',
                    type: 'callSelfFunc',
                    platform: 'pc',
                ...
                onIconClick={() => {
                  ...
                  CMDGenerator(eventDatacallSelfFunc3, {}, 'callSelfFunc', {
                    id: 'callSelfFunc',
                    name: 'callSelfFunc',
                    type: 'callSelfFunc',
                    platform: 'pc',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  CMDGenerator(eventDatacallSelfFunc4, { e }, 'callSelfFunc', {
                    id: 'callSelfFunc',
                    name: 'callSelfFunc',
                    type: 'callSelfFunc',
                    platform: 'pc',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDataclearValue: any = [
                    {
                      ...
                      path: [166964664525196480],
                      line_number: 1,
                    },
                  ];
                  eventDataclearValue.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataclearValue, { e }, 'clearValue', {
                    id: 'clearValue',
                    name: 'clearValue',
                    type: 'clearValue',
                    platform: 'pc',
                  });
                  const eventDatacallSelfFunc5: any = [
                    {
                      type: 'callSelfFunc',
                  ...
                  eventDatacallSelfFunc5.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatacallSelfFunc5, { e }, 'callSelfFunc', {
                    id: 'callSelfFunc',
                    name: 'callSelfFunc',
                    type: 'callSelfFunc',
                    platform: 'pc',
                      ...
                      callback1: [
                        {
                          ...
                          path: [
                            167945455237187520, 167946747304968830,
                            167946747304927000,
                          ],
                          line_number: 2,
                          callback1: [],
                          ...
                          callback1: [
                            {
                              ...
                              path: [
                                166314441615824600, 166418284911394300,
                                166418284911338980,
                              ],
                              line_number: 2,
                              callback1: [],
                      ...
                      const eventDatacustomActionCode15: any = [
                        {
                          ...
                          options: {
                            ...
                            pageJsonId: '866861',
                            originCode:
                              '/** main函数为入口函数，代码仅支持写在该函数内部，请勿删除该函数\n * @param {data} 页面数据\n * @param {state} 组件状态\n * @param {success} 触发成功回调 仅支持返回参数，多个参数可以通过对象传递 如：在事件编排中需成功后回调拿到xx值，只需要 success(xx)\n * @param {fail} 触发失败回调 仅支持返回参数，多个参数可以通过对象传递 如：在事件编排中需失败后回调拿到xx值，只需要 fail(xx)\n */\nfunction main(data, state, success, fail) {\n    console.log(data);\n\tconst nodeMap = data?.selectedNodes?.nodes ?? {};\n    const nodeKeys = Object.values(nodeMap).flat().map(e => e.nodeKey);\n    success(nodeKeys);\n};',
                          ...
                          callback1: [
                            {
                              ...
                              path: [
                                166338230643954720, 166521463232806140,
                                166521463232843200,
                              ],
                                  ...
                                  children: [
                                    {
                                      ...
                                      path: [
                                        166338230643954720, 166521463232806140,
                                        166521463232843200, 166521463232841380,
                                        166521466482461900,
                                      ],
                                      options: {
                                        compId: 'apiRequest',
