  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_721399_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        >
          <Divider
            ...
            ref={(r: any) => (refs['Divider_314592'] = r)}
            {...injectData}
          />
          <View
            name={'布局容器'}
          ...
          >
            <HorizontalView
              ...
              ref={(r: any) => (refs['HorizontalView_399328'] = r)}
              {...injectData}
            >
              <View
                name={'布局容器'}
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    ref={(r: any) => (refs['Checkbox_450985'] = r)}
                    {...injectData}
                  />
                  <View
                    name={'布局容器'}
          ...
          >
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_5671474'] = r)}
              {...injectData}
            />
            <Select
              name={'客户来源'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Select_7117554'] = r)}
              {...injectData}
            />
            <Input
              name={'生效时间'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_9732016'] = r)}
              {...injectData}
            />
            <Input
              name={'失效时间'}
          ...
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_285298'] = r)}
            {...injectData}
          />
        </View>
      </View>
