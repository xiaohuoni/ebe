...
const pageId = '966543836292554752';
  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => refs.setComponentRef(r, 'View_7946678_1')}
        {...injectData}
      >
        <View
          className="View_View_2339845"
          name={'布局容器'}
          ...
          ref={(r: any) => refs.setComponentRef(r, 'View_2339845')}
          {...injectData}
        >
          <Divider
            name={'分割线'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Divider_058849')}
            {...injectData}
          />
          <View
            className="View_View_0260956"
            name={'布局容器'}
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'View_0260956',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_0260956')}
            {...injectData}
          >
            <HorizontalView
              name={'左右布局'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'HorizontalView_913816')}
              {...injectData}
            >
              <View
                className="View_View_4327083"
                name={'布局容器'}
                $$componentItem={{
                  id: 'View_4327083',
                  uid: 'View_4327083',
                ...
                ref={(r: any) => refs.setComponentRef(r, 'View_4327083')}
                {...injectData}
              >
                <Form
                  name={'表单'}
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'Form_712669')}
                  {...injectData}
                >
                  <Checkbox
                    name={'审批场景'}
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'Checkbox_595805')}
                    {...injectData}
                  />
                  <View
                    className="View_View_3136854"
                    name={'布局容器'}
                    labelCol={8}
                    wrapperCol={16}
                    backgroundType={{ type: 'cleanColor', color: undefined }}
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'View_3136854')}
                    {...injectData}
                  />
                  <Input
                    name={'场景最高审批等级'}
                    ...
                    readOnly={false}
                    isFormRootChild={true}
                    ref={(r: any) => refs.setComponentRef(r, 'Input_942445')}
                    {...injectData}
                  />
                </Form>
              </View>
          ...
          <Form
            ...
            readOnly={false}
            style={{ padding: '0px 0px 0px 0px' }}
            ref={(r: any) => refs.setComponentRef(r, 'Form_154804')}
            {...injectData}
          >
            <Input
              name={'CT集团编码'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_654349')}
              {...injectData}
            />
            <Input
              name={'订单流水'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_706726')}
              {...injectData}
            />
            <Input
              name={'有效期'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_590392')}
              {...injectData}
            />
          </Form>
          <BusiComp0521965
            ...
            ref={(r: any) => refs.setComponentRef(r, 'BOFramer_18971')}
            {...injectData}
          />
        </View>
      </View>
