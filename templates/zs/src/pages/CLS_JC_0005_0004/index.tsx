      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) => (refs['Form_4311097_670555'] = r)}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  ref={(r: any) => (refs['Checkbox_882584_5289015_336596'] = r)}
                  {...injectData}
                />
                <View
                  name={'布局容器'}
                ...
                <Input
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Input_361479_887285_715324'] = r)}
                  {...injectData}
                />
              </Form>
            </View>
          ...
          <Form
            ...
            ref={(r: any) => (refs['Form_449441_5218975'] = r)}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_accColseExp_50426_975593'] = r)}
              {...injectData}
            />
          </Form>
          <Row
          ...
          >
            <Form
              ...
              ref={(r: any) => (refs['Form_395851_5233095'] = r)}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_690228_114287'] = r)}
                {...injectData}
              />
              <View
                name={'布局容器'}
                ...
                ref={(r: any) => (refs['View_22346374_5530783'] = r)}
                {...injectData}
              >
                <StdUpload
                  name={'附件上传'}
                  ...
                  ref={(r: any) => (refs['StdUpload_6230546_3819126'] = r)}
                  {...injectData}
                />
              </View>
            </Form>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => (refs['BOFramer_52609'] = r)}
          {...injectData}
        />
      </View>
    </div>
