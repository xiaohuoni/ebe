...
const pageId = '889474344567050240';
const ClsJc_0005_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_688863: any) => {
    const eventDatacustomActionCode191: any = [
      {
        type: 'customActionCode',
        dataId: 167282154204011400,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '232921',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_688863;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167282155508653400,
            options: {
    ...
    eventDatacustomActionCode191.params =
      [
        {
          title: '事件入参',
          name: 'options_688863',
          value: '$options_688863$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode191,
      { options_688863 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest514: any = [
      {
        type: 'apiRequest',
        dataId: 166977348952230600,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '8999999',
        ...
        callback1: [
          {
            ...
            dataId: 166977350543758800,
            options: {
              compId: 'Input_690228_114287',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '725992',
              data: '$reply_8999999?.resultData$',
    ...
    eventDataapiRequest514.params = [] || [];
    CMDGenerator(eventDataapiRequest514, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest515: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest515.params = [] || [];
    CMDGenerator(eventDataapiRequest515, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse266: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166367506270837200,
                options: {
                  compId: 'Input_361479_887285_715324',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '233486',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166745861922817660,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166745865688027600,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166367511242031940,
                options: {
                  compId: 'Form_449441_5218975',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '6812',
    ...
    eventDataifelse266.params = [] || [];
    CMDGenerator(eventDataifelse266, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_670555',
                  uid: 'Form_4311097_670555',
                  type: 'Form',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) => refs.setComponentRef(r, 'Form_4311097_670555')}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_336596',
                    uid: 'Checkbox_882584_5289015_336596',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  disabled={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Checkbox_882584_5289015_336596')
                  }
                  {...injectData}
                />
                <View
                  className="View_View_412129"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_412129',
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_412129')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_715324',
                    uid: 'Input_361479_887285_715324',
                    type: 'Input',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Input_361479_887285_715324')
                  }
                  {...injectData}
                />
              </Form>
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_5218975',
              uid: 'Form_449441_5218975',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource232: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource232.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_5218975')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'accColseExp'}
              value={data?.factorForm?.accColseExp}
              formItemIndex={0}
              tipIcon={{
                theme: 'outlined',
                type: 'question-circle',
              ...
              tipContent={'目前已合作XX业务等，因xx原因需申请集团销户。'}
              $$componentItem={{
                id: 'Input_accColseExp_50426_975593',
                uid: 'Input_accColseExp_50426_975593',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={false}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_accColseExp_50426_975593')
              }
              {...injectData}
            />
          </Form>
          ...
          >
            <Form
              ...
              $$componentItem={{
                id: 'Form_395851_5233095',
                uid: 'Form_395851_5233095',
                type: 'Form',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Form_395851_5233095')}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_114287',
                  uid: 'Input_690228_114287',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => refs.setComponentRef(r, 'Input_690228_114287')}
                {...injectData}
              />
              <View
                className="View_View_22346374_5530783"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_5530783',
                  uid: 'View_22346374_5530783',
                  type: 'View',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_5530783')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_3819126',
                    uid: 'StdUpload_6230546_3819126',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData409: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166367515574030600,
                        options: {
                          compId: 'Input_690228_114287',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_878016[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_878016[0].label$',
                                  },
                                },
                              ],
                              operateType: 0,
                    ...
                    eventDatagetSelectedData409.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode761: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode761.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_3819126')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode762: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode762.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId95: any = [
                {
              ...
              eventDatadownloadByFileId95.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_52609')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsJc_0005_0004$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
