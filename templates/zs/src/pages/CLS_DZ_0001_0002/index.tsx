...
const pageId = '950269453468602368';
const ClsDz_0001_0002$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const updataSubmitDataProdList = (options_379575: any) => {
    const eventDatacustomActionCode177: any = [
      {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 168681662936234500,
                elseIfs: [],
                line_number: 4,
                callback1: [
                  {
                    type: 'callCustomPageFunc',
                    dataId: 168681664680257280,
                    options: {
                      compId: 'callCustomPageFunc',
                      compName: 'system',
                      id: '6124464',
          ...
          },
          {
            ...
            dataId: 167816855566875840,
            options: {
              compId: 'Table_093003_975455_588034_303562',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Table',
              id: '732889',
    ...
    eventDatacustomActionCode177.params =
      [
        {
          title: '事件入参',
          name: 'options_379575',
  ...
  const updataSubmitDataFormData = (options_543189: any) => {
    const eventDatagetCurrentFormValues7: any = [
      {
    ...
    eventDatagetCurrentFormValues7.params =
      [
        {
          title: '事件入参',
          name: 'options_543189',
    ...
    CMDGenerator(
      eventDatagetCurrentFormValues7,
      { options_543189 },
  ...
  const fileUpload = (options_3690043: any) => {
    const eventDatacustomActionCode178: any = [
      {
        type: 'customActionCode',
    ...
    eventDatacustomActionCode178.params =
      [
        {
          title: '事件入参',
  ...
  const batchDeal = (options_4690173: any) => {
    const eventDatagetTableSelected1: any = [
      {
        type: 'getTableSelected',
        dataId: 167816859726537120,
        options: {
          compId: 'Table_093003_975455_588034_303562',
          compLib: 'comm',
          pageJsonId: '537892',
        ...
        callback1: [
          {
            type: 'customActionCode',
            dataId: 167816860750122720,
            options: {
              compId: 'customActionCode',
              compName: 'page',
              id: '07896',
              pageJsonId: '537892',
              code: 'function main(data,state,success,fail){var tabelSelectors=selectedRows_1184573;if((tabelSelectors===null||tabelSelectors===void 0?void 0:tabelSelectors.length)>0){data.gradeList=data.gradeList.map(function(item){var _index=tabelSelectors.findIndex(function(selector){return selector.gradeId===item.gradeId});if(_index>-1){var _options_;console.log("\\u5904\\u7406\\u72B6\\u6001",options_4690173);item.handleIdea=((_options_=options_4690173)===null||_options_===void 0?void 0:_options_.handleIdea)||""}return item});success()}else{fail()}};',
            },
            line_number: 2,
            callback1: [
              {
                type: 'setDataSource',
                dataId: 167816860750186980,
                options: {
                  compId: 'setDataSource',
                  compName: 'page',
                  id: '129645',
    ...
    eventDatagetTableSelected1.params =
      [
        {
          title: '事件入参',
  ...
  const initTable = (options_20826: any) => {
    const eventDatacustomActionCode179: any = [
      {
        type: 'customActionCode',
        ...
        callback1: [
                    ...
                    children: [
                      {
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            todoOptions: ['visible', 'selectComp'],
                            options: {
                              compId: ['View_836897', 'View_836897_988729'],
                              compLib: 'custom',
                              pageJsonId: '537892',
                              compName: 'View',
                              id: '236052',
          ...
          },
          {
            ...
            options: {
              ...
              code: 'function main(data,state,success,fail){if(data_8946417=="0"||data_8946417=="1"||data_8946417=="2"){success(1)}};',
            },
            line_number: 12,
            callback1: [
              {
    ...
    eventDatacustomActionCode179.params =
      [
        { title: '事件入参', name: 'options_20826', value: '$options_20826$' },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode179,
      { options_20826 },
      'customActionCode',
      {
        id: 'customActionCode',
                  ...
                  dataSourceSetValue: [
                    {
                      ...
                      type: 'string',
                      initialData: { type: 'static', value: '-1' },
                      value: { type: ['context', '$data_771068$'], code: '' },
                    },
                  ],
                  operateType: 1,
                  onlySetPatch: true,
                ...
                callback1: [
                  {
                    ...
                    dataId: 168673553486297800,
                    elseIfs: [
                      {
                        dataName: 'elseIf',
                        dataId: 168673553486260400,
                        children: [
                          {
                            dataName: 'condition',
                            dataId: 168673553486262880,
                            children: [
                              {
                                dataName: 'action',
                                dataId: 168673553486230300,
                                children: [],
                                todoOptions: ['visible', 'selectComp'],
                                options: {
                                  compId: [
                            ...
                            elseIfs: [
                              {
                                dataName: 'elseIf',
                                dataId: 168673571375591600,
                                children: [
                                  {
                                    dataName: 'action',
                                    dataId: 168673578467531000,
                                    children: [],
                                    todoOptions: ['visible', 'selectComp'],
                                    options: {
                                      compId: [
                                  ...
                                  {
                                    dataName: 'action',
                                    dataId: 168681247206700380,
                                    children: [
                                      {
                                        dataName: 'callback',
                                        dataId: 168681247206730300,
                                        children: [],
                                        value: 'callback1',
                                        params: [],
                                      },
                                    ...
                                    options: {
                                      compId:
                                        'Table_093003_975455_588034_3119085_1382584',
                                      compLib: 'comm',
                                      pageJsonId: '537892',
                                      compName: 'Table',
                                      id: '996076',
                              ...
                              {
                                dataName: 'elseIf',
                                dataId: 168673553486235870,
                                children: [
                                  {
                                    dataName: 'action',
                                    dataId: 168673553486213630,
                                    children: [],
                                    todoOptions: ['visible', 'selectComp'],
                                    options: {
                                      compId: ['View_836897', 'View_167873'],
                                      compLib: 'custom',
                                      pageJsonId: '537892',
                                      compName: 'View',
                                      id: '747628',
    ...
    eventDatacustomActionCode180.params =
      [
        { title: '事件入参', name: 'options_20826', value: '$options_20826$' },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode180,
      { options_20826 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    // console 168673410462124930
    console.log('电渠-state', state);
    const eventDataapiRequest490: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest490.params = [] || [];
    CMDGenerator(eventDataapiRequest490, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest491: any = [
      {
        type: 'apiRequest',
                  ...
                  dataSourceSetValue: [
                    {
                      ...
                      type: 'objectArray',
                      initialData: { type: 'static', value: '[]' },
                      value: { type: ['context', '$data_078119$'], code: '' },
                    },
                    {
                      attrId: '569692',
                      code: 'cityZoneList',
    ...
    eventDataapiRequest491.params = [] || [];
    CMDGenerator(eventDataapiRequest491, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest492: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest492.params = [] || [];
    CMDGenerator(eventDataapiRequest492, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest493: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest493.params = [] || [];
    CMDGenerator(eventDataapiRequest493, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest494: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest494.params = [] || [];
    CMDGenerator(eventDataapiRequest494, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse254: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            options: {
              compId: [
                'Input_361479_887285_2150708_936504_923334_755169_97903_059209_7061384_941508_1546303_8297347',
              ],
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Input',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 168673494383039800,
                elseIfs: [
                  {
                    dataName: 'elseIf',
                    dataId: 168673494383013860,
                    children: [
                      {
                        dataName: 'action',
                        dataId: 168673644639192030,
                        children: [
                          {
                            dataName: 'callback',
                            dataId: 168673644639196200,
                            children: [],
                            value: 'callback1',
                            params: [],
                          },
                    ...
                    callback1: [
                      {
                        ...
                        options: {
                          ...
                          customFuncParams: 'object',
                          paramsObj: {
                            tacheCode: '$reply_4302826?.resultData.traceCode$',
                            initGradeList: '$data_9981685$',
                          },
                          paramsObjKeyValueMap: {
                            tacheCode: '$reply_4302826?.resultData.traceCode$',
            ...
            callback1: [
              {
                ...
                dataId: 167816852847623170,
                options: {
                  compId: 'Form_190947_1873837_623598_5869526',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '7277003',
    ...
    eventDataifelse254.params = [] || [];
    CMDGenerator(eventDataifelse254, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
  ...
  return (
    ...
    >
      <View
        className="View_View_537892_1_573149_701132_218771"
        name={'页面'}
        $$componentItem={{
          id: 'View_537892_1_573149_701132_218771',
          uid: 'View_537892_1_573149_701132_218771',
          type: 'View',
          ...componentItem,
        }}
        disabled={false}
        ...
        ref={(r: any) =>
          refs.setComponentRef(r, 'View_537892_1_573149_701132_218771')
        }
        {...injectData}
      >
        <Divider
          ...
          showTitle={true}
          $$componentItem={{
            id: 'Divider_52558_7410426_0513435_450346',
            uid: 'Divider_52558_7410426_0513435_450346',
            type: 'Divider',
            ...componentItem,
          }}
          disabled={false}
          ...
          ref={(r: any) =>
            refs.setComponentRef(r, 'Divider_52558_7410426_0513435_450346')
          }
          {...injectData}
        />
        <View
          ...
          $$componentItem={{
            id: 'View_6806553_3483268_062749_7477213',
            uid: 'View_6806553_3483268_062749_7477213',
            type: 'View',
            ...componentItem,
          }}
          disabled={false}
          ...
          ref={(r: any) =>
            refs.setComponentRef(r, 'View_6806553_3483268_062749_7477213')
          }
          {...injectData}
        >
          <HorizontalView
            ...
            formItemIndex={0}
            $$componentItem={{
              id: 'HorizontalView_004602_830821_1770203_9965213',
              uid: 'HorizontalView_004602_830821_1770203_9965213',
              type: 'HorizontalView',
              ...componentItem,
            }}
            disabled={false}
            ...
            ref={(r: any) =>
              refs.setComponentRef(
                r,
                'HorizontalView_004602_830821_1770203_9965213',
              )
            }
            {...injectData}
          >
            <View
              className="View_View_339406_177732_031805_647988"
              name={'布局容器'}
              $$componentItem={{
                id: 'View_339406_177732_031805_647988',
                uid: 'View_339406_177732_031805_647988',
                type: 'View',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'View_339406_177732_031805_647988')
              }
              {...injectData}
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_8411515_9167293_4337769_708507_903502_3391966_6232938_109586_394942',
                  uid: 'Form_4311097_9385662_8411515_9167293_4337769_708507_903502_3391966_6232938_109586_394942',
                  type: 'Form',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(
                    r,
                    'Form_4311097_9385662_8411515_9167293_4337769_708507_903502_3391966_6232938_109586_394942',
                  )
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_355644_646764_5265724_8221694_7217427_269901_508524_63674_975828',
                    uid: 'Checkbox_882584_5289015_934499_355644_646764_5265724_8221694_7217427_269901_508524_63674_975828',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  disabled={true}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_355644_646764_5265724_8221694_7217427_269901_508524_63674_975828',
                    )
                  }
                  {...injectData}
                />
                <View
                  className="View_View_6319234_3569864_15467365_781748_88437_8005128_331855"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                    id: 'View_6319234_3569864_15467365_781748_88437_8005128_331855',
                    uid: 'View_6319234_3569864_15467365_781748_88437_8005128_331855',
                    type: 'View',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'View_6319234_3569864_15467365_781748_88437_8005128_331855',
                    )
                  }
                  {...injectData}
                />
                <Input
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_936504_923334_755169_97903_059209_7061384_941508_1546303_8297347',
                    uid: 'Input_361479_887285_2150708_936504_923334_755169_97903_059209_7061384_941508_1546303_8297347',
                    type: 'Input',
                    ...componentItem,
                  }}
                  disabled={false}
          ...
          <Form
            ...
            busiObjectId={''}
            $$componentItem={{
              id: 'Form_190947_1873837_623598_5869526',
              uid: 'Form_190947_1873837_623598_5869526',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
            ...
            style={{ padding: '0px 0px 0px 0px' }}
            ref={(r: any) =>
              refs.setComponentRef(r, 'Form_190947_1873837_623598_5869526')
            }
            {...injectData}
          >
            <Input
              ...
              $$componentItem={{
                id: 'Input_379441_56819334_28852_2350897',
                uid: 'Input_379441_56819334_28852_2350897',
                type: 'Input',
                ...componentItem,
              }}
              disabled={true}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_379441_56819334_28852_2350897')
              }
              {...injectData}
            />
            <Input
              ...
              $$componentItem={{
                id: 'Input_0360323_306855_648804_901796',
                uid: 'Input_0360323_306855_648804_901796',
                type: 'Input',
                ...componentItem,
              }}
              disabled={true}
              ...
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_0360323_306855_648804_901796')
              }
              {...injectData}
            />
            <TextArea
              ...
              $$componentItem={{
                id: 'TextArea_56357_512748',
                uid: 'TextArea_56357_512748',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={true}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'TextArea_56357_512748')}
              {...injectData}
            />
          </Form>
          <Row
            ...
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'Row_851124_503615_8495153_702502',
              uid: 'Row_851124_503615_8495153_702502',
              type: 'Row',
              ...componentItem,
            }}
            disabled={false}
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Row_851124_503615_8495153_702502')
            }
            {...injectData}
          >
            <View
              className="View_View_167873"
              name={'详情表格容器'}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
                id: 'View_167873',
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_167873')}
              {...injectData}
            >
              <Table
                name={'场景表格'}
                ...
                onRowEdit={(rowId: any, row: any, index: any) => {
                  const eventDatashowCustomModal233: any = [
                    {
                  ...
                  eventDatashowCustomModal233.params =
                    [
                ...
                onRowDetail={(rowId: any, row: any, index: any) => {
                  const eventDatashowCustomModal234: any = [
                    {
                      type: 'showCustomModal',
                  ...
                  eventDatashowCustomModal234.params =
                    [
                      { title: '行id', name: 'rowId', value: '$rowId$' },
                      {
                        title: '行对象',
                ...
                ref={(r: any) => refs.setComponentRef(r, 'Table_096215')}
                {...injectData}
              />
            </View>
            <View
              className="View_View_836897_988729"
              name={'无多选档次表格容器'}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
                id: 'View_836897_988729',
                uid: 'View_836897_988729',
                type: 'View',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_836897_988729')}
              {...injectData}
            >
              <Table
                name={'场景表格'}
                ...
                columns={[
                  {
                    ...
                    id: '6469864',
                    staticDataSource: [
                      { id: '488074', label: '通过', value: '1' },
                      { id: '9542136', label: '不通过', value: '0' },
                      { id: '530621', label: '不通过', value: '3' },
                    ],
                    customRendering: undefined,
                    editContent: {
                      edittype: 'title',
                  ...
                  },
                  {
                    ...
                    id: '428466',
                    staticDataSource: [
                      { id: '7246578', label: '新建', value: '1' },
                      { id: '8127835', label: '调整', value: '2' },
                    ],
                    customRendering: undefined,
                    editContent: {
                      edittype: 'title',
                ...
                $$componentItem={{
                  id: 'Table_093003_975455_588034_3119085_1382584',
                  uid: 'Table_093003_975455_588034_3119085_1382584',
                  type: 'Table',
                  ...componentItem,
                }}
                disabled={false}
                ...
                style={{ margin: '16px 0px 16px 0px' }}
                onRowEdit={(rowId: any, row: any, index: any) => {
                  const eventDatashowCustomModal235: any = [
                    {
                      type: 'showCustomModal',
                      dataId: 167324950367922300,
                      options: {
                      ...
                      callback1: [
                        {
                          ...
                          options: {
                            ...
                            id: '93443',
                            pageJsonId: '537892',
                            code: 'function main(data,state,success,fail){console.log("\\u5F39\\u7A97\\u786E\\u8BA4\\u56DE\\u8C03\\u53C2\\u6570",okData_224589);data.gradeList[index]=Object.assign(data.gradeList[index],okData_224589);success(data.gradeList)};',
                          },
                          line_number: 2,
                          callback1: [
                            {
                  ...
                  eventDatashowCustomModal235.params =
                    [
                      { title: '行id', name: 'rowId', value: '$rowId$' },
                      {
                        title: '行对象',
                ...
                onRowDetail={(rowId: any, row: any, index: any) => {
                  const eventDatashowCustomModal236: any = [
                    {
                      type: 'showCustomModal',
                      dataId: 167324945398196130,
                      options: {
                  ...
                  eventDatashowCustomModal236.params =
                    [
                      { title: '行id', name: 'rowId', value: '$rowId$' },
                      {
                        title: '行对象',
            ...
            <View
              className="View_View_836897_8898268_3011325"
              name={'多选档次表格容器'}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
                id: 'View_836897_8898268_3011325',
                uid: 'View_836897_8898268_3011325',
                type: 'View',
                ...componentItem,
              }}
              disabled={false}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'View_836897_8898268_3011325')
              }
              {...injectData}
            >
              <Table
                ...
                columns={[
                  {
                    ...
                    id: '301539',
                    staticDataSource: [
                      { id: '701125', label: '通过', value: '1' },
                      { id: '553478', label: '不通过', value: '0' },
                      { id: '2229193', label: '不通过', value: '3' },
                    ],
                    customRendering: undefined,
                    editContent: {
                      edittype: 'title',
                  ...
                  },
                  {
                    ...
                    id: '940699',
                    staticDataSource: [
                      { id: '998534', label: '新建', value: '1' },
                      { id: '7532836', label: '调整', value: '2' },
                    ],
                    customRendering: undefined,
                    editContent: {
                      edittype: 'title',
                ...
                dataSourceFromDataSourceConfig={'data.gradeList'}
                $$componentItem={{
                  id: 'Table_093003_975455_588034_303562',
                  uid: 'Table_093003_975455_588034_303562',
                  type: 'Table',
                  ...componentItem,
                }}
                disabled={false}
                ...
                style={{ margin: '16px 0px 16px 0px' }}
                onRowDetail={(rowId: any, row: any, index: any) => {
                  const eventDatashowCustomModal237: any = [
                    {
                      type: 'showCustomModal',
                      dataId: 167324945398196130,
                      options: {
                  ...
                  eventDatashowCustomModal237.params =
                    [
                      { title: '行id', name: 'rowId', value: '$rowId$' },
                      {
                        title: '行对象',
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Table_093003_975455_588034_303562')
                }
                {...injectData}
              />
              <View
                className="View_View_852425_151885"
                name={'表格按钮容器'}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_852425_151885',
                  uid: 'View_852425_151885',
                  type: 'View',
                  ...componentItem,
                }}
                disabled={false}
                ...
                ref={(r: any) => refs.setComponentRef(r, 'View_852425_151885')}
                {...injectData}
              >
                <Button
                  name={'通过'}
                  ...
                  hasIcon={false}
                  $$componentItem={{
                    id: 'Button_832224_171507',
                    uid: 'Button_832224_171507',
                    type: 'Button',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onClick={(e: any) => {
                    const eventDatacallSelfFunc637: any = [
                      {
                        type: 'callSelfFunc',
                    ...
                    eventDatacallSelfFunc637.params =
                      [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                    CMDGenerator(
                      eventDatacallSelfFunc637,
                      { e },
                      'callSelfFunc',
                      {
                        id: 'callSelfFunc',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Button_832224_171507')
                  }
                  {...injectData}
                />
                <Button
                  ...
                  hasIcon={false}
                  $$componentItem={{
                    id: 'Button_487669_8212735',
                    uid: 'Button_487669_8212735',
                    type: 'Button',
                    ...componentItem,
                  }}
                  disabled={false}
                  ...
                  onClick={(e: any) => {
                    const eventDatacallSelfFunc638: any = [
                      {
                        type: 'callSelfFunc',
                    ...
                    eventDatacallSelfFunc638.params =
                      [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                    CMDGenerator(
                      eventDatacallSelfFunc638,
                      { e },
                      'callSelfFunc',
                      {
                        id: 'callSelfFunc',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'Button_487669_8212735')
                  }
                  {...injectData}
                />
              </View>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) =>
            refs.setComponentRef(r, 'BOFramer_349769_535362_307168')
          }
          {...injectData}
        />
      </View>
...
export default withPageHOC(ClsDz_0001_0002$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
