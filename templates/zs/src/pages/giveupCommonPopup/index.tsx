...
const GiveupCommonPopup$$Modal: React.FC<PageProps> = ({
  ...
  const fillTacheRemark = (options_141226: any) => {
    const eventDatasetValue7: any = [
      {
        type: 'setValue',
        dataId: 166920747427982900,
        options: {
          compId: 'TextArea_4776246_432797_396424',
          compLib: 'comm',
          pageJsonId: 30,
          compName: 'TextArea',
          id: '126148',
          valueList: {
            TextArea_4776246_432797_396424: '$options_141226.handleComment$',
          },
        },
        line_number: 1,
        callback1: [],
    ...
    CMDGenerator(eventDatasetValue7, { options_141226 }, 'setValue', {
      id: 'setValue',
      name: 'setValue',
      type: 'setValue',
      platform: 'undefined',
  ...
  useEffect(() => {
    // console 168437686608166500
    console.log('====作废处理====', state);
    const eventDatasetDataSource20: any = [
      {
        type: 'setDataSource',
    ...
    eventDatasetDataSource20.params = [] || [];
    CMDGenerator(eventDatasetDataSource20, {}, 'setDataSource', {
      id: 'setDataSource',
      name: 'setDataSource',
      type: 'setDataSource',
      platform: 'undefined',
    ...
    <div style={{ height: '100%', ...style }} className="__CustomClass_30__">
      ...
      >
        <Row
          ...
          $$componentItem={{
            id: 'Row_628506_2746863',
            uid: 'Row_628506_2746863',
            type: 'Row',
            ...componentItem,
          }}
          disabled={false}
        ...
        >
          <Form
            ...
            $$componentItem={{
              id: 'Form_0063102_5441816_834516',
              uid: 'Form_0063102_5441816_834516',
              type: 'Form',
              ...componentItem,
            }}
            disabled={false}
          ...
          >
            <TextArea
              ...
              maxLength={256}
              $$componentItem={{
                id: 'TextArea_4776246_432797_396424',
                uid: 'TextArea_4776246_432797_396424',
                type: 'TextArea',
                ...componentItem,
              }}
              disabled={false}
        ...
        <View
          ...
          $$componentItem={{
            ...
            uid: 'View_30_1122_56129022_411221_5151687',
            type: 'View',
            ...componentItem,
          }}
          disabled={false}
        ...
        >
          <Button
            ...
            hasIcon={false}
            $$componentItem={{
              id: 'Button_30_122_408084_070965_1557667',
              uid: 'Button_30_122_408084_070965_1557667',
              type: 'Button',
              ...componentItem,
            }}
            disabled={false}
            ...
            onClick={(e: any) => {
              const eventDatacloseModal135: any = [
                {
                  type: 'closeModal',
              ...
              eventDatacloseModal135.params =
                [{ title: '事件对象', name: 'e', value: '$e$' }] || [];
              CMDGenerator(eventDatacloseModal135, { e }, 'closeModal', {
                id: 'closeModal',
                name: 'closeModal',
                type: 'closeModal',
                platform: 'pc',
          ...
          <Button
            ...
            hasIcon={false}
            $$componentItem={{
              id: 'Button_30_121_490898_246542_8622692',
              uid: 'Button_30_121_490898_246542_8622692',
              type: 'Button',
              ...componentItem,
            }}
            disabled={false}
            ...
            onClick={(e: any) => {
              const eventDatavalidateCurrentForm81: any = [
                {
                  type: 'validateCurrentForm',
                  dataId: 166996280081640580,
                  options: {
                    compId: 'Form_0063102_5441816_834516',
                    compLib: 'comm',
                    pageJsonId: 30,
                    compName: 'Form',
                    id: '798575',
                  ...
                  callback1: [
                    {
                      ...
                      options: {
                        compId: 'Button_30_121_490898_246542_8622692',
                        compLib: 'comm',
                        pageJsonId: 30,
                        compName: 'Button',
                        id: '186972',
                          ...
                          },
                          {
                            ...
                            children: [
                              ...
                              },
                              {
                                ...
                                value: { type: ['customize'], code: 'refuse' },
                              },
                              {
                                code: 'busiObjNbr',
                                attrType: 'field',
              ...
              eventDatavalidateCurrentForm81.params =
                [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
              CMDGenerator(
                eventDatavalidateCurrentForm81,
                { e },
                'validateCurrentForm',
                {
