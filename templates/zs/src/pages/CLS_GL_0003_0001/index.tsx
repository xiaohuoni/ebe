...
const ClsGl_0003_0001$$Page: React.FC<PageProps> = ({
  ...
  useEffect(() => {
    ...
    const eventDatacustomActionCode264: any = [
      {
    ...
    eventDatacustomActionCode264.params = [] || [];
    CMDGenerator(eventDatacustomActionCode264, {}, 'customActionCode', {
      id: 'customActionCode',
      ...
      >
        ...
        >
          ...
          <TextArea
            ...
            placeholder={'请输入'}
            formItemIndex={3}
            fieldName={'onLineDesc'}
            value={data?.factoryForm?.onLineDesc}
            $$componentItem={{
              id: 'TextArea_996429',
              uid: 'TextArea_996429',
              type: 'TextArea',
