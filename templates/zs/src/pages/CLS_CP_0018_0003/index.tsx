...
const pageId = '1042675812651814912';
const ClsCp_0018_0003$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode127: any = [
      {
    ...
    eventDatacustomActionCode127.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse196.params = [] || [];
    CMDGenerator(eventDataifelse196, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest367: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest367.params = [] || [];
    CMDGenerator(eventDataapiRequest367, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest368: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest368.params = [] || [];
    CMDGenerator(eventDataapiRequest368, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest369: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest369.params = [] || [];
    CMDGenerator(eventDataapiRequest369, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest370: any = [
      {
        type: 'apiRequest',
        dataId: 170020422617434780,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '818778',
                  ...
                  children: [
                    {
                      ...
                      parents: ['root', 'body'],
                      id: 'root.body.catalogCode',
                      dataKey: '818778_root.body.catalogCode',
                      value: {
                        type: ['customize'],
                        code: '$state.catalogCode$',
                      },
                    ...
                    },
                    {
                      ...
                      parents: ['root', 'body'],
                      id: 'root.body.attrCode',
                      dataKey: '818778_root.body.attrCode',
                      value: { type: ['customize'], code: 'applyBsType' },
                      parentType: 'object',
                      parentKey: '0-3',
                      key: '0-3-1',
                    },
        ...
        callback1: [
          {
            type: 'reloadSelectData',
            dataId: 170020423870953300,
            options: {
              compId: 'Select_153685',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '853504',
              data: '$reply_818778?.resultData$',
              labelKey: 'attrValueName',
              valueKey: 'attrValue',
            },
            line_number: 10,
    ...
    eventDataapiRequest370.params = [] || [];
    CMDGenerator(eventDataapiRequest370, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest371: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest371.params = [] || [];
    CMDGenerator(eventDataapiRequest371, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse197: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse197.params = [] || [];
    CMDGenerator(eventDataifelse197, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          type={'horizontal'}
          dashed={false}
          dividerText={'大数据行业端口免白/签名变更/无合同开通审批单'}
          showTitle={true}
          $$componentItem={{
            id: 'Divider_52558',
            uid: 'Divider_52558',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource156: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource156.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <Select
              ...
              placeholder={'请选择'}
              formItemIndex={3}
              fieldName={'applyBsType'}
              value={data?.factorForm?.applyBsType}
              $$componentItem={{
                id: 'Select_153685',
                uid: 'Select_153685',
                type: 'Select',
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Select_153685')}
              {...injectData}
            />
            <Input
              name={'业务接入号'}
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData317: any = [
                      {
                    ...
                    eventDatagetSelectedData317.params =
                      [
                    ...
                    const eventDatagetSelectedData318: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData318.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode618: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode618.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode619: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode619.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId61: any = [
                {
              ...
              eventDatadownloadByFileId61.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0018_0003$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
