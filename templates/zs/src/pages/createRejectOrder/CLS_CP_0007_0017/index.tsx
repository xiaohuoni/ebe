...
const CreateRejectOrderClsCp_0007_0017$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDatacustomActionCode255: any = [
      {
    ...
    eventDatacustomActionCode255.params = [] || [];
    CMDGenerator(eventDatacustomActionCode255, {}, 'customActionCode', {
      id: 'customActionCode',
      name: 'customActionCode',
      type: 'customActionCode',
      platform: 'undefined',
    });
    const eventDataapiRequest310: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest310.params = [] || [];
    CMDGenerator(eventDataapiRequest310, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    }); // console 170131275076413120
    console.log('===DATA===', urlParam, data, state);
  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_537892_1_2061057'] = r)}
        {...injectData}
      >
        <Divider
          name={'分割线'}
          ...
          ref={(r: any) => (refs['Divider_52558_0392997'] = r)}
          {...injectData}
        />
        <View
          name={'布局容器'}
          ...
          ref={(r: any) => (refs['View_6806553_449831'] = r)}
          {...injectData}
        >
          <HorizontalView
            name={'左右布局'}
            ...
            ref={(r: any) => (refs['HorizontalView_004602_63707'] = r)}
            {...injectData}
          >
            <View
              name={'布局容器'}
              ...
              ref={(r: any) => (refs['View_339406_281032'] = r)}
              {...injectData}
            >
              <HorizontalView
                name={'左右布局'}
                ...
                ref={(r: any) => (refs['HorizontalView_806975'] = r)}
                {...injectData}
              >
                <View
                  name={'布局容器'}
                ...
                >
                  <Checkbox
                    ...
                    readOnly={false}
                    onChange={(e: any) => {
                      const eventDatacustomActionCode543: any = [
                        {
                          type: 'customActionCode',
                      ...
                      eventDatacustomActionCode543.params =
                        [
                          {
                            title: '复选框取值',
                            name: 'e',
                ...
                >
                  <Text
                    ...
                    ref={(r: any) => (refs['Text_35633157'] = r)}
                    {...injectData}
                  />
                </View>
                <View
                  ...
                  ref={(r: any) => (refs['View_200544_764009'] = r)}
                  {...injectData}
                >
                  <Text
                    name={'文本'}
                ...
                <View
                  ...
                  ref={(r: any) => (refs['View_741146_4429651'] = r)}
                  {...injectData}
                >
                  <Text
                    name={'文本'}
                ...
                <View
                  ...
                  ref={(r: any) => (refs['View_741146_4429651_673978'] = r)}
                  {...injectData}
                >
                  <Text
                    name={'文本'}
          ...
          <Table
            ...
            ref={(r: any) => (refs['Table_8700198_489761_4830966'] = r)}
            {...injectData}
          />
        </View>
      </View>
...
export default withPageHOC(CreateRejectOrderClsCp_0007_0017$$Page, {
  pageId: '1047342056277389312',
  hasLogin: false,
  dataSource,
