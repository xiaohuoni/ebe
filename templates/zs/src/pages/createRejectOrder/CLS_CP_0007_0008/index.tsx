...
const CreateRejectOrderClsCp_0007_0008$$Page: React.FC<PageProps> = ({
  ...
  return (
    ...
    >
      <View
        className="View_View_537892_1_538963"
        name={'页面'}
        visible={true}
        $$componentItem={{
      ...
      >
        ...
        />
        <View
          className="View_View_6806553_449831_089676"
          name={'布局容器'}
          visible={true}
        ...
        >
          ...
          >
            <View
              className="View_View_339406_281032_297273"
              name={'布局容器'}
              visible={true}
              $$componentItem={{
            ...
            >
              ...
              >
                <View
                  className="View_View_9690203_589474"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                ...
                <View
                  className="View_View_200544_115993"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                ...
                <View
                  className="View_View_200544_764009_0226035"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                ...
                <View
                  className="View_View_741146_4429651_804104"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                ...
                <View
                  className="View_View_741146_4429651_673978_7050843"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
