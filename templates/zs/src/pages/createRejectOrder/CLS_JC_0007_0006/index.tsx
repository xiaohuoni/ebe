...
const CreateRejectOrderClsJc_0007_0006$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDatacustomActionCode256: any = [
      {
    ...
    eventDatacustomActionCode256.params = [] || [];
    CMDGenerator(eventDatacustomActionCode256, {}, 'customActionCode', {
      id: 'customActionCode',
      name: 'customActionCode',
      type: 'customActionCode',
      platform: 'undefined',
    });
    const eventDataapiRequest325: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest325.params = [] || [];
    CMDGenerator(eventDataapiRequest325, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    readOnly={false}
                    onChange={(e: any) => {
                      const eventDatacustomActionCode563: any = [
                        {
                          type: 'customActionCode',
                      ...
                      eventDatacustomActionCode563.params =
                        [
                          {
                            title: '复选框取值',
                            name: 'e',
...
export default withPageHOC(CreateRejectOrderClsJc_0007_0006$$Page, {
  pageId: '1047074346297569280',
  hasLogin: false,
  dataSource,
