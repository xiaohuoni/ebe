...
const pageId = '910628839639101440';
const CreateRejectOrderClsCp_0007_0009$$Page: React.FC<PageProps> = ({
  ...
  return (
    ...
    >
      <View
        className="View_View_537892_1_47249"
        name={'页面'}
        visible={true}
        $$componentItem={{
        ...
        ref={(r: any) => refs.setComponentRef(r, 'View_537892_1_47249')}
        {...injectData}
      >
        <Divider
          name={'分割线'}
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_52558_34577')}
          {...injectData}
        />
        <View
          className="View_View_6806553_449831_241779"
          name={'布局容器'}
          visible={true}
          ...
          ref={(r: any) =>
            refs.setComponentRef(r, 'View_6806553_449831_241779')
          }
          {...injectData}
        >
          <HorizontalView
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'HorizontalView_004602_63707_599136')
            }
            {...injectData}
          >
            <View
              className="View_View_339406_281032_719202"
              name={'布局容器'}
              visible={true}
              $$componentItem={{
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'View_339406_281032_719202')
              }
              {...injectData}
            >
              <HorizontalView
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'HorizontalView_806975_0509512')
                }
                {...injectData}
              >
                <View
                  className="View_View_9690203_19122"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_9690203_19122')
                  }
                  {...injectData}
                >
                  <Checkbox
                ...
                <View
                  className="View_View_200544_3384213"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_200544_3384213')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_35633157_459709')
                    }
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_200544_764009_3289322"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_200544_764009_3289322')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_4468414_422414')
                    }
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_741146_4429651_528883"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_741146_4429651_528883')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'Text_721006')}
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_741146_4429651_673978_1736115"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'View_741146_4429651_673978_1736115',
                    )
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'Text_71270902')}
                    {...injectData}
                  />
                </View>
              </HorizontalView>
          ...
          <Table
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Table_8700198_43013_894282_793728')
            }
            {...injectData}
          />
        </View>
