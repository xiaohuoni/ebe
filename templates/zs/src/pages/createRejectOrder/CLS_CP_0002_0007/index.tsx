...
const pageId = '937532223410704384';
const CreateRejectOrderClsCp_0002_0007$$Page: React.FC<PageProps> = ({
  ...
  return (
    ...
    >
      <View
        className="View_View_537892_1_232562"
        name={'页面'}
        visible={true}
        $$componentItem={{
        ...
        ref={(r: any) => refs.setComponentRef(r, 'View_537892_1_232562')}
        {...injectData}
      >
        <Divider
          name={'分割线'}
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_95322766_8425169')}
          {...injectData}
        />
        <View
          className="View_View_6806553_730932"
          name={'布局容器'}
          visible={true}
          ...
          ref={(r: any) => refs.setComponentRef(r, 'View_6806553_730932')}
          {...injectData}
        >
          <HorizontalView
            name={'左右布局'}
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'HorizontalView_004602_63707_2612714')
            }
            {...injectData}
          >
            <View
              className="View_View_339406_281032_745525"
              name={'布局容器'}
              visible={true}
              $$componentItem={{
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'View_339406_281032_745525')
              }
              {...injectData}
            >
              <HorizontalView
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'HorizontalView_806975_722668')
                }
                {...injectData}
              >
                <View
                  className="View_View_9690203_631823"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_9690203_631823')
                  }
                  {...injectData}
                >
                  <Checkbox
                ...
                <View
                  className="View_View_200544_2986568"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_200544_2986568')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_35633157_94036')
                    }
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_200544_764009_4859037"
                  name={'布局容器'}
                  visible={true}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_200544_764009_4859037')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_4468414_703735')
                    }
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_741146_4429651_496981"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'View_741146_4429651_496981')
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_456671_280083')
                    }
                    {...injectData}
                  />
                </View>
                <View
                  className="View_View_741146_4429651_673978_87307074"
                  name={'布局容器'}
                  visible={true}
                  $$componentItem={{
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'View_741146_4429651_673978_87307074',
                    )
                  }
                  {...injectData}
                >
                  <Text
                    ...
                    ref={(r: any) =>
                      refs.setComponentRef(r, 'Text_269337_3231567')
                    }
                    {...injectData}
                  />
                </View>
          ...
          <Table
            ...
            ref={(r: any) =>
              refs.setComponentRef(r, 'Table_7669008_367679_0926046')
            }
            {...injectData}
          />
        </View>
