...
const Xuanzerenyuanguanlianzuzhi3072copy$$Modal: React.FC<PageProps> = ({
  ...
  return (
    ...
    >
      <View
        className="View_View_482782_1_2245467"
        name={'页面'}
        visible={true}
        $$componentItem={{
      ...
      >
        <View
          className="View_View_947999_9714262"
          name={'布局容器'}
          visible={true}
        ...
        >
          ...
          >
            ...
            />
            <View
              className="View_View_841498_8261476_979664_9421495"
              name={'布局容器'}
              visible={true}
              labelCol={8}
              wrapperCol={16}
            ...
            >
              <View
                className="View_View_110211_6102645_905926"
                name={'布局容器'}
                visible={true}
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
        ...
        <View
          className="View_View_740935_509061"
          name={'布局容器'}
          visible={true}
          backgroundType={{ type: 'cleanColor', color: undefined }}
          $$componentItem={{
