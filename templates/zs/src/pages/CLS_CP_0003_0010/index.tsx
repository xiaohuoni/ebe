...
const ClsCp_0003_0010$$Page: React.FC<PageProps> = ({
  ...
  const fileUpload = (options_1964167: any) => {
    ...
    eventDatacustomActionCode113.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDatacustomActionCode258: any = [
      {
        type: 'customActionCode',
        ...
        options: {
          ...
          id: '943794',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){var iconClass="icon-tips";var tableId="Table_8700198_3717786";var thName="\\u5F15\\u5165\\u8BC4\\u5BA1\\u5F97\\u5206";var ths=document.querySelectorAll("div[data-compid=".concat(tableId,"] .pcfactory-table-thead th"));var icon=document.getElementsByClassName(iconClass)[0];if(!icon)return;for(var i=0;i<ths.length;i+=1){if(ths[i].innerText===thName){icon.style.marginLeft="6px";ths[i].appendChild(icon)}}};',
        },
        line_number: 1,
        callback1: [],
        callback2: [],
    ...
    eventDatacustomActionCode258.params = [] || [];
    CMDGenerator(eventDatacustomActionCode258, {}, 'customActionCode', {
      id: 'customActionCode',
      name: 'customActionCode',
      type: 'customActionCode',
      platform: 'undefined',
    });
    const eventDataifelse180: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse180.params = [] || [];
    CMDGenerator(eventDataifelse180, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest333: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest333.params = [] || [];
    CMDGenerator(eventDataapiRequest333, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest334: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest334.params = [] || [];
    CMDGenerator(eventDataapiRequest334, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest335: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest335.params = [] || [];
    CMDGenerator(eventDataapiRequest335, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse181: any = [
      {
        type: 'ifelse',
        condition: [
          {
            ...
            callback1: [
              {
                ...
                options: {
                  ...
                  id: '013094',
                  pageJsonId: '537892',
                  dataSourceId: 169936121307829300,
                  dataSourceName: 'backAgencyList',
                  dataSourceRelType: 'custom',
                  dataSourceSetValue: [
                    {
                      attrId: '923634',
    ...
    eventDataifelse181.params = [] || [];
    CMDGenerator(eventDataifelse181, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource146: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource146.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal172: any = [
                    {
                      ...
                      options: {
                        ...
                        paramsObj: {
                          ...
                          isCoreFlag: '1',
                          backAgencyList: '$data.backAgencyList$',
                        },
                      ...
                      callback1: [
                        {
                          ...
                          options: {
                            ...
                            id: '195951',
                            pageJsonId: '537892',
                            code: 'function main(data,state,success,fail){console.log("\\u5F39\\u7A97\\u8FD4\\u56DE:",okData_611628);var res=okData_611628;var backAgencyList=data.backAgencyList||[];console.log("backAgencyList = ",backAgencyList);if(backAgencyList.length>0){var maxRowId=1;for(var i=0;i<backAgencyList.length;i++){var rowId=parseInt(backAgencyList[i]["rowId"]);if(maxRowId<=rowId){maxRowId=rowId}}res.rowId=parseInt(maxRowId)+1}else{res.rowId=1}backAgencyList.unshift(res);var instList=[];for(var key in res){instList.push({"attrCode":key,"attrName":"","attrValue":res[key]})}var instObj={"instCode":res.rowId,"instAttrList":instList};if(data.sceneSubmit.instList!=undefined&&data.sceneSubmit.instList.length>0){data.sceneSubmit.instList.unshift(instObj)}else{var instList=[];instList.unshift(instObj);data.sceneSubmit.instList=instList}data.backAgencyList=backAgencyList;success()};',
                          },
                          line_number: 2,
                          callback1: [
                            {
                  ...
                  eventDatashowCustomModal172.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal172,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey60: any = [
                    {
                                      ...
                                      children: [
                                        {
                                          ...
                                          options: {
                                            ...
                                            id: '25397954',
                                            pageJsonId: '537892',
                                            code: 'function main(data,state,success,fail){var backAgencyList=data.backAgencyList;var sel=selectedRowKeys_7288851;var res=[];var instList=[];if(sel!=undefined&&sel.length>0){backAgencyList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.rowId});console.log(exit);if(exit===-1){res.push(v)}});data.backAgencyList=res;data.sceneSubmit.instList.forEach(function(v){var exit=sel.findIndex(function(item){return item==v.instCode});if(exit===-1){instList.push(v)}});data.sceneSubmit.instList=instList}success()};',
                                          },
                  ...
                  eventDatagetTableSelectedKey60.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey60,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                      ...
                      condition: [
                        ...
                        },
                        {
                          options: {
                            useManual: true,
                            useObject: false,
                            context: '$data.backAgencyList.length$',
                            operate: '>',
                            manualValue: '0',
                          },
                          condId: '225057',
                  ...
                  eventDataifelse479.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse479, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading180: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest737: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode574: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode574.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatasetLoading181: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading181.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading181, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDataapiRequest738: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest738.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest738, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected60: any = [
                    {
                  ...
                  eventDatagetTableSelected60.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected60,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatasetLoading182: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading182.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading182, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDatacustomActionCode575: any = [
                    {
                      type: 'customActionCode',
                      ...
                      options: {
                        ...
                        id: '7076346',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){var arr1=[];var arr2=[];var agencyList=data.backAgencyList||[];for(var i=0;i<agencyList.length;i++){var info=agencyList[i];{arr2.push({"name":"\\u540E\\u5907\\u4EE3\\u7406\\u5546\\u540D\\u79F0","value":info.backAgencyName});arr2.push({"name":"\\u5F15\\u5165\\u8BC4\\u5BA1\\u5F97\\u5206","value":info.judgeScore});arr2.push({"name":"\\u627F\\u8BFA\\u5B63\\u5EA6\\u9884\\u5B58\\u91D1\\u989D\\uFF08\\u5355\\u4F4D\\uFF1A\\u4E07\\u5143\\uFF09","value":info.promiseQuarterPrestoreFee});arr2.push({"name":"\\u4EE3\\u7406\\u5546\\u7B80\\u4ECB","value":info.agencyProfile})}arr1.push(arr2);arr2=[]}if(arr1.length>0){success(JSON.stringify(arr1))}else{fail()}};',
                      },
                      line_number: 9,
                      callback1: [
                        {
                  ...
                  eventDatacustomActionCode575.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode575,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            dataSource={data?.backAgencyList}
            fieldName={'data.MemberInfo.length'}
            total={data?.backAgencyList?.length}
            hiddenAction={false}
            rowKey={'rowId'}
            rowActions={[]}
            extend={[]}
            ...
            dataSourceFromDataSourceConfig={'data.backAgencyList'}
            $$componentItem={{
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData277: any = [
                      {
                    ...
                    eventDatagetSelectedData277.params =
                      [
                    ...
                    const eventDatagetSelectedData278: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData278.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode577: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode577.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode578: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode578.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId54: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId54.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
