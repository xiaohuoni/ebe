...
const pageId = '930364949744459776';
const ClsCp_0011_0002$$Page: React.FC<PageProps> = ({
  ...
  return (
    ...
    >
      <View
        className="View_View_537892_1_939141"
        name={'页面'}
        $$componentItem={{
      ...
      >
        ...
        />
        <View
          className="View_View_6806553_683494"
          name={'布局容器'}
        ...
        >
          ...
          >
            <View
              className="View_View_339406_641214"
              name={'布局容器'}
              $$componentItem={{
            ...
            >
              ...
              >
                ...
                />
                <View
                  className="View_View_855319_4239901"
                  name={'布局容器'}
                  backgroundType={{ type: 'cleanColor', color: undefined }}
                  $$componentItem={{
          ...
          >
            ...
            >
              <View
                ...
                ref={(r: any) => refs.setComponentRef(r, 'View_2989285')}
                {...injectData}
              >
                <Text
                  name={'*'}
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'Text_77289')}
                  {...injectData}
                />
                <Text
                  name={'业务期限'}
          ...
          <View
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_380221')}
            {...injectData}
          >
            <Button
              name={'新增'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Button_2162543')}
              {...injectData}
            />
            <Button
              name={'删除'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Button_576412')}
              {...injectData}
            />
            <Button
              name={'清空'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Button_804191')}
              {...injectData}
            />
          </View>
          <Table
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Table_009428')}
            {...injectData}
          />
          <Table
            name={'表格'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Table_937379')}
            {...injectData}
          />
          <Row
            name={'行容器'}
          ...
          >
            ...
            >
              ...
              />
              <View
                className="View_View_22346374_875512_9117364_899382_548798_637825"
                name={'布局容器'}
                labelCol={8}
                wrapperCol={16}
                backgroundType={{ type: 'cleanColor', color: undefined }}
        ...
        <View
          className="View_View_4949093_7915488"
          name={'布局容器'}
          backgroundType={{ type: 'cleanColor', color: undefined }}
          $$componentItem={{
