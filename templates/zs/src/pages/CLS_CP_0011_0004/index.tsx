...
const pageId = '986186614709608448';
    ...
    >
      ...
      >
        ...
        >
            ...
            >
              ...
              >
                ...
                <Input
                  ...
                  readOnly={true}
                  isFormRootChild={true}
                  ref={(r: any) => refs.setComponentRef(r, 'Input_016057')}
                  {...injectData}
                />
              </Form>
            </View>
          ...
          >
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_discount_401711')}
              {...injectData}
            />
            <View
              className="View_View_900528"
              name={'布局容器'}
              backgroundType={{ type: 'cleanColor', color: undefined }}
              $$componentItem={{
                id: 'View_900528',
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_900528')}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_881094')}
          {...injectData}
        />
      </View>
    </div>
