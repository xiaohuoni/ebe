        ...
        >
          ...
          >
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_691764455'] = r)}
              {...injectData}
            />
            <Input
              name={'发票类型'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_8921829'] = r)}
              {...injectData}
            />
            <Input
              name={'发票申请场景'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_7849427'] = r)}
              {...injectData}
            />
            <Input
              name={'发票备注信息是否修改'}
            ...
            <TextArea
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['TextArea_3110722'] = r)}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => (refs['Divider_052764'] = r)}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => (refs['Divider_257542'] = r)}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => (refs['Divider_829144'] = r)}
              {...injectData}
            />
            <Input
              name={'销售方名称'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_4073395'] = r)}
              {...injectData}
            />
            <Input
              name={'销售方统一社会信用代码'}
            ...
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_9997785'] = r)}
              {...injectData}
            />
          </Form>
          <BusiComp0521965
