...
const pageId = '1041547000576790528';
const ClsCp_0018_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode111: any = [
      {
    ...
    eventDatacustomActionCode111.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse176.params = [] || [];
    CMDGenerator(eventDataifelse176, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDataapiRequest326: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest326.params = [] || [];
    CMDGenerator(eventDataapiRequest326, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest327: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest327.params = [] || [];
    CMDGenerator(eventDataapiRequest327, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest328: any = [
      {
        type: 'apiRequest',
        dataId: 169994065514103360,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '851785',
                  ...
                  children: [
                    {
                      ...
                      parents: ['root', 'body'],
                      id: 'root.body.catalogCode',
                      dataKey: '851785_root.body.catalogCode',
                      value: {
                        type: ['customize'],
                        code: '$state.catalogCode$',
                      },
                    ...
                    },
                    {
                      ...
                      parents: ['root', 'body'],
                      id: 'root.body.attrCode',
                      dataKey: '851785_root.body.attrCode',
                      value: { type: ['customize'], code: 'bsType' },
                      parentType: 'object',
                      parentKey: '0-3',
                      key: '0-3-1',
                      _deletable: true,
        ...
        callback1: [
          {
            type: 'reloadSelectData',
            dataId: 169994067067189250,
            options: {
              compId: 'Select_077278',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '357917',
              data: '$reply_851785?.resultData$',
              labelKey: 'attrValueName',
              valueKey: 'attrValue',
            },
            line_number: 8,
    ...
    eventDataapiRequest328.params = [] || [];
    CMDGenerator(eventDataapiRequest328, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest329: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest329.params = [] || [];
    CMDGenerator(eventDataapiRequest329, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse177: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse177.params = [] || [];
    CMDGenerator(eventDataifelse177, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource144: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource144.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <Select
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Select_077278')}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal170: any = [
                    {
                      ...
                      options: {
                        ...
                        id: '611628',
                        pageJsonId: '537892',
                        modalname: '/CLS_CP_0018_0001ADDINFO',
                        ...
                        modalPath: '/CLS_CP_0018_0001ADDINFO',
                      },
                      line_number: 1,
                      callback1: [
                        {
                  ...
                  eventDatashowCustomModal170.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal170,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey58: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey58.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey58,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse477.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse477, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading174: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest733: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode564: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode564.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatasetLoading175: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading175.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading175, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDataapiRequest734: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest734.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest734, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected58: any = [
                    {
                  ...
                  eventDatagetTableSelected58.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected58,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatasetLoading176: any = [
                    {
                      type: 'setLoading',
                  ...
                  eventDatasetLoading176.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDatasetLoading176, { e }, 'setLoading', {
                    id: 'setLoading',
                    name: 'setLoading',
                    type: 'setLoading',
                    platform: 'pc',
                  });
                  const eventDatacustomActionCode565: any = [
                    {
                      type: 'customActionCode',
                      ...
                      options: {
                        ...
                        id: '7076346',
                        pageJsonId: '537892',
                        code: 'function main(data,state,success,fail){var arr1=[];var arr2=[];var infoList=data.infoList;for(var i=0;i<infoList.length;i++){var info=infoList[i];{arr2.push({"name":"\\u96C6\\u56E2\\u7F16\\u7801","value":info.groupId});arr2.push({"name":"\\u96C6\\u56E2\\u540D\\u79F0","value":info.groupName});arr2.push({"name":"\\u4EE3\\u7406\\u5546\\u540D\\u79F0","value":info.agencyName});arr2.push({"name":"\\u57FA\\u672C\\u63A5\\u5165\\u53F7","value":info.basicAccessNumber});arr2.push({"name":"\\u4E1A\\u52A1\\u63A5\\u5165\\u53F7","value":info.busiAccessNumber})}arr1.push(arr2);arr2=[]}if(arr1.length>0){success(JSON.stringify(arr1))}else{fail()}};',
                      },
                      line_number: 9,
                      callback1: [
                        {
                  ...
                  eventDatacustomActionCode565.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode565,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData269: any = [
                      {
                    ...
                    eventDatagetSelectedData269.params =
                      [
                    ...
                    const eventDatagetSelectedData270: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData270.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode567: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode567.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode568: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode568.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId52: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId52.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0018_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
