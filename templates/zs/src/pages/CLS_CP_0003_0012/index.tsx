...
const pageId = '1043815950014328832';
const ClsCp_0003_0012$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode125: any = [
      {
    ...
    eventDatacustomActionCode125.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest357: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest357.params = [] || [];
    CMDGenerator(eventDataapiRequest357, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest358: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest358.params = [] || [];
    CMDGenerator(eventDataapiRequest358, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest359: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest359.params = [] || [];
    CMDGenerator(eventDataapiRequest359, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse193: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse193.params = [] || [];
    CMDGenerator(eventDataifelse193, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource154: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource154.params =
                [
                  {
                    title: '表单当前改变字段编码',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData309: any = [
                      {
                    ...
                    eventDatagetSelectedData309.params =
                      [
                    ...
                    const eventDatagetSelectedData310: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData310.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode612: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode612.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode613: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode613.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId59: any = [
                {
              ...
              eventDatadownloadByFileId59.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0012$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
