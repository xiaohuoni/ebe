...
const pageId = '967975614291091456';
  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => refs.setComponentRef(r, 'View_841291_1')}
        {...injectData}
      >
        <View
          className="View_View_0968674"
          name={'布局容器'}
          ...
          ref={(r: any) => refs.setComponentRef(r, 'View_0968674')}
          {...injectData}
        >
          <Divider
            name={'分割线'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Divider_282876')}
            {...injectData}
          />
          <View
            className="View_View_602102"
            name={'布局容器'}
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'View_602102',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_602102')}
            {...injectData}
          >
            <HorizontalView
              name={'左右布局'}
              ...
              ref={(r: any) =>
                refs.setComponentRef(r, 'HorizontalView_2533504')
              }
              {...injectData}
            >
              <View
                className="View_View_5909674"
                name={'布局容器'}
                $$componentItem={{
                  id: 'View_5909674',
                  uid: 'View_5909674',
                ...
                ref={(r: any) => refs.setComponentRef(r, 'View_5909674')}
                {...injectData}
              >
                <Form
                  name={'表单'}
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'Form_542065')}
                  {...injectData}
                >
                  <Checkbox
                    name={'审批场景'}
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'Checkbox_514197')}
                    {...injectData}
                  />
                  <View
                    className="View_View_9696068"
                    name={'布局容器'}
                    labelCol={8}
                    wrapperCol={16}
                    backgroundType={{ type: 'cleanColor', color: undefined }}
                    ...
                    ref={(r: any) => refs.setComponentRef(r, 'View_9696068')}
                    {...injectData}
                  />
                  <Input
                    name={'场景最高审批等级'}
                    ...
                    readOnly={false}
                    isFormRootChild={true}
                    ref={(r: any) => refs.setComponentRef(r, 'Input_4043608')}
                    {...injectData}
                  />
                </Form>
              </View>
          ...
          <Form
            ...
            readOnly={false}
            style={{ padding: '0px 0px 0px 0px' }}
            ref={(r: any) => refs.setComponentRef(r, 'Form_777641')}
            {...injectData}
          >
            <Input
              name={'CT集团编码'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_743019')}
              {...injectData}
            />
            <Input
              name={'订单流水'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_155171')}
              {...injectData}
            />
            <Input
              name={'生效时间'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_049222')}
              {...injectData}
            />
            <Input
              name={'失效时间'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_40360073')}
              {...injectData}
            />
          </Form>
        </View>
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_625733')}
          {...injectData}
        />
      </View>
    </div>
