...
const pageId = '1061968337100169216';
      ...
      >
        ...
        >
          <BusiComp963983
            ...
            ref={(r: any) => refs.setComponentRef(r, 'BOFramer_931709')}
            {...injectData}
          />
        </View>
        <View
          className="View_View_699118"
          name={'布局容器'}
          backgroundType={{ type: 'cleanColor', color: undefined }}
          $$componentItem={{
            id: 'View_699118',
          ...
          ref={(r: any) => refs.setComponentRef(r, 'View_699118')}
          {...injectData}
        >
          <View
            className="View_View_609801"
            name={'布局容器'}
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'View_609801',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_609801')}
            {...injectData}
          >
            <View
              className="View_View_572656"
              name={'布局容器'}
              backgroundType={{ type: 'cleanColor', color: '#1890ff' }}
              $$componentItem={{
                id: 'View_572656',
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_572656')}
              {...injectData}
            />
            <Text
              name={'账户信息'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_198779')}
              {...injectData}
            />
          </View>
          <View
            className="View_View_802629"
            name={'布局容器'}
            backgroundType={{ type: 'cleanColor', color: undefined }}
            $$componentItem={{
              id: 'View_802629',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_802629')}
            {...injectData}
          >
            <Text
              name={'账户信息风险提示'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_946219')}
              {...injectData}
            />
          </View>
        </View>
        <Table
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Table_651663')}
          {...injectData}
        />
      </View>
    </div>
