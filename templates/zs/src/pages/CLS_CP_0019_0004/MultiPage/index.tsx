  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_360551_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        <Table
          ...
          ref={(r: any) => (refs['Table_5017878'] = r)}
          {...injectData}
        />
      </View>
    </div>
