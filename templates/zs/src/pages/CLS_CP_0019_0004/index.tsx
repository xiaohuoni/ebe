...
const ClsCp_0019_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_263015: any) => {
    const eventDatacustomActionCode59: any = [
      {
    ...
    eventDatacustomActionCode59.params =
      [
        {
          title: '事件入参',
          name: 'options_263015',
  ...
  const updateTitle = (options_9020026: any) => {
    const eventDatacustomActionCode60: any = [
      {
        type: 'customActionCode',
    ...
    eventDatacustomActionCode60.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest195: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest195.params = [] || [];
    CMDGenerator(eventDataapiRequest195, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse115: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse115.params = [] || [];
    CMDGenerator(eventDataifelse115, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          >
            <TextArea
              ...
              required={true}
              formItemIndex={0}
              fieldName={'arrearageBlacklistDeclare'}
              value={data?.factorForm?.arrearageBlacklistDeclare}
              $$componentItem={{
                id: 'TextArea_2434036',
...
export default withPageHOC(ClsCp_0019_0004$$Page, {
  pageId: '1064022354525511680',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
