...
styleInject(
  '.__CustomClass_537892__ .Form_449441_1900385_965292_804694_0429677_280477_612369_3241812 .custom_textarea .pcfactory-row .pcfactory-col:nth-child(8) .pcfactory-legacy-form-item-required span span{max-width:73px;white-space:pre-wrap;max-height:38px;display:flex;flex-direction:row;justify-content:flex-start;}',

  '537892',
);

const ClsCp_0003_0003$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode94: any = [
      {
    ...
    eventDatacustomActionCode94.params =
      [
        {
          title: '事件入参',
  ...
  const initSelection = (options_642306: any) => {
    const eventDataapiRequest49: any = [
      {
        type: 'apiRequest',
    ...
    CMDGenerator(eventDataapiRequest49, { options_642306 }, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest50: any = [
      {
        type: 'apiRequest',
    ...
    CMDGenerator(eventDataapiRequest50, { options_642306 }, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest51: any = [
      {
        type: 'apiRequest',
    ...
    CMDGenerator(eventDataapiRequest51, { options_642306 }, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest52: any = [
      {
        type: 'apiRequest',
        ...
        callback1: [
          {
            type: 'reloadSelectData',
            dataId: 170246354468860600,
            options: {
              compId: 'Select_412302',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '132245',
    ...
    CMDGenerator(eventDataapiRequest52, { options_642306 }, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
  ...
  useEffect(() => {
    const eventDatacallSelfFunc32: any = [
      {
        type: 'callSelfFunc',
    ...
    eventDatacallSelfFunc32.params = [] || [];
    CMDGenerator(eventDatacallSelfFunc32, {}, 'callSelfFunc', {
      id: 'callSelfFunc',
      name: 'callSelfFunc',
      type: 'callSelfFunc',
      platform: 'undefined',
    });
    const eventDataapiRequest272: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest272.params = [] || [];
    CMDGenerator(eventDataapiRequest272, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse151: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            options: {
              ...
              id: '9981685',
              pageJsonId: '537892',
              code: 'function main(data,state,success,fail){var item=state.itemList;var factorForm={};var attrList=item.attrList;if(attrList!=undefined&&attrList.length>0){for(var i=0;i<attrList.length;i++){var attrCode=attrList[i].attrCode;var attrValue=attrList[i].attrValue;factorForm[attrCode]=attrValue}}data.factorForm=factorForm;data.sceneSubmit.approveGrade=item.approveGrade;data.sceneSubmit.approveGradeName=item.approveGradeName;data.sceneSubmit.attrList=item.attrList;success(factorForm)};',
    ...
    eventDataifelse151.params = [] || [];
    CMDGenerator(eventDataifelse151, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource128: any = [
                {
                  type: 'setDataSource',
                  ...
                  options: {
                    ...
                    dataSourceSetValue: [
                      ...
                      {
                        attrId: '085149',
                        code: 'busiComplaintRate',
                        name: '业务整体投诉率',
                        type: 'string',
                        initialData: { type: 'static' },
                        showInput: true,
                        _codePath: ['busiComplaintRate'],
                        _idpath: ['085149'],
                        value: {
                          type: [
                            'form',
                  ...
                  callback1: [
                    {
                      ...
                      options: {
                        ...
                        pageJsonId: '537892',
                        actionTitle: '',
                        code: 'function main(data,state,success,fail){var attrList=[];var obj=data.factorForm;for(var key in obj){var attrValue=obj[key];attrList.push({"attrCode":key,"attrName":"","attrValue":attrValue})}data.sceneSubmit.attrList=attrList;console.log("data.sceneSubmit.attrList",data.sceneSubmit.attrList);success(attrList)};',
                      },
                      line_number: 2,
                      callback1: [
                        {
              ...
              eventDatasetDataSource128.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            <Select
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Select_417532'] = r)}
              {...injectData}
            />
            <Input
              name={'业务接入号'}
            ...
            <Input
              ...
              allowClear={false}
              value={data?.factorForm?.agencyName}
              icon={{
                type: undefined,
                theme: 'outlined',
                fontAddress: '',
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_0791389'] = r)}
              {...injectData}
            />
            <Select
              name={'业务规模'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Select_412302'] = r)}
              {...injectData}
            />
            <Input
              name={'业务整体投诉率'}
              ...
              placeholder={'请输入'}
              formItemIndex={7}
              fieldName={'busiComplaintRate'}
              value={data?.factorForm?.busiComplaintRate}
              regexp={[
                {
                  id: '454585',
                  title: '按钮1',
            ...
            <TextArea
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['TextArea_54467'] = r)}
              {...injectData}
            />
            <TextArea
              name={'集团简介'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['TextArea_018024'] = r)}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData210: any = [
                      {
                    ...
                    eventDatagetSelectedData210.params =
                      [
                    ...
                    const eventDatagetSelectedData211: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData211.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode517: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode517.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode518: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode518.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId41: any = [
                {
              ...
              eventDatadownloadByFileId41.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0003$$Page, {
  pageId: '1052167056079908864',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
