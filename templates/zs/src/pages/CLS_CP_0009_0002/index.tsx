...
const pageId = '885063062410186752';
const ClsCp_0009_0002$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_96940006: any) => {
    const eventDatacustomActionCode210: any = [
      {
        type: 'customActionCode',
        dataId: 167238970434853200,
        options: {
          compId: 'customActionCode',
          compName: 'page',
          id: '624408',
          pageJsonId: '537892',
          code: 'function main(data,state,success,fail){data.sceneSubmit.fileInfo=options_96940006;success()};',
        },
        line_number: 1,
        callback1: [
          {
            type: 'callParentCustomFunc',
            dataId: 167238971251334080,
            options: {
    ...
    eventDatacustomActionCode210.params =
      [
        {
          title: '事件入参',
          name: 'options_96940006',
          value: '$options_96940006$',
        },
      ] || [];
    CMDGenerator(
      eventDatacustomActionCode210,
      { options_96940006 },
      'customActionCode',
      {
        id: 'customActionCode',
  ...
  useEffect(() => {
    const eventDataapiRequest579: any = [
      {
        type: 'apiRequest',
        dataId: 166972735680674620,
        options: {
          compId: 'apiRequest',
          compName: 'system',
          id: '056895',
        ...
        callback1: [
          {
            ...
            dataId: 166972736010634180,
            options: {
              compId: 'Input_690228_5400337_144149',
              compLib: 'comm',
              pageJsonId: '537892',
              compName: 'Select',
              id: '919537',
              data: '$reply_056895?.resultData$',
    ...
    eventDataapiRequest579.params = [] || [];
    CMDGenerator(eventDataapiRequest579, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest580: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest580.params = [] || [];
    CMDGenerator(eventDataapiRequest580, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse290: any = [
      {
        type: 'ifelse',
        condition: [
          {
        ...
        callback1: [
          {
            ...
            callback1: [
              ...
              {
                type: 'setValue',
                dataId: 166262214090415360,
                options: {
                  compId: 'Input_361479_887285_2150708_6077137',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '6221495',
          ...
          },
          {
            ...
            callback1: [
              ...
              },
              {
                ...
                dataId: 166746137451882850,
                elseIfs: [],
                line_number: 12,
                callback1: [
                  {
                    type: 'setVisible',
                    dataId: 166746138566091600,
                    options: {
          ...
          },
          {
            ...
            callback1: [
              ...
              {
                type: 'setDisable',
                dataId: 166262247228072100,
                options: {
                  compId: 'Form_449441_3083418',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Form',
                  id: '2181813',
    ...
    eventDataifelse290.params = [] || [];
    CMDGenerator(eventDataifelse290, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Divider_675796')}
          {...injectData}
        />
        <View
          name={'布局容器'}
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                $$componentItem={{
                  id: 'Form_4311097_9385662_090751',
                  uid: 'Form_4311097_9385662_090751',
                  type: 'Form',
                  ...componentItem,
                }}
                style={{ padding: '0px 0px 0px 0px' }}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Form_4311097_9385662_090751')
                }
                {...injectData}
              >
                <Checkbox
                  ...
                  $$componentItem={{
                    id: 'Checkbox_882584_5289015_934499_965885',
                    uid: 'Checkbox_882584_5289015_934499_965885',
                    type: 'Checkbox',
                    ...componentItem,
                  }}
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Checkbox_882584_5289015_934499_965885',
                    )
                  }
                  {...injectData}
                />
                <View
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_552058')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
                  ...
                  $$componentItem={{
                    id: 'Input_361479_887285_2150708_6077137',
                    uid: 'Input_361479_887285_2150708_6077137',
                    type: 'Input',
                    ...componentItem,
                  }}
                  isFormRootChild={true}
                  ref={(r: any) =>
                    refs.setComponentRef(
                      r,
                      'Input_361479_887285_2150708_6077137',
                    )
                  }
                  {...injectData}
                />
          ...
          <Form
            ...
            $$componentItem={{
              id: 'Form_449441_3083418',
              uid: 'Form_449441_3083418',
              type: 'Form',
              ...componentItem,
            }}
            style={{ padding: '0px 0px 0px 0px', margin: '0px 150px 0px 0px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource269: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource269.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_449441_3083418')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              required={true}
              placeholder={'请输入'}
              fieldName={'closeDownExp'}
              value={data?.factorForm?.closeDownExp}
              formItemIndex={0}
              disabled={false}
              tipIcon={{
                theme: 'outlined',
              ...
              tipContent={
                '目前已合作XX业务等，因xx原因需申请关停产品及对应营销案。'
              }
              $$componentItem={{
                id: 'Input_closeDownExp_015954_722406',
                uid: 'Input_closeDownExp_015954_722406',
                type: 'TextArea',
                ...componentItem,
              }}
              isFormRootChild={true}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Input_closeDownExp_015954_722406')
              }
              {...injectData}
            />
          </Form>
          <Row
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Row_851124_076282')}
            {...injectData}
          >
            <Form
              name={'表单'}
              ...
              $$componentItem={{
                id: 'Form_395851_1727917_68438',
                uid: 'Form_395851_1727917_68438',
                type: 'Form',
                ...componentItem,
              }}
              style={{ padding: '0px 0px 0px 0px', margin: '10px 0px 0px 0px' }}
              ref={(r: any) =>
                refs.setComponentRef(r, 'Form_395851_1727917_68438')
              }
              {...injectData}
            >
              <Select
                ...
                formItemIndex={0}
                $$componentItem={{
                  id: 'Input_690228_5400337_144149',
                  uid: 'Input_690228_5400337_144149',
                  type: 'Select',
                  ...componentItem,
                }}
                disabled={false}
                ...
                isFormRootChild={true}
                ref={(r: any) =>
                  refs.setComponentRef(r, 'Input_690228_5400337_144149')
                }
                {...injectData}
              />
              <View
                ...
                backgroundType={{ type: 'cleanColor', color: undefined }}
                $$componentItem={{
                  id: 'View_22346374_875512_444606',
                  uid: 'View_22346374_875512_444606',
                  type: 'View',
                  ...componentItem,
                }}
                isFormRootChild={true}
                ...
                ref={(r: any) =>
                  refs.setComponentRef(r, 'View_22346374_875512_444606')
                }
                {...injectData}
              >
                <StdUpload
                  ...
                  $$componentItem={{
                    id: 'StdUpload_6230546_867413_8038837',
                    uid: 'StdUpload_6230546_867413_8038837',
                    type: 'StdUpload',
                    ...componentItem,
                  }}
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData439: any = [
                      {
                        type: 'getSelectedData',
                        dataId: 166262259552008670,
                        options: {
                          compId: 'Input_690228_5400337_144149',
                          compLib: 'comm',
                          pageJsonId: '537892',
                            ...
                            options: {
                              ...
                              dataSourceSetValue: [
                                ...
                                },
                                {
                                  ...
                                  value: {
                                    type: ['customize'],
                                    code: '$selectedData_726443[0].value$',
                                  },
                                },
                                {
                                  code: 'fileUrl',
                    ...
                    eventDatagetSelectedData439.params =
                      [
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode814: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode814.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  ref={(r: any) =>
                    refs.setComponentRef(r, 'StdUpload_6230546_867413_8038837')
                  }
                  {...injectData}
                />
              </View>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode815: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode815.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId111: any = [
                {
              ...
              eventDatadownloadByFileId111.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => refs.setComponentRef(r, 'BOFramer_1972')}
          {...injectData}
        />
      </View>
    </div>
...
export default withPageHOC(ClsCp_0009_0002$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
