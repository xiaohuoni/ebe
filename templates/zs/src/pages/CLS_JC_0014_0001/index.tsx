...
const pageId = '1061459573179768832';
const ClsJc_0014_0001$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode74: any = [
      {
    ...
    eventDatacustomActionCode74.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest224: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest224.params = [] || [];
    CMDGenerator(eventDataapiRequest224, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest225: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest225.params = [] || [];
    CMDGenerator(eventDataapiRequest225, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse128: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse128.params = [] || [];
    CMDGenerator(eventDataifelse128, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    });
    const eventDatasetTimer: any = [
      {
        type: 'setTimer',
        dataId: 170476503325257250,
        options: {
          compId: 'setTimer',
          compName: 'system',
          id: '112845',
        ...
        callback1: [
          {
            type: 'customActionCode',
            dataId: 170476504624435940,
            options: {
              compId: 'customActionCode',
              compName: 'page',
              id: '931065',
              pageJsonId: '537892',
              code: 'function main(data,state,success,fail){var feeInfo=data.feeInfo;var totalRevenue=feeInfo.reduce(function(acc,fee){return acc+parseFloat(fee.totalFee)},0);data.factorForm.totalRevenue=totalRevenue;success(totalRevenue)};',
            },
            line_number: 20,
            callback1: [
              {
                type: 'setValue',
                dataId: 170476590688527300,
                options: {
                  compId: 'Input_7242206_974846_973427',
                  compLib: 'comm',
                  pageJsonId: '537892',
                  compName: 'Input',
                  id: '272781',
                  valueList: { Input_7242206_974846_973427: '$data_931065$' },
                },
                line_number: 21,
                callback1: [],
              },
    ...
    eventDatasetTimer.params = [] || [];
    CMDGenerator(eventDatasetTimer, {}, 'setTimer', {
      id: 'setTimer',
      name: 'setTimer',
      type: 'setTimer',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource103: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource103.params =
                [
                  {
                    title: '表单当前改变字段编码',
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Form_4263693')}
            {...injectData}
          >
            <TextArea
              name={'申请原因'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'TextArea_59369')}
              {...injectData}
            />
          </Form>
          <Form
            ...
            visible={true}
            readOnly={false}
            style={{ padding: '0px 0px 0px 0px', margin: '8px 8px 8px 8px' }}
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource104: any = [
                {
                  type: 'setDataSource',
                  dataId: 167051118069269700,
                  options: {
              ...
              eventDatasetDataSource104.params =
                [
                  {
                    title: '表单当前改变字段编码',
                    name: 'changedFieldName',
          ...
          >
            <View
              ...
              ref={(r: any) => refs.setComponentRef(r, 'View_3692196')}
              {...injectData}
            />
            <Input
              name={'视频AI业务收入合计'}
              ...
              value={data?.factorForm?.totalRevenue}
              formItemIndex={1}
              icon={{
                type: undefined,
                theme: 'outlined',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal95: any = [
                    {
                      ...
                      options: {
                        ...
                        id: '611628',
                        pageJsonId: '537892',
                        modalname: '/networkAcrossProvincecopy2copycopy',
                        ...
                        modalPath: '/networkAcrossProvincecopy2copycopy',
                      },
                      line_number: 1,
                      callback1: [
                        {
                  ...
                  eventDatashowCustomModal95.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal95,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey44: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey44.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey44,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse425.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse425, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading154: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest712: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode474: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode474.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDataapiRequest713: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest713.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest713, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected39: any = [
                    {
                  ...
                  eventDatagetTableSelected39.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected39,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatacustomActionCode475: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode475.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode475,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal96: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal96.params =
                [
          ...
          <Table
            ...
            style={{ margin: '10px 0px 10px 0px' }}
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal97: any = [
                {
                  type: 'showCustomModal',
                  dataId: 166539679318667200,
                  options: {
              ...
              eventDatashowCustomModal97.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onRowDetail={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal98: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal98.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData176: any = [
                      {
                    ...
                    eventDatagetSelectedData176.params =
                      [
                    ...
                    const eventDatagetSelectedData177: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData177.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode477: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode477.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode478: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode478.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId32: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId32.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsJc_0014_0001$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
