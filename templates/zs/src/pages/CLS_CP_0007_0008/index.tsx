...
const pageId = '896998320957526016';
const ClsCp_0007_0008$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode137: any = [
      {
    ...
    eventDatacustomActionCode137.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest409: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest409.params = [] || [];
    CMDGenerator(eventDataapiRequest409, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest410: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest410.params = [] || [];
    CMDGenerator(eventDataapiRequest410, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse216: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse216.params = [] || [];
    CMDGenerator(eventDataifelse216, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource177: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource177.params =
                [
                  {
                    title: '表单当前改变字段编码',
          ...
          >
            ...
            >
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatashowCustomModal199: any = [
                    {
                  ...
                  eventDatashowCustomModal199.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatashowCustomModal199,
                    { e },
                    'showCustomModal',
                    {
                      id: 'showCustomModal',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDatagetTableSelectedKey68: any = [
                    {
                  ...
                  eventDatagetTableSelectedKey68.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelectedKey68,
                    { e },
                    'getTableSelectedKey',
                    {
              ...
              <Button
                ...
                onClick={(e: any) => {
                  ...
                  eventDataifelse488.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataifelse488, { e }, 'ifelse', {
                    id: 'ifelse',
                    name: 'ifelse',
                    type: 'ifelse',
                    platform: 'pc',
              ...
              <StdUpload
                ...
                onFinishUpload={(
                  ...
                  const eventDatasetLoading200: any = [
                    {
                      type: 'setLoading',
                  ...
                  const eventDataapiRequest757: any = [
                    {
                      type: 'apiRequest',
                ...
                onListenUploading={(
                  ...
                  const eventDatacustomActionCode654: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode654.params =
                    [
                      {
                        title: '文件对象',
                        name: 'file',
              ...
              <Button
                ...
                onClick={(e: any) => {
                  const eventDataapiRequest758: any = [
                    {
                      type: 'apiRequest',
                  ...
                  eventDataapiRequest758.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(eventDataapiRequest758, { e }, 'apiRequest', {
                    id: 'apiRequest',
                    name: 'apiRequest',
                    type: 'apiRequest',
                    platform: 'pc',
              ...
              <Button
                ...
                style={{ width: 'fit-content', margin: '0px 0px 0px 8px' }}
                onClick={(e: any) => {
                  const eventDatagetTableSelected67: any = [
                    {
                  ...
                  eventDatagetTableSelected67.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatagetTableSelected67,
                    { e },
                    'getTableSelected',
                    {
                      id: 'getTableSelected',
                  ...
                  const eventDatacustomActionCode655: any = [
                    {
                      type: 'customActionCode',
                  ...
                  eventDatacustomActionCode655.params =
                    [{ title: '事件对象', value: '$e$', name: 'e' }] || [];
                  CMDGenerator(
                    eventDatacustomActionCode655,
                    { e },
                    'customActionCode',
                    {
                      id: 'customActionCode',
          ...
          <Table
            ...
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal200: any = [
                {
                  type: 'showCustomModal',
              ...
              eventDatashowCustomModal200.params =
                [
          ...
          <Table
            ...
            style={{ margin: '10px 0px 10px 0px' }}
            onRowEdit={(rowId: any, row: any, index: any) => {
              const eventDatashowCustomModal201: any = [
                {
                  type: 'showCustomModal',
                  dataId: 166539679318667200,
                  options: {
              ...
              eventDatashowCustomModal201.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData354: any = [
                      {
                    ...
                    eventDatagetSelectedData354.params =
                      [
                    ...
                    const eventDatagetSelectedData355: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData355.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode657: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode657.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode658: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode658.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId69: any = [
                {
                  type: 'downloadByFileId',
              ...
              eventDatadownloadByFileId69.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0007_0008$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
