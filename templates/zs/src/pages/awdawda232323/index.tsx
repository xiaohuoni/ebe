...
const pageId = '1066685234520510464';
const Awdawda232323$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDataapiRequest123: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest123.params = [] || [];
    CMDGenerator(eventDataapiRequest123, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse83: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse83.params = [] || [];
    CMDGenerator(eventDataifelse83, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        ...
        <Form
          ...
          style={{ padding: '0px 0px 0px 0px' }}
          onValuesChange={() => {
            const eventDatasetDataSource48: any = [
              {
                type: 'setDataSource',
            ...
            eventDatasetDataSource48.params = [] || [];
            CMDGenerator(eventDatasetDataSource48, {}, 'setDataSource', {
              id: 'setDataSource',
              name: 'setDataSource',
              type: 'setDataSource',
              platform: 'pc',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode382: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode382.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId15: any = [
                {
              ...
              eventDatadownloadByFileId15.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn2={(rowId: any, row: any, index: any) => {
              const eventDatapreviewFile9: any = [
                {
                  type: 'previewFile',
...
export default withPageHOC(Awdawda232323$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
