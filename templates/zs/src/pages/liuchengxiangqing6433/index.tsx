  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_689515_1'] = r)}
        {...injectData}
      >
        <View
          name={'布局容器'}
        ...
        >
          ...
          >
            ...
            <MultipleSelect
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['MultipleSelect_0354337'] = r)}
              {...injectData}
            />
            <Select
              name={'状态'}
            ...
            <Input
              ...
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_9293691'] = r)}
              {...injectData}
            />
            <TextArea
              name={'备注'}
              ...
              isFormRootChild={true}
              ref={(r: any) => (refs['TextArea_348804'] = r)}
              {...injectData}
            />
            <Input
              name={'流程ID'}
