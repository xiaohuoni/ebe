...
const pageId = '892383116470751232';
const ClsJc_0008_0002$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  useEffect(() => {
    const eventDataapiRequest102: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest102.params = [] || [];
    CMDGenerator(eventDataapiRequest102, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse72: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse72.params = [] || [];
    CMDGenerator(eventDataifelse72, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
              ...
              <Form
                ...
                ref={(r: any) =>
                  refs.setComponentRef(
                    r,
                    'Form_4311097_9385662_1929847_738917_68642',
                  )
                }
                {...injectData}
              >
                ...
                <View
                  ...
                  ref={(r: any) => refs.setComponentRef(r, 'View_949332')}
                  {...injectData}
                />
                <Input
                  name={'场景最高审批等级'}
        ...
        <Form
          ...
          style={{ padding: '0px 0px 0px 0px' }}
          onValuesChange={() => {
            const eventDatasetDataSource39: any = [
              {
                type: 'setDataSource',
            ...
            eventDatasetDataSource39.params = [] || [];
            CMDGenerator(eventDatasetDataSource39, {}, 'setDataSource', {
              id: 'setDataSource',
              name: 'setDataSource',
              type: 'setDataSource',
              platform: 'pc',
        ...
        >
          <Input
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => refs.setComponentRef(r, 'Input_flowType_5008433')}
            {...injectData}
          />
          <Input
            name={'已审批工单号'}
            ...
            isFormRootChild={true}
            ref={(r: any) =>
              refs.setComponentRef(r, 'Input_workOrderNbr_146745')
            }
            {...injectData}
          />
          <Input
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => refs.setComponentRef(r, 'Input_380435')}
            {...injectData}
          />
          <TextArea
            name={'审批内容'}
            ...
            isFormRootChild={true}
            ref={(r: any) =>
              refs.setComponentRef(r, 'Input_approvaItemDesc_0698245')
            }
            {...injectData}
          />
        </Form>
        <Row
          ...
          ref={(r: any) => refs.setComponentRef(r, 'Row_26691126')}
          {...injectData}
        >
          <Text
            name={'文本'}
            ...
            ref={(r: any) => refs.setComponentRef(r, 'Text_9164415')}
            {...injectData}
          />
        </Row>
        <GridView
        ...
        >
          ...
          <View
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_919028')}
            {...injectData}
          >
            <Condition
              name={'条件容器'}
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_671699')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_227786')}
                {...injectData}
              />
              <Table
                name={'购买充值卡'}
            ...
            <Condition
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_236354')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_333768')}
                {...injectData}
              />
              <Table
                name={'营销活动'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_902235')}
                {...injectData}
              />
            </Condition>
            <Condition
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_8688958')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_727703')}
                {...injectData}
              />
              <Table
                name={'集团缴费'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_4909574')}
                {...injectData}
              />
            </Condition>
            <Condition
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_985687')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_702503')}
                {...injectData}
              />
              <Table
                name={'物联网缴费'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_900354')}
                {...injectData}
              />
            </Condition>
            <Condition
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_526522')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_6317116')}
                {...injectData}
              />
              <Table
                name={'保证金'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_290076')}
                {...injectData}
              />
            </Condition>
            <Condition
              ...
              style={{ minHeight: 40 }}
              ref={(r: any) => refs.setComponentRef(r, 'Condition_312308')}
              {...injectData}
            >
              <Divider
                name={'分割线'}
                ...
                readOnly={false}
                style={{ margin: '12px 0 12px 0', height: 'auto' }}
                ref={(r: any) => refs.setComponentRef(r, 'Divider_87821')}
                {...injectData}
              />
              <Table
                name={'代客充值'}
                ...
                visible={true}
                readOnly={false}
                ref={(r: any) => refs.setComponentRef(r, 'Table_943125')}
                {...injectData}
              />
            </Condition>
          </View>
        ...
        >
          ...
          <View
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_1032745')}
            {...injectData}
          >
            <Text
              name={'文本'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_669756')}
              {...injectData}
            />
            <Text
              name={'受理方式'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_2328527')}
              {...injectData}
            />
          </View>
        </Row>
        ...
        >
          ...
          <View
            ...
            ref={(r: any) => refs.setComponentRef(r, 'View_009264')}
            {...injectData}
          >
            <Text
              name={'文本'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_349893')}
              {...injectData}
            />
            <Text
              name={'资金变动提醒人员是否变更'}
              ...
              ref={(r: any) => refs.setComponentRef(r, 'Text_605866')}
              {...injectData}
            />
          </View>
        </Row>
        ...
        <Table
          ...
          visible={false}
          readOnly={false}
          ref={(r: any) => refs.setComponentRef(r, 'Table_23071')}
          {...injectData}
        />
        <GridView
          name={'银行到账信息(bankAccountList)'}
          ...
          style={{ minHeight: 40 }}
          ref={(r: any) => refs.setComponentRef(r, 'GridView_9617166')}
          {...injectData}
          getEngineApis={() => {
            return {
              ...injectData.getEngineApis(),
                  ...
                  return (
                    <>
                      <Description
                        ...
                        readOnly={false}
                        ref={(r: any) =>
                          refs.setComponentRef(r, 'Description_566961')
                        }
                        {...injectData}
                      />
                    </>
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode336: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode336.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId11: any = [
                {
              ...
              eventDatadownloadByFileId11.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
            ...
            onClickBtn2={(rowId: any, row: any, index: any) => {
              const eventDatapreviewFile5: any = [
                {
                  type: 'previewFile',
...
export default withPageHOC(ClsJc_0008_0002$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
