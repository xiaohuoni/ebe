  ...
  return (
    ...
    >
      <View
        ...
        ref={(r: any) => (refs['View_537892_1_573149'] = r)}
        {...injectData}
      >
        <Divider
          name={'分割线'}
          ...
          ref={(r: any) => (refs['Divider_52558_7410426'] = r)}
          {...injectData}
        />
        <View
          name={'布局容器'}
          ...
          ref={(r: any) => (refs['View_6806553_3483268'] = r)}
          {...injectData}
        >
          <HorizontalView
            name={'左右布局'}
            ...
            ref={(r: any) => (refs['HorizontalView_004602_830821'] = r)}
            {...injectData}
          >
            <View
              name={'布局容器'}
              ...
              ref={(r: any) => (refs['View_339406_177732'] = r)}
              {...injectData}
            >
              <Form
                name={'表单'}
              ...
              >
                ...
                <View
                  ...
                  ref={(r: any) =>
                    (refs['View_6319234_3569864_15467365_781748_88437'] = r)
                  }
                  {...injectData}
                />
                <Input
          ...
          <Card
            ...
            ref={(r: any) => (refs['Card_79842901'] = r)}
            {...injectData}
          >
            <Form
              name={'省内商品信息表单'}
            ...
            >
              ...
              <Input
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_9325585'] = r)}
                {...injectData}
              />
              <Input
                name={'省内商品大类名称'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_82528218'] = r)}
                {...injectData}
              />
              <Input
                name={'省内商品小类'}
              ...
              <Input
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_2971792'] = r)}
                {...injectData}
              />
              <Input
                name={'省内商品描述'}
          ...
          >
            ...
            >
              <Select
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Select_388225'] = r)}
                {...injectData}
              />
              <Input
                name={'商品规格编码'}
              ...
              <Select
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Select_122215'] = r)}
                {...injectData}
              />
              <Select
                name={'商品类型'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Select_081304'] = r)}
                {...injectData}
              />
              <Select
                name={'可支持的操作类型'}
              ...
              <DatePicker
                ...
                defaultValue={{}}
                isFormRootChild={true}
                ref={(r: any) => (refs['DatePicker_4913772'] = r)}
                {...injectData}
              />
              <DatePicker
                name={'失效时间'}
                ...
                defaultValue={{}}
                isFormRootChild={true}
                ref={(r: any) => (refs['DatePicker_713708'] = r)}
                {...injectData}
              />
              <Input
                name={'支持自动上架'}
              ...
              <DatePicker
                ...
                defaultValue={{}}
                isFormRootChild={true}
                ref={(r: any) => (refs['DatePicker_706247'] = r)}
                {...injectData}
              />
              <Input
                name={'一经通信和信息化产品编码'}
              ...
              <TextArea
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['TextArea_911085'] = r)}
                {...injectData}
              />
              <Input
                name={'商品开放省'}
        ...
        >
          <Table
            ...
            ref={(r: any) => (refs['Table_3108885'] = r)}
            {...injectData}
          />
        </Card>
        <Card
