...
const pageId = '912665099090276352';
      ...
      >
        ...
        >
          ...
          <Input
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => refs.setComponentRef(r, 'Input_3965095')}
            {...injectData}
          />
          <Input
            name={'调账总金额'}
            ...
            readOnly={false}
            isFormRootChild={true}
            ref={(r: any) => refs.setComponentRef(r, 'Input_283936')}
            {...injectData}
          />
        </Form>
        <Table
        ...
        <Table
          ...
          visible={true}
          readOnly={false}
          ref={(r: any) => refs.setComponentRef(r, 'Table_4668064')}
          {...injectData}
        />
        <View
