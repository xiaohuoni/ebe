    ...
    >
      ...
      >
        <Divider
          ...
          ref={(r: any) => (refs['Divider_006706'] = r)}
          {...injectData}
        />
        <View
          name={'布局容器'}
        ...
        >
          ...
          >
            ...
            >
              <Form
                ...
                ref={(r: any) => (refs['Form_4311097_5142916'] = r)}
                {...injectData}
              >
                <Checkbox
                  name={'审批场景'}
                  ...
                  ref={(r: any) =>
                    (refs['Checkbox_882584_5289015_6659047'] = r)
                  }
                  {...injectData}
                />
                <View
                ...
                <Input
                  ...
                  readOnly={false}
                  isFormRootChild={true}
                  ref={(r: any) => (refs['Input_361479_887285_3596799'] = r)}
                  {...injectData}
                />
              </Form>
            </View>
          ...
          >
            <Input
              ...
              ref={(r: any) => (refs['Input_agentName_4780553_7528804'] = r)}
              {...injectData}
            />
            <Input
              name={'减免金额'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_derateMoney_636038'] = r)}
              {...injectData}
            />
            <TextArea
              name={'申请原因'}
          ...
          >
            <Form
              ...
              ref={(r: any) => (refs['Form_395851_238338'] = r)}
              {...injectData}
            >
              <Select
                name={'附件'}
                ...
                readOnly={false}
                isFormRootChild={true}
                ref={(r: any) => (refs['Input_690228_437986'] = r)}
                {...injectData}
              />
              <View
                name={'布局容器'}
                ...
                ref={(r: any) => (refs['View_22346374_40472'] = r)}
                {...injectData}
              >
                <StdUpload
                  name={'附件上传'}
                  ...
                  ref={(r: any) => (refs['StdUpload_6230546_48197'] = r)}
                  {...injectData}
                />
              </View>
            </Form>
        ...
        <BusiComp0521965
          ...
          ref={(r: any) => (refs['BOFramer_839089'] = r)}
          {...injectData}
        />
      </View>
    </div>
