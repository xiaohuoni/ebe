...
const pageId = '1024964287946043392';
const ClsJc_0013_0003$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_56073068: any) => {
    const eventDatacustomActionCode140: any = [
      {
    ...
    eventDatacustomActionCode140.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    ...
    eventDataifelse219.params = [] || [];
    CMDGenerator(eventDataifelse219, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
      ...
      >
        ...
        >
          ...
          <Form
            ...
            readOnly={false}
            style={{ padding: '0px 0px 0px 0px' }}
            ref={(r: any) => refs.setComponentRef(r, 'Form_710572')}
            {...injectData}
          >
            <Input
              name={'发票开具类型'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_52594')}
              {...injectData}
            />
            <Input
              name={'发票类型'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_932313')}
              {...injectData}
            />
            <Input
              name={'发票申请开具时间'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_611589')}
              {...injectData}
            />
            <Input
              name={'发票申请场景'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_638462')}
              {...injectData}
            />
            <Input
              name={'发票开具申请人'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_900887')}
              {...injectData}
            />
            <Input
              name={'发票备注信息是否修改'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_9192755')}
              {...injectData}
            />
            <TextArea
              name={'审批事项说明'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'TextArea_492914')}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => refs.setComponentRef(r, 'Divider_805849')}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => refs.setComponentRef(r, 'Divider_368643')}
              {...injectData}
            />
            <Divider
              name={'分割线'}
              ...
              style={{ margin: '12px 0 12px 0', height: 'auto' }}
              ref={(r: any) => refs.setComponentRef(r, 'Divider_347378')}
              {...injectData}
            />
            <Input
              name={'销售方名称'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_0814075')}
              {...injectData}
            />
            <Input
              name={'销售方统一社会信用代码'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_710346')}
              {...injectData}
            />
            <Input
              name={'购买方统一社会信用代码'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_688569')}
              {...injectData}
            />
            <Input
              name={'购买方名称'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_7217852')}
              {...injectData}
            />
            <Input
              name={'含税金额'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_052778')}
              {...injectData}
            />
            <Input
              name={'发票备注'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => refs.setComponentRef(r, 'Input_710264')}
              {...injectData}
            />
          </Form>
          <BusiComp0521965
...
export default withPageHOC(ClsJc_0013_0003$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
