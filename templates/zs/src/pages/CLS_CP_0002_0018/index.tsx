      ...
      >
        ...
        >
          <Divider
            ...
            ref={(r: any) => (refs['Divider_988927'] = r)}
            {...injectData}
          />
          <View
            name={'布局容器'}
          ...
          >
            <HorizontalView
              ...
              ref={(r: any) => (refs['HorizontalView_280735'] = r)}
              {...injectData}
            >
              <View
                name={'布局容器'}
              ...
              >
                ...
                >
                  <Checkbox
                    ...
                    ref={(r: any) => (refs['Checkbox_863779'] = r)}
                    {...injectData}
                  />
                  <View
                    name={'布局容器'}
          ...
          >
            <Input
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_1946759'] = r)}
              {...injectData}
            />
            <Input
              name={'订单流水'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_5863596'] = r)}
              {...injectData}
            />
            <Input
              name={'生效时间'}
              ...
              readOnly={false}
              isFormRootChild={true}
              ref={(r: any) => (refs['Input_5164583'] = r)}
              {...injectData}
            />
            <Input
              name={'失效时间'}
          ...
          <BusiComp0521965
            ...
            ref={(r: any) => (refs['BOFramer_415396'] = r)}
            {...injectData}
          />
        </View>
      </View>
