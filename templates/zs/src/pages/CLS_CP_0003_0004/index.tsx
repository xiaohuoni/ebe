...
const pageId = '1043697921037283328';
const ClsCp_0003_0004$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode126: any = [
      {
    ...
    eventDatacustomActionCode126.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest360: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest360.params = [] || [];
    CMDGenerator(eventDataapiRequest360, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest361: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest361.params = [] || [];
    CMDGenerator(eventDataapiRequest361, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest362: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest362.params = [] || [];
    CMDGenerator(eventDataapiRequest362, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest363: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest363.params = [] || [];
    CMDGenerator(eventDataapiRequest363, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest364: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest364.params = [] || [];
    CMDGenerator(eventDataapiRequest364, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse194: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse194.params = [] || [];
    CMDGenerator(eventDataifelse194, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
    ...
    >
      ...
      >
        <Divider
          ...
          type={'horizontal'}
          dashed={false}
          dividerText={'行业端口免白/签名变更/无合同开通审批单'}
          showTitle={true}
          $$componentItem={{
            id: 'Divider_52558',
            uid: 'Divider_52558',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource155: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource155.params =
                [
                  {
                    title: '表单当前改变字段编码',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData313: any = [
                      {
                    ...
                    eventDatagetSelectedData313.params =
                      [
                    ...
                    const eventDatagetSelectedData314: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData314.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode615: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode615.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode616: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode616.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId60: any = [
                {
              ...
              eventDatadownloadByFileId60.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0004$$Page, {
  pageId,
  hasLogin: false,
  dataSource,
  defaultState: {},
