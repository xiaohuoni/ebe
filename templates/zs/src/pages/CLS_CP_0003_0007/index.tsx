...
const ClsCp_0003_0007$$Page: React.FC<PageProps> = ({
  data,
  CMDGenerator,
  attrDataMap = {},
  customActionMapRef,
  ...
  const fileUpload = (options_1964167: any) => {
    const eventDatacustomActionCode108: any = [
      {
    ...
    eventDatacustomActionCode108.params =
      [
        {
          title: '事件入参',
  ...
  useEffect(() => {
    const eventDataapiRequest317: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest317.params = [] || [];
    CMDGenerator(eventDataapiRequest317, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest318: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest318.params = [] || [];
    CMDGenerator(eventDataapiRequest318, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataapiRequest319: any = [
      {
        type: 'apiRequest',
    ...
    eventDataapiRequest319.params = [] || [];
    CMDGenerator(eventDataapiRequest319, {}, 'apiRequest', {
      id: 'apiRequest',
      name: 'apiRequest',
      type: 'apiRequest',
      platform: 'undefined',
    });
    const eventDataifelse173: any = [
      {
        type: 'ifelse',
        condition: [
          {
    ...
    eventDataifelse173.params = [] || [];
    CMDGenerator(eventDataifelse173, {}, 'ifelse', {
      id: 'ifelse',
      name: 'ifelse',
      type: 'ifelse',
      platform: 'undefined',
        ...
        >
          ...
          <Form
            ...
            onValuesChange={(changedFieldName: any, changedValue: any) => {
              const eventDatasetDataSource141: any = [
                {
                  type: 'setDataSource',
              ...
              eventDatasetDataSource141.params =
                [
                  {
                    title: '表单当前改变字段编码',
              ...
              >
                <StdUpload
                  ...
                  onFinishUpload={(
                    ...
                    const eventDatagetSelectedData259: any = [
                      {
                    ...
                    eventDatagetSelectedData259.params =
                      [
                    ...
                    const eventDatagetSelectedData260: any = [
                      {
                        type: 'getSelectedData',
                    ...
                    eventDatagetSelectedData260.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
                  ...
                  onListenUploading={(
                    ...
                    const eventDatacustomActionCode551: any = [
                      {
                        type: 'customActionCode',
                    ...
                    eventDatacustomActionCode551.params =
                      [
                        { title: '文件对象', name: 'file', value: '$file$' },
                        {
                          title: '文件列表',
        ...
        >
          <Table
            ...
            onRowDelete={(rowId: any, row: any, index: any) => {
              const eventDatacustomActionCode552: any = [
                {
                  type: 'customActionCode',
              ...
              eventDatacustomActionCode552.params =
                [
            ...
            onClickBtn1={(rowId: any, row: any, index: any) => {
              const eventDatadownloadByFileId49: any = [
                {
              ...
              eventDatadownloadByFileId49.params =
                [
                  { title: '行id', name: 'rowId', value: '$rowId$' },
                  {
                    title: '行对象',
...
export default withPageHOC(ClsCp_0003_0007$$Page, {
  pageId: '1047126758932721664',
  hasLogin: false,
  dataSource,
  defaultState: {},
});
